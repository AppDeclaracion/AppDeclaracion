 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ov;function TS(){if(Ov)return xe;Ov=1;var n=Symbol.for("react.transitional.element"),a=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),x=Symbol.iterator;function j(A){return A===null||typeof A!="object"?null:(A=x&&A[x]||A["@@iterator"],typeof A=="function"?A:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,O={};function E(A,$,re){this.props=A,this.context=$,this.refs=O,this.updater=re||S}E.prototype.isReactComponent={},E.prototype.setState=function(A,$){if(typeof A!="object"&&typeof A!="function"&&A!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,A,$,"setState")},E.prototype.forceUpdate=function(A){this.updater.enqueueForceUpdate(this,A,"forceUpdate")};function k(){}k.prototype=E.prototype;function N(A,$,re){this.props=A,this.context=$,this.refs=O,this.updater=re||S}var T=N.prototype=new k;T.constructor=N,C(T,E.prototype),T.isPureReactComponent=!0;var L=Array.isArray,B={H:null,A:null,T:null,S:null,V:null},U=Object.prototype.hasOwnProperty;function _(A,$,re,Z,G,ue){return re=ue.ref,{$$typeof:n,type:A,key:$,ref:re!==void 0?re:null,props:ue}}function z(A,$){return _(A.type,$,void 0,void 0,void 0,A.props)}function Y(A){return typeof A=="object"&&A!==null&&A.$$typeof===n}function ee(A){var $={"=":"=0",":":"=2"};return"$"+A.replace(/[=:]/g,function(re){return $[re]})}var ne=/\/+/g;function le(A,$){return typeof A=="object"&&A!==null&&A.key!=null?ee(""+A.key):$.toString(36)}function ie(){}function ae(A){switch(A.status){case"fulfilled":return A.value;case"rejected":throw A.reason;default:switch(typeof A.status=="string"?A.then(ie,ie):(A.status="pending",A.then(function($){A.status==="pending"&&(A.status="fulfilled",A.value=$)},function($){A.status==="pending"&&(A.status="rejected",A.reason=$)})),A.status){case"fulfilled":return A.value;case"rejected":throw A.reason}}throw A}function P(A,$,re,Z,G){var ue=typeof A;(ue==="undefined"||ue==="boolean")&&(A=null);var me=!1;if(A===null)me=!0;else switch(ue){case"bigint":case"string":case"number":me=!0;break;case"object":switch(A.$$typeof){case n:case a:me=!0;break;case b:return me=A._init,P(me(A._payload),$,re,Z,G)}}if(me)return G=G(A),me=Z===""?"."+le(A,0):Z,L(G)?(re="",me!=null&&(re=me.replace(ne,"$&/")+"/"),P(G,$,re,"",function(Ie){return Ie})):G!=null&&(Y(G)&&(G=z(G,re+(G.key==null||A&&A.key===G.key?"":(""+G.key).replace(ne,"$&/")+"/")+me)),$.push(G)),1;me=0;var He=Z===""?".":Z+":";if(L(A))for(var we=0;we<A.length;we++)Z=A[we],ue=He+le(Z,we),me+=P(Z,$,re,ue,G);else if(we=j(A),typeof we=="function")for(A=we.call(A),we=0;!(Z=A.next()).done;)Z=Z.value,ue=He+le(Z,we++),me+=P(Z,$,re,ue,G);else if(ue==="object"){if(typeof A.then=="function")return P(ae(A),$,re,Z,G);throw $=String(A),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(A).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return me}function D(A,$,re){if(A==null)return A;var Z=[],G=0;return P(A,Z,"","",function(ue){return $.call(re,ue,G++)}),Z}function Q(A){if(A._status===-1){var $=A._result;$=$(),$.then(function(re){(A._status===0||A._status===-1)&&(A._status=1,A._result=re)},function(re){(A._status===0||A._status===-1)&&(A._status=2,A._result=re)}),A._status===-1&&(A._status=0,A._result=$)}if(A._status===1)return A._result.default;throw A._result}var oe=typeof reportError=="function"?reportError:function(A){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof A=="object"&&A!==null&&typeof A.message=="string"?String(A.message):String(A),error:A});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",A);return}console.error(A)};function V(){}return xe.Children={map:D,forEach:function(A,$,re){D(A,function(){$.apply(this,arguments)},re)},count:function(A){var $=0;return D(A,function(){$++}),$},toArray:function(A){return D(A,function($){return $})||[]},only:function(A){if(!Y(A))throw Error("React.Children.only expected to receive a single React element child.");return A}},xe.Component=E,xe.Fragment=o,xe.Profiler=u,xe.PureComponent=N,xe.StrictMode=l,xe.Suspense=h,xe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,xe.__COMPILER_RUNTIME={__proto__:null,c:function(A){return B.H.useMemoCache(A)}},xe.cache=function(A){return function(){return A.apply(null,arguments)}},xe.cloneElement=function(A,$,re){if(A==null)throw Error("The argument must be a React element, but you passed "+A+".");var Z=C({},A.props),G=A.key,ue=void 0;if($!=null)for(me in $.ref!==void 0&&(ue=void 0),$.key!==void 0&&(G=""+$.key),$)!U.call($,me)||me==="key"||me==="__self"||me==="__source"||me==="ref"&&$.ref===void 0||(Z[me]=$[me]);var me=arguments.length-2;if(me===1)Z.children=re;else if(1<me){for(var He=Array(me),we=0;we<me;we++)He[we]=arguments[we+2];Z.children=He}return _(A.type,G,void 0,void 0,ue,Z)},xe.createContext=function(A){return A={$$typeof:p,_currentValue:A,_currentValue2:A,_threadCount:0,Provider:null,Consumer:null},A.Provider=A,A.Consumer={$$typeof:d,_context:A},A},xe.createElement=function(A,$,re){var Z,G={},ue=null;if($!=null)for(Z in $.key!==void 0&&(ue=""+$.key),$)U.call($,Z)&&Z!=="key"&&Z!=="__self"&&Z!=="__source"&&(G[Z]=$[Z]);var me=arguments.length-2;if(me===1)G.children=re;else if(1<me){for(var He=Array(me),we=0;we<me;we++)He[we]=arguments[we+2];G.children=He}if(A&&A.defaultProps)for(Z in me=A.defaultProps,me)G[Z]===void 0&&(G[Z]=me[Z]);return _(A,ue,void 0,void 0,null,G)},xe.createRef=function(){return{current:null}},xe.forwardRef=function(A){return{$$typeof:g,render:A}},xe.isValidElement=Y,xe.lazy=function(A){return{$$typeof:b,_payload:{_status:-1,_result:A},_init:Q}},xe.memo=function(A,$){return{$$typeof:v,type:A,compare:$===void 0?null:$}},xe.startTransition=function(A){var $=B.T,re={};B.T=re;try{var Z=A(),G=B.S;G!==null&&G(re,Z),typeof Z=="object"&&Z!==null&&typeof Z.then=="function"&&Z.then(V,oe)}catch(ue){oe(ue)}finally{B.T=$}},xe.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},xe.use=function(A){return B.H.use(A)},xe.useActionState=function(A,$,re){return B.H.useActionState(A,$,re)},xe.useCallback=function(A,$){return B.H.useCallback(A,$)},xe.useContext=function(A){return B.H.useContext(A)},xe.useDebugValue=function(){},xe.useDeferredValue=function(A,$){return B.H.useDeferredValue(A,$)},xe.useEffect=function(A,$,re){var Z=B.H;if(typeof re=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Z.useEffect(A,$)},xe.useId=function(){return B.H.useId()},xe.useImperativeHandle=function(A,$,re){return B.H.useImperativeHandle(A,$,re)},xe.useInsertionEffect=function(A,$){return B.H.useInsertionEffect(A,$)},xe.useLayoutEffect=function(A,$){return B.H.useLayoutEffect(A,$)},xe.useMemo=function(A,$){return B.H.useMemo(A,$)},xe.useOptimistic=function(A,$){return B.H.useOptimistic(A,$)},xe.useReducer=function(A,$,re){return B.H.useReducer(A,$,re)},xe.useRef=function(A){return B.H.useRef(A)},xe.useState=function(A){return B.H.useState(A)},xe.useSyncExternalStore=function(A,$,re){return B.H.useSyncExternalStore(A,$,re)},xe.useTransition=function(){return B.H.useTransition()},xe.version="19.1.1",xe}var kv;function _f(){return kv||(kv=1,Hd.exports=TS()),Hd.exports}var m=_f();const Fe=Do(m);var qd={exports:{}},Ys={},Jd={exports:{}},Gd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tv;function RS(){return Tv||(Tv=1,(function(n){function a(D,Q){var oe=D.length;D.push(Q);e:for(;0<oe;){var V=oe-1>>>1,A=D[V];if(0<u(A,Q))D[V]=Q,D[oe]=A,oe=V;else break e}}function o(D){return D.length===0?null:D[0]}function l(D){if(D.length===0)return null;var Q=D[0],oe=D.pop();if(oe!==Q){D[0]=oe;e:for(var V=0,A=D.length,$=A>>>1;V<$;){var re=2*(V+1)-1,Z=D[re],G=re+1,ue=D[G];if(0>u(Z,oe))G<A&&0>u(ue,Z)?(D[V]=ue,D[G]=oe,V=G):(D[V]=Z,D[re]=oe,V=re);else if(G<A&&0>u(ue,oe))D[V]=ue,D[G]=oe,V=G;else break e}}return Q}function u(D,Q){var oe=D.sortIndex-Q.sortIndex;return oe!==0?oe:D.id-Q.id}if(n.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;n.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();n.unstable_now=function(){return p.now()-g}}var h=[],v=[],b=1,x=null,j=3,S=!1,C=!1,O=!1,E=!1,k=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,T=typeof setImmediate<"u"?setImmediate:null;function L(D){for(var Q=o(v);Q!==null;){if(Q.callback===null)l(v);else if(Q.startTime<=D)l(v),Q.sortIndex=Q.expirationTime,a(h,Q);else break;Q=o(v)}}function B(D){if(O=!1,L(D),!C)if(o(h)!==null)C=!0,U||(U=!0,le());else{var Q=o(v);Q!==null&&P(B,Q.startTime-D)}}var U=!1,_=-1,z=5,Y=-1;function ee(){return E?!0:!(n.unstable_now()-Y<z)}function ne(){if(E=!1,U){var D=n.unstable_now();Y=D;var Q=!0;try{e:{C=!1,O&&(O=!1,N(_),_=-1),S=!0;var oe=j;try{t:{for(L(D),x=o(h);x!==null&&!(x.expirationTime>D&&ee());){var V=x.callback;if(typeof V=="function"){x.callback=null,j=x.priorityLevel;var A=V(x.expirationTime<=D);if(D=n.unstable_now(),typeof A=="function"){x.callback=A,L(D),Q=!0;break t}x===o(h)&&l(h),L(D)}else l(h);x=o(h)}if(x!==null)Q=!0;else{var $=o(v);$!==null&&P(B,$.startTime-D),Q=!1}}break e}finally{x=null,j=oe,S=!1}Q=void 0}}finally{Q?le():U=!1}}}var le;if(typeof T=="function")le=function(){T(ne)};else if(typeof MessageChannel<"u"){var ie=new MessageChannel,ae=ie.port2;ie.port1.onmessage=ne,le=function(){ae.postMessage(null)}}else le=function(){k(ne,0)};function P(D,Q){_=k(function(){D(n.unstable_now())},Q)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(D){D.callback=null},n.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<D?Math.floor(1e3/D):5},n.unstable_getCurrentPriorityLevel=function(){return j},n.unstable_next=function(D){switch(j){case 1:case 2:case 3:var Q=3;break;default:Q=j}var oe=j;j=Q;try{return D()}finally{j=oe}},n.unstable_requestPaint=function(){E=!0},n.unstable_runWithPriority=function(D,Q){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var oe=j;j=D;try{return Q()}finally{j=oe}},n.unstable_scheduleCallback=function(D,Q,oe){var V=n.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?V+oe:V):oe=V,D){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=oe+A,D={id:b++,callback:Q,priorityLevel:D,startTime:oe,expirationTime:A,sortIndex:-1},oe>V?(D.sortIndex=oe,a(v,D),o(h)===null&&D===o(v)&&(O?(N(_),_=-1):O=!0,P(B,oe-V))):(D.sortIndex=A,a(h,D),C||S||(C=!0,U||(U=!0,le()))),D},n.unstable_shouldYield=ee,n.unstable_wrapCallback=function(D){var Q=j;return function(){var oe=j;j=Q;try{return D.apply(this,arguments)}finally{j=oe}}}})(Gd)),Gd}var Rv;function DS(){return Rv||(Rv=1,Jd.exports=RS()),Jd.exports}var Fd={exports:{}},xt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dv;function LS(){if(Dv)return xt;Dv=1;var n=_f();function a(h){var v="https://react.dev/errors/"+h;if(1<arguments.length){v+="?args[]="+encodeURIComponent(arguments[1]);for(var b=2;b<arguments.length;b++)v+="&args[]="+encodeURIComponent(arguments[b])}return"Minified React error #"+h+"; visit "+v+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var l={d:{f:o,r:function(){throw Error(a(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},u=Symbol.for("react.portal");function d(h,v,b){var x=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:u,key:x==null?null:""+x,children:h,containerInfo:v,implementation:b}}var p=n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function g(h,v){if(h==="font")return"";if(typeof v=="string")return v==="use-credentials"?v:""}return xt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=l,xt.createPortal=function(h,v){var b=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!v||v.nodeType!==1&&v.nodeType!==9&&v.nodeType!==11)throw Error(a(299));return d(h,v,null,b)},xt.flushSync=function(h){var v=p.T,b=l.p;try{if(p.T=null,l.p=2,h)return h()}finally{p.T=v,l.p=b,l.d.f()}},xt.preconnect=function(h,v){typeof h=="string"&&(v?(v=v.crossOrigin,v=typeof v=="string"?v==="use-credentials"?v:"":void 0):v=null,l.d.C(h,v))},xt.prefetchDNS=function(h){typeof h=="string"&&l.d.D(h)},xt.preinit=function(h,v){if(typeof h=="string"&&v&&typeof v.as=="string"){var b=v.as,x=g(b,v.crossOrigin),j=typeof v.integrity=="string"?v.integrity:void 0,S=typeof v.fetchPriority=="string"?v.fetchPriority:void 0;b==="style"?l.d.S(h,typeof v.precedence=="string"?v.precedence:void 0,{crossOrigin:x,integrity:j,fetchPriority:S}):b==="script"&&l.d.X(h,{crossOrigin:x,integrity:j,fetchPriority:S,nonce:typeof v.nonce=="string"?v.nonce:void 0})}},xt.preinitModule=function(h,v){if(typeof h=="string")if(typeof v=="object"&&v!==null){if(v.as==null||v.as==="script"){var b=g(v.as,v.crossOrigin);l.d.M(h,{crossOrigin:b,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0})}}else v==null&&l.d.M(h)},xt.preload=function(h,v){if(typeof h=="string"&&typeof v=="object"&&v!==null&&typeof v.as=="string"){var b=v.as,x=g(b,v.crossOrigin);l.d.L(h,b,{crossOrigin:x,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0,type:typeof v.type=="string"?v.type:void 0,fetchPriority:typeof v.fetchPriority=="string"?v.fetchPriority:void 0,referrerPolicy:typeof v.referrerPolicy=="string"?v.referrerPolicy:void 0,imageSrcSet:typeof v.imageSrcSet=="string"?v.imageSrcSet:void 0,imageSizes:typeof v.imageSizes=="string"?v.imageSizes:void 0,media:typeof v.media=="string"?v.media:void 0})}},xt.preloadModule=function(h,v){if(typeof h=="string")if(v){var b=g(v.as,v.crossOrigin);l.d.m(h,{as:typeof v.as=="string"&&v.as!=="script"?v.as:void 0,crossOrigin:b,integrity:typeof v.integrity=="string"?v.integrity:void 0})}else l.d.m(h)},xt.requestFormReset=function(h){l.d.r(h)},xt.unstable_batchedUpdates=function(h,v){return h(v)},xt.useFormState=function(h,v,b){return p.H.useFormState(h,v,b)},xt.useFormStatus=function(){return p.H.useHostTransitionStatus()},xt.version="19.1.1",xt}var Lv;function Ib(){if(Lv)return Fd.exports;Lv=1;function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}return n(),Fd.exports=LS(),Fd.exports}/**
 * @license React
 ...
 *
 * @license MIT
 */var zv="popstate";function US(n={}){function a(u,d){let{pathname:p="/",search:g="",hash:h=""}=Sr(u.location.hash.substring(1));return!p.startsWith("/")&&!p.startsWith(".")&&(p="/"+p),ff("",{pathname:p,search:g,hash:h},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function o(u,d){let p=u.document.querySelector("base"),g="";if(p&&p.getAttribute("href")){let h=u.location.href,v=h.indexOf("#");g=v===-1?h:h.slice(0,v)}return g+"#"+(typeof d=="string"?d:ai(d))}function l(u,d){gn(u.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(d)})`)}return IS(a,o,l,n)}function Ve(n,a){if(n===!1||n===null||typeof n>"u")throw new Error(a)}function gn(n,a){if(!n){typeof console<"u"&&console.warn(a);try{throw new Error(a)}catch{}}}function PS(){return Math.random().toString(36).substring(2,10)}function Bv(n,a){return{usr:n.state,key:n.key,idx:a}}function ff(n,a,o=null,l){return{pathname:typeof n=="string"?n:n.pathname,search:"",hash:"",...typeof a=="string"?Sr(a):a,state:o,key:a&&a.key||l||PS()}}function ai({pathname:n="/",search:a="",hash:o=""}){return a&&a!=="?"&&(n+=a.charAt(0)==="?"?a:"?"+a),o&&o!=="#"&&(n+=o.charAt(0)==="#"?o:"#"+o),n}function Sr(n){let a={};if(n){let o=n.indexOf("#");o>=0&&(a.hash=n.substring(o),n=n.substring(0,o));let l=n.indexOf("?");l>=0&&(a.search=n.substring(l),n=n.substring(0,l)),n&&(a.pathname=n)}return a}function IS(n,a,o,l={}){let{window:u=document.defaultView,v5Compat:d=!1}=l,p=u.history,g="POP",h=null,v=b();v==null&&(v=0,p.replaceState({...p.state,idx:v},""));function b(){return(p.state||{idx:null}).idx}function x(){g="POP";let E=b(),k=E==null?null:E-v;v=E,h&&h({action:g,location:O.location,delta:k})}function j(E,k){g="PUSH";let N=ff(O.location,E,k);o&&o(N,E),v=b()+1;let T=Bv(N,v),L=O.createHref(N);try{p.pushState(T,"",L)}catch(B){if(B instanceof DOMException&&B.name==="DataCloneError")throw B;u.location.assign(L)}d&&h&&h({action:g,location:O.location,delta:1})}function S(E,k){g="REPLACE";let N=ff(O.location,E,k);o&&o(N,E),v=b();let T=Bv(N,v),L=O.createHref(N);p.replaceState(T,"",L),d&&h&&h({action:g,location:O.location,delta:0})}function C(E){return $S(E)}let O={get action(){return g},get location(){return n(u,p)},listen(E){if(h)throw new Error("A history only accepts one active listener");return u.addEventListener(zv,x),h=E,()=>{u.removeEventListener(zv,x),h=null}},createHref(E){return a(u,E)},createURL:C,encodeLocation(E){let k=C(E);return{pathname:k.pathname,search:k.search,hash:k.hash}},push:j,replace:S,go(E){return p.go(E)}};return O}function $S(n,a=!1){let o="http://localhost";typeof window<"u"&&(o=window.location.origin!=="null"?window.location.origin:window.location.href),Ve(o,"No window.location.(origin|href) available to create URL");let l=typeof n=="string"?n:ai(n);return l=l.replace(/ $/,"%20"),!a&&l.startsWith("//")&&(l=o+l),new URL(l,o)}function $b(n,a,o="/"){return HS(n,a,o,!1)}function HS(n,a,o,l){let u=typeof a=="string"?Sr(a):a,d=ua(u.pathname||"/",o);if(d==null)return null;let p=Hb(n);qS(p);let g=null;for(let h=0;g==null&&h<p.length;++h){let v=eE(d);g=QS(p[h],v,l)}return g}function Hb(n,a=[],o=[],l="",u=!1){let d=(p,g,h=u,v)=>{let b={relativePath:v===void 0?p.path||"":v,caseSensitive:p.caseSensitive===!0,childrenIndex:g,route:p};if(b.relativePath.startsWith("/")){if(!b.relativePath.startsWith(l)&&h)return;Ve(b.relativePath.startsWith(l),`Absolute route path "${b.relativePath}" nested under path "${l}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),b.relativePath=b.relativePath.slice(l.length)}let x=ia([l,b.relativePath]),j=o.concat(b);p.children&&p.children.length>0&&(Ve(p.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${x}".`),Hb(p.children,a,j,x,h)),!(p.path==null&&!p.index)&&a.push({path:x,score:ZS(x,p.index),routesMeta:j})};return n.forEach((p,g)=>{if(p.path===""||!p.path?.includes("?"))d(p,g);else for(let h of qb(p.path))d(p,g,!0,h)}),a}function qb(n){let a=n.split("/");if(a.length===0)return[];let[o,...l]=a,u=o.endsWith("?"),d=o.replace(/\?$/,"");if(l.length===0)return u?[d,""]:[d];let p=qb(l.join("/")),g=[];return g.push(...p.map(h=>h===""?d:[d,h].join("/"))),u&&g.push(...p),g.map(h=>n.startsWith("/")&&h===""?"/":h)}function qS(n){n.sort((a,o)=>a.score!==o.score?o.score-a.score:KS(a.routesMeta.map(l=>l.childrenIndex),o.routesMeta.map(l=>l.childrenIndex)))}var JS=/^:[\w-]+$/,GS=3,FS=2,VS=1,YS=10,XS=-2,Uv=n=>n==="*";function ZS(n,a){let o=n.split("/"),l=o.length;return o.some(Uv)&&(l+=XS),a&&(l+=FS),o.filter(u=>!Uv(u)).reduce((u,d)=>u+(JS.test(d)?GS:d===""?VS:YS),l)}function KS(n,a){return n.length===a.length&&n.slice(0,-1).every((l,u)=>l===a[u])?n[n.length-1]-a[a.length-1]:0}function QS(n,a,o=!1){let{routesMeta:l}=n,u={},d="/",p=[];for(let g=0;g<l.length;++g){let h=l[g],v=g===l.length-1,b=d==="/"?a:a.slice(d.length)||"/",x=Yl({path:h.relativePath,caseSensitive:h.caseSensitive,end:v},b),j=h.route;if(!x&&v&&o&&!l[l.length-1].route.index&&(x=Yl({path:h.relativePath,caseSensitive:h.caseSensitive,end:!1},b)),!x)return null;Object.assign(u,x.params),p.push({params:u,pathname:ia([d,x.pathname]),pathnameBase:rE(ia([d,x.pathnameBase])),route:j}),x.pathnameBase!=="/"&&(d=ia([d,x.pathnameBase]))}return p}function Yl(n,a){typeof n=="string"&&(n={path:n,caseSensitive:!1,end:!0});let[o,l]=WS(n.path,n.caseSensitive,n.end),u=a.match(o);if(!u)return null;let d=u[0],p=d.replace(/(.)\/+$/,"$1"),g=u.slice(1);return{params:l.reduce((v,{paramName:b,isOptional:x},j)=>{if(b==="*"){let C=g[j]||"";p=d.slice(0,d.length-C.length).replace(/(.)\/+$/,"$1")}const S=g[j];return x&&!S?v[b]=void 0:v[b]=(S||"").replace(/%2F/g,"/"),v},{}),pathname:d,pathnameBase:p,pattern:n}}function WS(n,a=!1,o=!0){gn(n==="*"||!n.endsWith("*")||n.endsWith("/*"),`Route path "${n}" will be treated as if it were "${n.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${n.replace(/\*$/,"/*")}".`);let l=[],u="^"+n.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(p,g,h)=>(l.push({paramName:g,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return n.endsWith("*")?(l.push({paramName:"*"}),u+=n==="*"||n==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?u+="\\/*$":n!==""&&n!=="/"&&(u+="(?:(?=\\/|$))"),[new RegExp(u,a?void 0:"i"),l]}function eE(n){try{return n.split("/").map(a=>decodeURIComponent(a).replace(/\//g,"%2F")).join("/")}catch(a){return gn(!1,`The URL path "${n}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${a}).`),n}}function ua(n,a){if(a==="/")return n;if(!n.toLowerCase().startsWith(a.toLowerCase()))return null;let o=a.endsWith("/")?a.length-1:a.length,l=n.charAt(o);return l&&l!=="/"?null:n.slice(o)||"/"}function tE(n,a="/"){let{pathname:o,search:l="",hash:u=""}=typeof n=="string"?Sr(n):n;return{pathname:o?o.startsWith("/")?o:nE(o,a):a,search:oE(l),hash:sE(u)}}function nE(n,a){let o=a.replace(/\/+$/,"").split("/");return n.split("/").forEach(u=>{u===".."?o.length>1&&o.pop():u!=="."&&o.push(u)}),o.length>1?o.join("/"):"/"}function Vd(n,a,o,l){return`Cannot include a '${n}' character in a manually specified \`to.${a}\` field [${JSON.stringify(l)}].  Please separate it out to the \`to.${o}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function aE(n){return n.filter((a,o)=>o===0||a.route.path&&a.route.path.length>0)}function zf(n){let a=aE(n);return a.map((o,l)=>l===a.length-1?o.pathname:o.pathnameBase)}function Bf(n,a,o,l=!1){let u;typeof n=="string"?u=Sr(n):(u={...n},Ve(!u.pathname||!u.pathname.includes("?"),Vd("?","pathname","search",u)),Ve(!u.pathname||!u.pathname.includes("#"),Vd("#","pathname","hash",u)),Ve(!u.search||!u.search.includes("#"),Vd("#","search","hash",u)));let d=n===""||u.pathname==="",p=d?"/":u.pathname,g;if(p==null)g=o;else{let x=a.length-1;if(!l&&p.startsWith("..")){let j=p.split("/");for(;j[0]==="..";)j.shift(),x-=1;u.pathname=j.join("/")}g=x>=0?a[x]:"/"}let h=tE(u,g),v=p&&p!=="/"&&p.endsWith("/"),b=(d||p===".")&&o.endsWith("/");return!h.pathname.endsWith("/")&&(v||b)&&(h.pathname+="/"),h}var ia=n=>n.join("/").replace(/\/\/+/g,"/"),rE=n=>n.replace(/\/+$/,"").replace(/^\/*/,"/"),oE=n=>!n||n==="?"?"":n.startsWith("?")?n:"?"+n,sE=n=>!n||n==="#"?"":n.startsWith("#")?n:"#"+n;function iE(n){return n!=null&&typeof n.status=="number"&&typeof n.statusText=="string"&&typeof n.internal=="boolean"&&"data"in n}var Jb=["POST","PUT","PATCH","DELETE"];new Set(Jb);var lE=["GET",...Jb];new Set(lE);var Lo=m.createContext(null);Lo.displayName="DataRouter";var cc=m.createContext(null);cc.displayName="DataRouterState";m.createContext(!1);var Gb=m.createContext({isTransitioning:!1});Gb.displayName="ViewTransition";var cE=m.createContext(new Map);cE.displayName="Fetchers";var uE=m.createContext(null);uE.displayName="Await";var An=m.createContext(null);An.displayName="Navigation";var li=m.createContext(null);li.displayName="Location";var Pn=m.createContext({outlet:null,matches:[],isDataRoute:!1});Pn.displayName="Route";var Uf=m.createContext(null);Uf.displayName="RouteError";function dE(n,{relative:a}={}){Ve(Mo(),"useHref() may be used only in the context of a <Router> component.");let{basename:o,navigator:l}=m.useContext(An),{hash:u,pathname:d,search:p}=ci(n,{relative:a}),g=d;return o!=="/"&&(g=d==="/"?o:ia([o,d])),l.createHref({pathname:g,search:p,hash:u})}function Mo(){return m.useContext(li)!=null}function In(){return Ve(Mo(),"useLocation() may be used only in the context of a <Router> component."),m.useContext(li).location}var Fb="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Vb(n){m.useContext(An).static||m.useLayoutEffect(n)}function On(){let{isDataRoute:n}=m.useContext(Pn);return n?EE():fE()}function fE(){Ve(Mo(),"useNavigate() may be used only in the context of a <Router> component.");let n=m.useContext(Lo),{basename:a,navigator:o}=m.useContext(An),{matches:l}=m.useContext(Pn),{pathname:u}=In(),d=JSON.stringify(zf(l)),p=m.useRef(!1);return Vb(()=>{p.current=!0}),m.useCallback((h,v={})=>{if(gn(p.current,Fb),!p.current)return;if(typeof h=="number"){o.go(h);return}let b=Bf(h,JSON.parse(d),u,v.relative==="path");n==null&&a!=="/"&&(b.pathname=b.pathname==="/"?a:ia([a,b.pathname])),(v.replace?o.replace:o.push)(b,v.state,v)},[a,o,d,u,n])}m.createContext(null);function ci(n,{relative:a}={}){let{matches:o}=m.useContext(Pn),{pathname:l}=In(),u=JSON.stringify(zf(o));return m.useMemo(()=>Bf(n,JSON.parse(u),l,a==="path"),[n,u,l,a])}function mE(n,a){return Yb(n,a)}function Yb(n,a,o,l,u){Ve(Mo(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=m.useContext(An),{matches:p}=m.useContext(Pn),g=p[p.length-1],h=g?g.params:{},v=g?g.pathname:"/",b=g?g.pathnameBase:"/",x=g&&g.route;{let N=x&&x.path||"";Xb(v,!x||N.endsWith("*")||N.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${v}" (under <Route path="${N}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${N}"> to <Route path="${N==="/"?"*":`${N}/*`}">.`)}let j=In(),S;if(a){let N=typeof a=="string"?Sr(a):a;Ve(b==="/"||N.pathname?.startsWith(b),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${b}" but pathname "${N.pathname}" was given in the \`location\` prop.`),S=N}else S=j;let C=S.pathname||"/",O=C;if(b!=="/"){let N=b.replace(/^\//,"").split("/");O="/"+C.replace(/^\//,"").split("/").slice(N.length).join("/")}let E=$b(n,{pathname:O});gn(x||E!=null,`No routes matched location "${S.pathname}${S.search}${S.hash}" `),gn(E==null||E[E.length-1].route.element!==void 0||E[E.length-1].route.Component!==void 0||E[E.length-1].route.lazy!==void 0,`Matched leaf route at location "${S.pathname}${S.search}${S.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let k=bE(E&&E.map(N=>Object.assign({},N,{params:Object.assign({},h,N.params),pathname:ia([b,d.encodeLocation?d.encodeLocation(N.pathname).pathname:N.pathname]),pathnameBase:N.pathnameBase==="/"?b:ia([b,d.encodeLocation?d.encodeLocation(N.pathnameBase).pathname:N.pathnameBase])})),p,o,l,u);return a&&k?m.createElement(li.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...S},navigationType:"POP"}},k):k}function pE(){let n=SE(),a=iE(n)?`${n.status} ${n.statusText}`:n instanceof Error?n.message:JSON.stringify(n),o=n instanceof Error?n.stack:null,l="rgba(200,200,200, 0.5)",u={padding:"0.5rem",backgroundColor:l},d={padding:"2px 4px",backgroundColor:l},p=null;return console.error("Error handled by React Router default ErrorBoundary:",n),p=m.createElement(m.Fragment,null,m.createElement("p",null,"💿 Hey developer 👋"),m.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",m.createElement("code",{style:d},"ErrorBoundary")," or"," ",m.createElement("code",{style:d},"errorElement")," prop on your route.")),m.createElement(m.Fragment,null,m.createElement("h2",null,"Unexpected Application Error!"),m.createElement("h3",{style:{fontStyle:"italic"}},a),o?m.createElement("pre",{style:u},o):null,p)}var hE=m.createElement(pE,null),gE=class extends m.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,a){return a.location!==n.location||a.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:a.error,location:a.location,revalidation:n.revalidation||a.revalidation}}componentDidCatch(n,a){this.props.unstable_onError?this.props.unstable_onError(n,a):console.error("React Router caught the following error during render",n)}render(){return this.state.error!==void 0?m.createElement(Pn.Provider,{value:this.props.routeContext},m.createElement(Uf.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function vE({routeContext:n,match:a,children:o}){let l=m.useContext(Lo);return l&&l.static&&l.staticContext&&(a.route.errorElement||a.route.ErrorBoundary)&&(l.staticContext._deepestRenderedBoundaryId=a.route.id),m.createElement(Pn.Provider,{value:n},o)}function bE(n,a=[],o=null,l=null,u=null){if(n==null){if(!o)return null;if(o.errors)n=o.matches;else if(a.length===0&&!o.initialized&&o.matches.length>0)n=o.matches;else return null}let d=n,p=o?.errors;if(p!=null){let v=d.findIndex(b=>b.route.id&&p?.[b.route.id]!==void 0);Ve(v>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),d=d.slice(0,Math.min(d.length,v+1))}let g=!1,h=-1;if(o)for(let v=0;v<d.length;v++){let b=d[v];if((b.route.HydrateFallback||b.route.hydrateFallbackElement)&&(h=v),b.route.id){let{loaderData:x,errors:j}=o,S=b.route.loader&&!x.hasOwnProperty(b.route.id)&&(!j||j[b.route.id]===void 0);if(b.route.lazy||S){g=!0,h>=0?d=d.slice(0,h+1):d=[d[0]];break}}}return d.reduceRight((v,b,x)=>{let j,S=!1,C=null,O=null;o&&(j=p&&b.route.id?p[b.route.id]:void 0,C=b.route.errorElement||hE,g&&(h<0&&x===0?(Xb("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),S=!0,O=null):h===x&&(S=!0,O=b.route.hydrateFallbackElement||null)));let E=a.concat(d.slice(0,x+1)),k=()=>{let N;return j?N=C:S?N=O:b.route.Component?N=m.createElement(b.route.Component,null):b.route.element?N=b.route.element:N=v,m.createElement(vE,{match:b,routeContext:{outlet:v,matches:E,isDataRoute:o!=null},children:N})};return o&&(b.route.ErrorBoundary||b.route.errorElement||x===0)?m.createElement(gE,{location:o.location,revalidation:o.revalidation,component:C,error:j,children:k(),routeContext:{outlet:null,matches:E,isDataRoute:!0},unstable_onError:l}):k()},null)}function Pf(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function yE(n){let a=m.useContext(Lo);return Ve(a,Pf(n)),a}function xE(n){let a=m.useContext(cc);return Ve(a,Pf(n)),a}function wE(n){let a=m.useContext(Pn);return Ve(a,Pf(n)),a}function If(n){let a=wE(n),o=a.matches[a.matches.length-1];return Ve(o.route.id,`${n} can only be used on routes that contain a unique "id"`),o.route.id}function jE(){return If("useRouteId")}function SE(){let n=m.useContext(Uf),a=xE("useRouteError"),o=If("useRouteError");return n!==void 0?n:a.errors?.[o]}function EE(){let{router:n}=yE("useNavigate"),a=If("useNavigate"),o=m.useRef(!1);return Vb(()=>{o.current=!0}),m.useCallback(async(u,d={})=>{gn(o.current,Fb),o.current&&(typeof u=="number"?n.navigate(u):await n.navigate(u,{fromRouteId:a,...d}))},[n,a])}var Pv={};function Xb(n,a,o){!a&&!Pv[n]&&(Pv[n]=!0,gn(!1,o))}m.memo(NE);function NE({routes:n,future:a,state:o,unstable_onError:l}){return Yb(n,void 0,o,l,a)}function CE({to:n,replace:a,state:o,relative:l}){Ve(Mo(),"<Navigate> may be used only in the context of a <Router> component.");let{static:u}=m.useContext(An);gn(!u,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:d}=m.useContext(Pn),{pathname:p}=In(),g=On(),h=Bf(n,zf(d),p,l==="path"),v=JSON.stringify(h);return m.useEffect(()=>{g(JSON.parse(v),{replace:a,state:o,relative:l})},[g,v,l,a,o]),null}function fn(n){Ve(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function AE({basename:n="/",children:a=null,location:o,navigationType:l="POP",navigator:u,static:d=!1}){Ve(!Mo(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let p=n.replace(/^\/*/,"/"),g=m.useMemo(()=>({basename:p,navigator:u,static:d,future:{}}),[p,u,d]);typeof o=="string"&&(o=Sr(o));let{pathname:h="/",search:v="",hash:b="",state:x=null,key:j="default"}=o,S=m.useMemo(()=>{let C=ua(h,p);return C==null?null:{location:{pathname:C,search:v,hash:b,state:x,key:j},navigationType:l}},[p,h,v,b,x,j,l]);return gn(S!=null,`<Router basename="${p}"> is not able to match the URL "${h}${v}${b}" because it does not start with the basename, so the <Router> won't render anything.`),S==null?null:m.createElement(An.Provider,{value:g},m.createElement(li.Provider,{children:a,value:S}))}function OE({children:n,location:a}){return mE(mf(n),a)}function mf(n,a=[]){let o=[];return m.Children.forEach(n,(l,u)=>{if(!m.isValidElement(l))return;let d=[...a,u];if(l.type===m.Fragment){o.push.apply(o,mf(l.props.children,d));return}Ve(l.type===fn,`[${typeof l.type=="string"?l.type:l.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ve(!l.props.index||!l.props.children,"An index route cannot have child routes.");let p={id:l.props.id||d.join("-"),caseSensitive:l.props.caseSensitive,element:l.props.element,Component:l.props.Component,index:l.props.index,path:l.props.path,loader:l.props.loader,action:l.props.action,hydrateFallbackElement:l.props.hydrateFallbackElement,HydrateFallback:l.props.HydrateFallback,errorElement:l.props.errorElement,ErrorBoundary:l.props.ErrorBoundary,hasErrorBoundary:l.props.hasErrorBoundary===!0||l.props.ErrorBoundary!=null||l.props.errorElement!=null,shouldRevalidate:l.props.shouldRevalidate,handle:l.props.handle,lazy:l.props.lazy};l.props.children&&(p.children=mf(l.props.children,d)),o.push(p)}),o}var Jl="get",Gl="application/x-www-form-urlencoded";function uc(n){return n!=null&&typeof n.tagName=="string"}function kE(n){return uc(n)&&n.tagName.toLowerCase()==="button"}function TE(n){return uc(n)&&n.tagName.toLowerCase()==="form"}function RE(n){return uc(n)&&n.tagName.toLowerCase()==="input"}function DE(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function LE(n,a){return n.button===0&&(!a||a==="_self")&&!DE(n)}var Bl=null;function ME(){if(Bl===null)try{new FormData(document.createElement("form"),0),Bl=!1}catch{Bl=!0}return Bl}var _E=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Yd(n){return n!=null&&!_E.has(n)?(gn(!1,`"${n}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Gl}"`),null):n}function zE(n,a){let o,l,u,d,p;if(TE(n)){let g=n.getAttribute("action");l=g?ua(g,a):null,o=n.getAttribute("method")||Jl,u=Yd(n.getAttribute("enctype"))||Gl,d=new FormData(n)}else if(kE(n)||RE(n)&&(n.type==="submit"||n.type==="image")){let g=n.form;if(g==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let h=n.getAttribute("formaction")||g.getAttribute("action");if(l=h?ua(h,a):null,o=n.getAttribute("formmethod")||g.getAttribute("method")||Jl,u=Yd(n.getAttribute("formenctype"))||Yd(g.getAttribute("enctype"))||Gl,d=new FormData(g,n),!ME()){let{name:v,type:b,value:x}=n;if(b==="image"){let j=v?`${v}.`:"";d.append(`${j}x`,"0"),d.append(`${j}y`,"0")}else v&&d.append(v,x)}}else{if(uc(n))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');o=Jl,l=null,u=Gl,p=n}return d&&u==="text/plain"&&(p=d,d=void 0),{action:l,method:o.toLowerCase(),encType:u,formData:d,body:p}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function $f(n,a){if(n===!1||n===null||typeof n>"u")throw new Error(a)}function BE(n,a,o){let l=typeof n=="string"?new URL(n,typeof window>"u"?"server://singlefetch/":window.location.origin):n;return l.pathname==="/"?l.pathname=`_root.${o}`:a&&ua(l.pathname,a)==="/"?l.pathname=`${a.replace(/\/$/,"")}/_root.${o}`:l.pathname=`${l.pathname.replace(/\/$/,"")}.${o}`,l}async function UE(n,a){if(n.id in a)return a[n.id];try{let o=await import(n.module);return a[n.id]=o,o}catch(o){return console.error(`Error loading route module \`${n.module}\`, reloading page...`),console.error(o),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function PE(n){return n==null?!1:n.href==null?n.rel==="preload"&&typeof n.imageSrcSet=="string"&&typeof n.imageSizes=="string":typeof n.rel=="string"&&typeof n.href=="string"}async function IE(n,a,o){let l=await Promise.all(n.map(async u=>{let d=a.routes[u.route.id];if(d){let p=await UE(d,o);return p.links?p.links():[]}return[]}));return JE(l.flat(1).filter(PE).filter(u=>u.rel==="stylesheet"||u.rel==="preload").map(u=>u.rel==="stylesheet"?{...u,rel:"prefetch",as:"style"}:{...u,rel:"prefetch"}))}function Iv(n,a,o,l,u,d){let p=(h,v)=>o[v]?h.route.id!==o[v].route.id:!0,g=(h,v)=>o[v].pathname!==h.pathname||o[v].route.path?.endsWith("*")&&o[v].params["*"]!==h.params["*"];return d==="assets"?a.filter((h,v)=>p(h,v)||g(h,v)):d==="data"?a.filter((h,v)=>{let b=l.routes[h.route.id];if(!b||!b.hasLoader)return!1;if(p(h,v)||g(h,v))return!0;if(h.route.shouldRevalidate){let x=h.route.shouldRevalidate({currentUrl:new URL(u.pathname+u.search+u.hash,window.origin),currentParams:o[0]?.params||{},nextUrl:new URL(n,window.origin),nextParams:h.params,defaultShouldRevalidate:!0});if(typeof x=="boolean")return x}return!0}):[]}function $E(n,a,{includeHydrateFallback:o}={}){return HE(n.map(l=>{let u=a.routes[l.route.id];if(!u)return[];let d=[u.module];return u.clientActionModule&&(d=d.concat(u.clientActionModule)),u.clientLoaderModule&&(d=d.concat(u.clientLoaderModule)),o&&u.hydrateFallbackModule&&(d=d.concat(u.hydrateFallbackModule)),u.imports&&(d=d.concat(u.imports)),d}).flat(1))}function HE(n){return[...new Set(n)]}function qE(n){let a={},o=Object.keys(n).sort();for(let l of o)a[l]=n[l];return a}function JE(n,a){let o=new Set;return new Set(a),n.reduce((l,u)=>{let d=JSON.stringify(qE(u));return o.has(d)||(o.add(d),l.push({key:d,link:u})),l},[])}function Zb(){let n=m.useContext(Lo);return $f(n,"You must render this element inside a <DataRouterContext.Provider> element"),n}function GE(){let n=m.useContext(cc);return $f(n,"You must render this element inside a <DataRouterStateContext.Provider> element"),n}var Hf=m.createContext(void 0);Hf.displayName="FrameworkContext";function Kb(){let n=m.useContext(Hf);return $f(n,"You must render this element inside a <HydratedRouter> element"),n}function FE(n,a){let o=m.useContext(Hf),[l,u]=m.useState(!1),[d,p]=m.useState(!1),{onFocus:g,onBlur:h,onMouseEnter:v,onMouseLeave:b,onTouchStart:x}=a,j=m.useRef(null);m.useEffect(()=>{if(n==="render"&&p(!0),n==="viewport"){let O=k=>{k.forEach(N=>{p(N.isIntersecting)})},E=new IntersectionObserver(O,{threshold:.5});return j.current&&E.observe(j.current),()=>{E.disconnect()}}},[n]),m.useEffect(()=>{if(l){let O=setTimeout(()=>{p(!0)},100);return()=>{clearTimeout(O)}}},[l]);let S=()=>{u(!0)},C=()=>{u(!1),p(!1)};return o?n!=="intent"?[d,j,{}]:[d,j,{onFocus:Xs(g,S),onBlur:Xs(h,C),onMouseEnter:Xs(v,S),onMouseLeave:Xs(b,C),onTouchStart:Xs(x,S)}]:[!1,j,{}]}function Xs(n,a){return o=>{n&&n(o),o.defaultPrevented||a(o)}}function VE({page:n,...a}){let{router:o}=Zb(),l=m.useMemo(()=>$b(o.routes,n,o.basename),[o.routes,n,o.basename]);return l?m.createElement(XE,{page:n,matches:l,...a}):null}function YE(n){let{manifest:a,routeModules:o}=Kb(),[l,u]=m.useState([]);return m.useEffect(()=>{let d=!1;return IE(n,a,o).then(p=>{d||u(p)}),()=>{d=!0}},[n,a,o]),l}function XE({page:n,matches:a,...o}){let l=In(),{manifest:u,routeModules:d}=Kb(),{basename:p}=Zb(),{loaderData:g,matches:h}=GE(),v=m.useMemo(()=>Iv(n,a,h,u,l,"data"),[n,a,h,u,l]),b=m.useMemo(()=>Iv(n,a,h,u,l,"assets"),[n,a,h,u,l]),x=m.useMemo(()=>{if(n===l.pathname+l.search+l.hash)return[];let C=new Set,O=!1;if(a.forEach(k=>{let N=u.routes[k.route.id];!N||!N.hasLoader||(!v.some(T=>T.route.id===k.route.id)&&k.route.id in g&&d[k.route.id]?.shouldRevalidate||N.hasClientLoader?O=!0:C.add(k.route.id))}),C.size===0)return[];let E=BE(n,p,"data");return O&&C.size>0&&E.searchParams.set("_routes",a.filter(k=>C.has(k.route.id)).map(k=>k.route.id).join(",")),[E.pathname+E.search]},[p,g,l,u,v,a,n,d]),j=m.useMemo(()=>$E(b,u),[b,u]),S=YE(b);return m.createElement(m.Fragment,null,x.map(C=>m.createElement("link",{key:C,rel:"prefetch",as:"fetch",href:C,...o})),j.map(C=>m.createElement("link",{key:C,rel:"modulepreload",href:C,...o})),S.map(({key:C,link:O})=>m.createElement("link",{key:C,nonce:o.nonce,...O})))}function ZE(...n){return a=>{n.forEach(o=>{typeof o=="function"?o(a):o!=null&&(o.current=a)})}}var Qb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Qb&&(window.__reactRouterVersion="7.8.2")}catch{}function KE({basename:n,children:a,window:o}){let l=m.useRef();l.current==null&&(l.current=US({window:o,v5Compat:!0}));let u=l.current,[d,p]=m.useState({action:u.action,location:u.location}),g=m.useCallback(h=>{m.startTransition(()=>p(h))},[p]);return m.useLayoutEffect(()=>u.listen(g),[u,g]),m.createElement(AE,{basename:n,children:a,location:d.location,navigationType:d.action,navigator:u})}var Wb=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Nn=m.forwardRef(function({onClick:a,discover:o="render",prefetch:l="none",relative:u,reloadDocument:d,replace:p,state:g,target:h,to:v,preventScrollReset:b,viewTransition:x,...j},S){let{basename:C}=m.useContext(An),O=typeof v=="string"&&Wb.test(v),E,k=!1;if(typeof v=="string"&&O&&(E=v,Qb))try{let Y=new URL(window.location.href),ee=v.startsWith("//")?new URL(Y.protocol+v):new URL(v),ne=ua(ee.pathname,C);ee.origin===Y.origin&&ne!=null?v=ne+ee.search+ee.hash:k=!0}catch{gn(!1,`<Link to="${v}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let N=dE(v,{relative:u}),[T,L,B]=FE(l,j),U=tN(v,{replace:p,state:g,target:h,preventScrollReset:b,relative:u,viewTransition:x});function _(Y){a&&a(Y),Y.defaultPrevented||U(Y)}let z=m.createElement("a",{...j,...B,href:E||N,onClick:k||d?a:_,ref:ZE(S,L),target:h,"data-discover":!O&&o==="render"?"true":void 0});return T&&!O?m.createElement(m.Fragment,null,z,m.createElement(VE,{page:N})):z});Nn.displayName="Link";var QE=m.forwardRef(function({"aria-current":a="page",caseSensitive:o=!1,className:l="",end:u=!1,style:d,to:p,viewTransition:g,children:h,...v},b){let x=ci(p,{relative:v.relative}),j=In(),S=m.useContext(cc),{navigator:C,basename:O}=m.useContext(An),E=S!=null&&sN(x)&&g===!0,k=C.encodeLocation?C.encodeLocation(x).pathname:x.pathname,N=j.pathname,T=S&&S.navigation&&S.navigation.location?S.navigation.location.pathname:null;o||(N=N.toLowerCase(),T=T?T.toLowerCase():null,k=k.toLowerCase()),T&&O&&(T=ua(T,O)||T);const L=k!=="/"&&k.endsWith("/")?k.length-1:k.length;let B=N===k||!u&&N.startsWith(k)&&N.charAt(L)==="/",U=T!=null&&(T===k||!u&&T.startsWith(k)&&T.charAt(k.length)==="/"),_={isActive:B,isPending:U,isTransitioning:E},z=B?a:void 0,Y;typeof l=="function"?Y=l(_):Y=[l,B?"active":null,U?"pending":null,E?"transitioning":null].filter(Boolean).join(" ");let ee=typeof d=="function"?d(_):d;return m.createElement(Nn,{...v,"aria-current":z,className:Y,ref:b,style:ee,to:p,viewTransition:g},typeof h=="function"?h(_):h)});QE.displayName="NavLink";var WE=m.forwardRef(({discover:n="render",fetcherKey:a,navigate:o,reloadDocument:l,replace:u,state:d,method:p=Jl,action:g,onSubmit:h,relative:v,preventScrollReset:b,viewTransition:x,...j},S)=>{let C=rN(),O=oN(g,{relative:v}),E=p.toLowerCase()==="get"?"get":"post",k=typeof g=="string"&&Wb.test(g),N=T=>{if(h&&h(T),T.defaultPrevented)return;T.preventDefault();let L=T.nativeEvent.submitter,B=L?.getAttribute("formmethod")||p;C(L||T.currentTarget,{fetcherKey:a,method:B,navigate:o,replace:u,state:d,relative:v,preventScrollReset:b,viewTransition:x})};return m.createElement("form",{ref:S,method:E,action:O,onSubmit:l?h:N,...j,"data-discover":!k&&n==="render"?"true":void 0})});WE.displayName="Form";function eN(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ey(n){let a=m.useContext(Lo);return Ve(a,eN(n)),a}function tN(n,{target:a,replace:o,state:l,preventScrollReset:u,relative:d,viewTransition:p}={}){let g=On(),h=In(),v=ci(n,{relative:d});return m.useCallback(b=>{if(LE(b,a)){b.preventDefault();let x=o!==void 0?o:ai(h)===ai(v);g(n,{replace:x,state:l,preventScrollReset:u,relative:d,viewTransition:p})}},[h,g,v,o,l,a,n,u,d,p])}var nN=0,aN=()=>`__${String(++nN)}__`;function rN(){let{router:n}=ey("useSubmit"),{basename:a}=m.useContext(An),o=jE();return m.useCallback(async(l,u={})=>{let{action:d,method:p,encType:g,formData:h,body:v}=zE(l,a);if(u.navigate===!1){let b=u.fetcherKey||aN();await n.fetch(b,o,u.action||d,{preventScrollReset:u.preventScrollReset,formData:h,body:v,formMethod:u.method||p,formEncType:u.encType||g,flushSync:u.flushSync})}else await n.navigate(u.action||d,{preventScrollReset:u.preventScrollReset,formData:h,body:v,formMethod:u.method||p,formEncType:u.encType||g,replace:u.replace,state:u.state,fromRouteId:o,flushSync:u.flushSync,viewTransition:u.viewTransition})},[n,a,o])}function oN(n,{relative:a}={}){let{basename:o}=m.useContext(An),l=m.useContext(Pn);Ve(l,"useFormAction must be used inside a RouteContext");let[u]=l.matches.slice(-1),d={...ci(n||".",{relative:a})},p=In();if(n==null){d.search=p.search;let g=new URLSearchParams(d.search),h=g.getAll("index");if(h.some(b=>b==="")){g.delete("index"),h.filter(x=>x).forEach(x=>g.append("index",x));let b=g.toString();d.search=b?`?${b}`:""}}return(!n||n===".")&&u.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),o!=="/"&&(d.pathname=d.pathname==="/"?o:ia([o,d.pathname])),ai(d)}function sN(n,{relative:a}={}){let o=m.useContext(Gb);Ve(o!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:l}=ey("useViewTransitionState"),u=ci(n,{relative:a});if(!o.isTransitioning)return!1;let d=ua(o.currentLocation.pathname,l)||o.currentLocation.pathname,p=ua(o.nextLocation.pathname,l)||o.nextLocation.pathname;return Yl(u.pathname,p)!=null||Yl(u.pathname,d)!=null}var iN=Ib();const gr=Do(iN),pf="backends_config";function ty(){try{const n=localStorage.getItem(pf);return n&&JSON.parse(n)?.active?.url||null}catch(n){return console.error("❌ Error leyendo backend desde localStorage",n),null}}function lN(n){try{if(!n)return;const a=localStorage.getItem(pf);if(!a)return;const o=JSON.parse(a);localStorage.setItem(pf,JSON.stringify({...o,active:{...o.active,url:n}}))}catch(a){console.warn("⚠️ No se pudo sincronizar backendURLGlobal",a)}}const $v="backends_config",ny=m.createContext();function cN({children:n}){const[a,o]=m.useState([]),[l,u]=m.useState(null),[d,p]=m.useState(!1),[g,h]=m.useState(!0);m.useEffect(()=>{const j=localStorage.getItem($v);if(j)try{const S=JSON.parse(j);o(S.backends||[]),u(S.active||null)}catch(S){console.error("⚠️ Error parseando backends_config",S)}p(!0),h(!1)},[]),m.useEffect(()=>{d&&localStorage.setItem($v,JSON.stringify({backends:a,active:l}))},[a,l,d]),m.useEffect(()=>{l?.url&&lN(l.url)},[l]);const v=(j,S,C=null)=>{if(!j?.trim()||!S?.trim())throw new Error("Alias y URL son obligatorios");if(a.some(E=>E.alias===j.trim()))throw new Error(`Ya existe un backend con alias "${j}"`);const O={id:crypto.randomUUID(),alias:j.trim(),url:S.trim().charAt(0).toLowerCase()+S.trim().slice(1),avatar:C};o(E=>[...E,O]),l||u(O)},b=j=>{o(S=>S.filter(C=>C.alias!==j)),l?.alias===j&&u(null)},x=j=>{const S=a.find(C=>C.alias===j);S&&l?.alias!==S.alias&&(localStorage.removeItem("auth_session"),u(S),setTimeout(()=>{window.location.replace(window.location.origin+window.location.pathname)},100))};return s.jsx(ny.Provider,{value:{backends:a,activeBackend:l,addBackend:v,deleteBackend:b,setActiveBackend:x,loading:g},children:n})}function dc(){return m.useContext(ny)}const uN="auth_session";class qf extends Error{constructor(a="Autenticación requerida"){super(a),this.name="AuthRequiredError"}}function _o(){try{return JSON.parse(localStorage.getItem(uN))?.token||null}catch{return null}}function Jf(n){console.warn("notifyAuthRequired:",n);try{window.dispatchEvent(new CustomEvent("auth:required",{detail:{message:n}}))}catch(a){console.error("Error dispatching auth:required",a)}}async function ay(n){if(!n.ok)throw new Error(`Error HTTP ${n.status}: ${n.statusText}`);const a=await n.json();if(a.status==="token_invalido"||a.autorizado===!1&&a.motivo==="token_invalido"){const o=a.mensaje||"Token inválido o sesión expirada";throw Jf(o),new qf(o)}if(a.status==="sin_permiso"){const o=a.mensaje||"No tiene permiso para realizar esta acción";throw console.warn("⛔ Acción bloqueada por permisos:",o),new Error(o)}if(a.status&&!["ok","exists","warning","error_validacion","error_campos","archivo_existente"].includes(a.status))throw new Error(a.mensaje||"Error en respuesta del servidor");return a}async function hn(n,a={}){const o=ty();if(!o)throw new Error("Backend no configurado");const l=_o();if(!l)throw Jf("No hay token en localStorage"),new qf("No hay token de sesión");const u=new URLSearchParams({accion:n,...a,token:l});try{const d=await fetch(`${o}?${u.toString()}`,{credentials:"omit"});return await ay(d,n)}catch(d){throw console.error(`❌ apiGet [${n}]`,d),d}}async function Ze(n,a={}){const o=ty();if(!o)throw new Error("Backend no configurado");const l=_o();if(!l)throw Jf("No hay token en localStorage"),new qf("No hay token de sesión");const u={accion:n,...a,token:l};try{const d=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u),credentials:"omit"});if(n==="generarBackupZIP"){if(!d.ok)throw new Error(`Error HTTP ${d.status}: ${d.statusText}`);const p=await d.json();if(p.status==="ok"&&p.base64){const g=atob(p.base64),h=new Array(g.length);for(let x=0;x<g.length;x++)h[x]=g.charCodeAt(x);const v=new Uint8Array(h),b=new Blob([v],{type:p.mimeType||"application/zip"});return{status:"ok",mensaje:p.mensaje,blob:b,nombreArchivo:p.nombreArchivo}}return p}return await ay(d,n)}catch(d){throw console.error(`❌ apiPost [${n}]`,d),d}}var Xd={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Hv;function dN(){return Hv||(Hv=1,(function(n){(function(){var a={}.hasOwnProperty;function o(){for(var d="",p=0;p<arguments.length;p++){var g=arguments[p];g&&(d=u(d,l(g)))}return d}function l(d){if(typeof d=="string"||typeof d=="number")return d;if(typeof d!="object")return"";if(Array.isArray(d))return o.apply(null,d);if(d.toString!==Object.prototype.toString&&!d.toString.toString().includes("[native code]"))return d.toString();var p="";for(var g in d)a.call(d,g)&&d[g]&&(p=u(p,g));return p}function u(d,p){return p?d?d+" "+p:d+p:d}n.exports?(o.default=o,n.exports=o):window.classNames=o})()})(Xd)),Xd.exports}var fN=dN();const ce=Do(fN);function hf(){return hf=Object.assign?Object.assign.bind():function(n){for(var a=1;a<arguments.length;a++){var o=arguments[a];for(var l in o)({}).hasOwnProperty.call(o,l)&&(n[l]=o[l])}return n},hf.apply(null,arguments)}function ry(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)!==-1)continue;o[l]=n[l]}return o}function qv(n){return"default"+n.charAt(0).toUpperCase()+n.substr(1)}function mN(n){var a=pN(n,"string");return typeof a=="symbol"?a:String(a)}function pN(n,a){if(typeof n!="object"||n===null)return n;var o=n[Symbol.toPrimitive];if(o!==void 0){var l=o.call(n,a);if(typeof l!="object")return l;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(n)}function oy(n,a,o){var l=m.useRef(n!==void 0),u=m.useState(a),d=u[0],p=u[1],g=n!==void 0,h=l.current;return l.current=g,!g&&h&&d!==a&&p(a),[g?n:d,m.useCallback(function(v){for(var b=arguments.length,x=new Array(b>1?b-1:0),j=1;j<b;j++)x[j-1]=arguments[j];o&&o.apply(void 0,[v].concat(x)),p(v)},[o])]}function fc(n,a){return Object.keys(a).reduce(function(o,l){var u,d=o,p=d[qv(l)],g=d[l],h=ry(d,[qv(l),l].map(mN)),v=a[l],b=oy(g,p,n[v]),x=b[0],j=b[1];return hf({},h,(u={},u[l]=x,u[v]=j,u))},n)}function gf(n,a){return gf=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(o,l){return o.__proto__=l,o},gf(n,a)}function hN(n,a){n.prototype=Object.create(a.prototype),n.prototype.constructor=n,gf(n,a)}const gN=["xxl","xl","lg","md","sm","xs"],vN="xs",ui=m.createContext({prefixes:{},breakpoints:gN,minBreakpoint:vN}),{Consumer:KT,Provider:QT}=ui;function de(n,a){const{prefixes:o}=m.useContext(ui);return n||o[a]||a}function sy(){const{breakpoints:n}=m.useContext(ui);return n}function iy(){const{minBreakpoint:n}=m.useContext(ui);return n}function mc(){const{dir:n}=m.useContext(ui);return n==="rtl"}function zo(n){return n&&n.ownerDocument||document}function bN(n){var a=zo(n);return a&&a.defaultView||window}function yN(n,a){return bN(n).getComputedStyle(n,a)}var xN=/([A-Z])/g;function wN(n){return n.replace(xN,"-$1").toLowerCase()}var jN=/^ms-/;function Ul(n){return wN(n).replace(jN,"-ms-")}var SN=/^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i;function EN(n){return!!(n&&SN.test(n))}function la(n,a){var o="",l="";if(typeof a=="string")return n.style.getPropertyValue(Ul(a))||yN(n).getPropertyValue(Ul(a));Object.keys(a).forEach(function(u){var d=a[u];!d&&d!==0?n.style.removeProperty(Ul(u)):EN(u)?l+=u+"("+d+") ":o+=Ul(u)+": "+d+";"}),l&&(o+="transform: "+l+";"),n.style.cssText+=";"+o}var Zd={exports:{}},Kd,Jv;function NN(){if(Jv)return Kd;Jv=1;var n="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return Kd=n,Kd}var Qd,Gv;function CN(){if(Gv)return Qd;Gv=1;var n=NN();function a(){}function o(){}return o.resetWarningCache=a,Qd=function(){function l(p,g,h,v,b,x){if(x!==n){var j=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw j.name="Invariant Violation",j}}l.isRequired=l;function u(){return l}var d={array:l,bigint:l,bool:l,func:l,number:l,object:l,string:l,symbol:l,any:l,arrayOf:u,element:l,elementType:l,instanceOf:u,node:l,objectOf:u,oneOf:u,oneOfType:u,shape:u,exact:u,checkPropTypes:o,resetWarningCache:a};return d.PropTypes=d,d},Qd}var Fv;function AN(){return Fv||(Fv=1,Zd.exports=CN()()),Zd.exports}var ON=AN();const _e=Do(ON),Vv={disabled:!1},ly=Fe.createContext(null);var kN=function(a){return a.scrollTop},Ws="unmounted",Ja="exited",mn="entering",oa="entered",No="exiting",ha=(function(n){hN(a,n);function a(l,u){var d;d=n.call(this,l,u)||this;var p=u,g=p&&!p.isMounting?l.enter:l.appear,h;return d.appearStatus=null,l.in?g?(h=Ja,d.appearStatus=mn):h=oa:l.unmountOnExit||l.mountOnEnter?h=Ws:h=Ja,d.state={status:h},d.nextCallback=null,d}a.getDerivedStateFromProps=function(u,d){var p=u.in;return p&&d.status===Ws?{status:Ja}:null};var o=a.prototype;return o.componentDidMount=function(){this.updateStatus(!0,this.appearStatus)},o.componentDidUpdate=function(u){var d=null;if(u!==this.props){var p=this.state.status;this.props.in?p!==mn&&p!==oa&&(d=mn):(p===mn||p===oa)&&(d=No)}this.updateStatus(!1,d)},o.componentWillUnmount=function(){this.cancelNextCallback()},o.getTimeouts=function(){var u=this.props.timeout,d,p,g;return d=p=g=u,u!=null&&typeof u!="number"&&(d=u.exit,p=u.enter,g=u.appear!==void 0?u.appear:p),{exit:d,enter:p,appear:g}},o.updateStatus=function(u,d){if(u===void 0&&(u=!1),d!==null)if(this.cancelNextCallback(),d===mn){if(this.props.unmountOnExit||this.props.mountOnEnter){var p=this.props.nodeRef?this.props.nodeRef.current:gr.findDOMNode(this);p&&kN(p)}this.performEnter(u)}else this.performExit();else this.props.unmountOnExit&&this.state.status===Ja&&this.setState({status:Ws})},o.performEnter=function(u){var d=this,p=this.props.enter,g=this.context?this.context.isMounting:u,h=this.props.nodeRef?[g]:[gr.findDOMNode(this),g],v=h[0],b=h[1],x=this.getTimeouts(),j=g?x.appear:x.enter;if(!u&&!p||Vv.disabled){this.safeSetState({status:oa},function(){d.props.onEntered(v)});return}this.props.onEnter(v,b),this.safeSetState({status:mn},function(){d.props.onEntering(v,b),d.onTransitionEnd(j,function(){d.safeSetState({status:oa},function(){d.props.onEntered(v,b)})})})},o.performExit=function(){var u=this,d=this.props.exit,p=this.getTimeouts(),g=this.props.nodeRef?void 0:gr.findDOMNode(this);if(!d||Vv.disabled){this.safeSetState({status:Ja},function(){u.props.onExited(g)});return}this.props.onExit(g),this.safeSetState({status:No},function(){u.props.onExiting(g),u.onTransitionEnd(p.exit,function(){u.safeSetState({status:Ja},function(){u.props.onExited(g)})})})},o.cancelNextCallback=function(){this.nextCallback!==null&&(this.nextCallback.cancel(),this.nextCallback=null)},o.safeSetState=function(u,d){d=this.setNextCallback(d),this.setState(u,d)},o.setNextCallback=function(u){var d=this,p=!0;return this.nextCallback=function(g){p&&(p=!1,d.nextCallback=null,u(g))},this.nextCallback.cancel=function(){p=!1},this.nextCallback},o.onTransitionEnd=function(u,d){this.setNextCallback(d);var p=this.props.nodeRef?this.props.nodeRef.current:gr.findDOMNode(this),g=u==null&&!this.props.addEndListener;if(!p||g){setTimeout(this.nextCallback,0);return}if(this.props.addEndListener){var h=this.props.nodeRef?[this.nextCallback]:[p,this.nextCallback],v=h[0],b=h[1];this.props.addEndListener(v,b)}u!=null&&setTimeout(this.nextCallback,u)},o.render=function(){var u=this.state.status;if(u===Ws)return null;var d=this.props,p=d.children;d.in,d.mountOnEnter,d.unmountOnExit,d.appear,d.enter,d.exit,d.timeout,d.addEndListener,d.onEnter,d.onEntering,d.onEntered,d.onExit,d.onExiting,d.onExited,d.nodeRef;var g=ry(d,["children","in","mountOnEnter","unmountOnExit","appear","enter","exit","timeout","addEndListener","onEnter","onEntering","onEntered","onExit","onExiting","onExited","nodeRef"]);return Fe.createElement(ly.Provider,{value:null},typeof p=="function"?p(u,g):Fe.cloneElement(Fe.Children.only(p),g))},a})(Fe.Component);ha.contextType=ly;ha.propTypes={};function vo(){}ha.defaultProps={in:!1,mountOnEnter:!1,unmountOnExit:!1,appear:!1,enter:!0,exit:!0,onEnter:vo,onEntering:vo,onEntered:vo,onExit:vo,onExiting:vo,onExited:vo};ha.UNMOUNTED=Ws;ha.EXITED=Ja;ha.ENTERING=mn;ha.ENTERED=oa;ha.EXITING=No;function cy(n){return n.code==="Escape"||n.keyCode===27}function TN(){const n=m.version.split(".");return{major:+n[0],minor:+n[1],patch:+n[2]}}function Er(n){if(!n||typeof n=="function")return null;const{major:a}=TN();return a>=19?n.props.ref:n.ref}const Bo=!!(typeof window<"u"&&window.document&&window.document.createElement);var vf=!1,bf=!1;try{var Wd={get passive(){return vf=!0},get once(){return bf=vf=!0}};Bo&&(window.addEventListener("test",Wd,Wd),window.removeEventListener("test",Wd,!0))}catch{}function Gf(n,a,o,l){if(l&&typeof l!="boolean"&&!bf){var u=l.once,d=l.capture,p=o;!bf&&u&&(p=o.__once||function g(h){this.removeEventListener(a,g,d),o.call(this,h)},o.__once=p),n.addEventListener(a,p,vf?l:d)}n.addEventListener(a,o,l)}function yf(n,a,o,l){var u=l&&typeof l!="boolean"?l.capture:l;n.removeEventListener(a,o,u),o.__once&&n.removeEventListener(a,o.__once,u)}function sa(n,a,o,l){return Gf(n,a,o,l),function(){yf(n,a,o,l)}}function RN(n,a,o,l){if(l===void 0&&(l=!0),n){var u=document.createEvent("HTMLEvents");u.initEvent(a,o,l),n.dispatchEvent(u)}}function DN(n){var a=la(n,"transitionDuration")||"",o=a.indexOf("ms")===-1?1e3:1;return parseFloat(a)*o}function LN(n,a,o){o===void 0&&(o=5);var l=!1,u=setTimeout(function(){l||RN(n,"transitionend",!0)},a+o),d=sa(n,"transitionend",function(){l=!0},{once:!0});return function(){clearTimeout(u),d()}}function uy(n,a,o,l){o==null&&(o=DN(n)||0);var u=LN(n,o,l),d=sa(n,"transitionend",a);return function(){u(),d()}}function Yv(n,a){const o=la(n,a)||"",l=o.indexOf("ms")===-1?1e3:1;return parseFloat(o)*l}function Ff(n,a){const o=Yv(n,"transitionDuration"),l=Yv(n,"transitionDelay"),u=uy(n,d=>{d.target===n&&(u(),a(d))},o+l)}function Zs(...n){return n.filter(a=>a!=null).reduce((a,o)=>{if(typeof o!="function")throw new Error("Invalid Argument Type, must only provide functions, undefined, or null.");return a===null?o:function(...u){a.apply(this,u),o.apply(this,u)}},null)}function dy(n){n.offsetHeight}const Xv=n=>!n||typeof n=="function"?n:a=>{n.current=a};function MN(n,a){const o=Xv(n),l=Xv(a);return u=>{o&&o(u),l&&l(u)}}function Uo(n,a){return m.useMemo(()=>MN(n,a),[n,a])}function Xl(n){return n&&"setState"in n?gr.findDOMNode(n):n??null}const pc=Fe.forwardRef(({onEnter:n,onEntering:a,onEntered:o,onExit:l,onExiting:u,onExited:d,addEndListener:p,children:g,childRef:h,...v},b)=>{const x=m.useRef(null),j=Uo(x,h),S=U=>{j(Xl(U))},C=U=>_=>{U&&x.current&&U(x.current,_)},O=m.useCallback(C(n),[n]),E=m.useCallback(C(a),[a]),k=m.useCallback(C(o),[o]),N=m.useCallback(C(l),[l]),T=m.useCallback(C(u),[u]),L=m.useCallback(C(d),[d]),B=m.useCallback(C(p),[p]);return s.jsx(ha,{ref:b,...v,onEnter:O,onEntered:k,onEntering:E,onExit:N,onExited:L,onExiting:T,addEndListener:B,nodeRef:x,children:typeof g=="function"?(U,_)=>g(U,{..._,ref:S}):Fe.cloneElement(g,{ref:S})})});pc.displayName="TransitionWrapper";const _N={height:["marginTop","marginBottom"],width:["marginLeft","marginRight"]};function zN(n,a){const o=`offset${n[0].toUpperCase()}${n.slice(1)}`,l=a[o],u=_N[n];return l+parseInt(la(a,u[0]),10)+parseInt(la(a,u[1]),10)}const BN={[Ja]:"collapse",[No]:"collapsing",[mn]:"collapsing",[oa]:"collapse show"},fy=Fe.forwardRef(({onEnter:n,onEntering:a,onEntered:o,onExit:l,onExiting:u,className:d,children:p,dimension:g="height",in:h=!1,timeout:v=300,mountOnEnter:b=!1,unmountOnExit:x=!1,appear:j=!1,getDimensionValue:S=zN,...C},O)=>{const E=typeof g=="function"?g():g,k=m.useMemo(()=>Zs(U=>{U.style[E]="0"},n),[E,n]),N=m.useMemo(()=>Zs(U=>{const _=`scroll${E[0].toUpperCase()}${E.slice(1)}`;U.style[E]=`${U[_]}px`},a),[E,a]),T=m.useMemo(()=>Zs(U=>{U.style[E]=null},o),[E,o]),L=m.useMemo(()=>Zs(U=>{U.style[E]=`${S(E,U)}px`,dy(U)},l),[l,S,E]),B=m.useMemo(()=>Zs(U=>{U.style[E]=null},u),[E,u]);return s.jsx(pc,{ref:O,addEndListener:Ff,...C,"aria-expanded":C.role?h:null,onEnter:k,onEntering:N,onEntered:T,onExit:L,onExiting:B,childRef:Er(p),in:h,timeout:v,mountOnEnter:b,unmountOnExit:x,appear:j,children:(U,_)=>Fe.cloneElement(p,{..._,className:ce(d,p.props.className,BN[U],E==="width"&&"collapse-horizontal")})})});fy.displayName="Collapse";function UN(n){const a=m.useRef(n);return m.useEffect(()=>{a.current=n},[n]),a}function da(n){const a=UN(n);return m.useCallback(function(...o){return a.current&&a.current(...o)},[a])}const hc=(n=>m.forwardRef((a,o)=>s.jsx("div",{...a,ref:o,className:ce(a.className,n)})));function xf(){return m.useState(null)}function PN(n){const a=m.useRef(n);return m.useEffect(()=>{a.current=n},[n]),a}function gt(n){const a=PN(n);return m.useCallback(function(...o){return a.current&&a.current(...o)},[a])}function IN(n,a,o,l=!1){const u=gt(o);m.useEffect(()=>{const d=typeof n=="function"?n():n;return d.addEventListener(a,u,l),()=>d.removeEventListener(a,u,l)},[n])}function my(){const n=m.useRef(!0),a=m.useRef(()=>n.current);return m.useEffect(()=>(n.current=!0,()=>{n.current=!1}),[]),a.current}function py(n){const a=m.useRef(null);return m.useEffect(()=>{a.current=n}),a.current}const $N=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",HN=typeof document<"u",Zv=HN||$N?m.useLayoutEffect:m.useEffect,qN=["as","disabled"];function JN(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function GN(n){return!n||n.trim()==="#"}function Vf({tagName:n,disabled:a,href:o,target:l,rel:u,role:d,onClick:p,tabIndex:g=0,type:h}){n||(o!=null||l!=null||u!=null?n="a":n="button");const v={tagName:n};if(n==="button")return[{type:h||"button",disabled:a},v];const b=j=>{if((a||n==="a"&&GN(o))&&j.preventDefault(),a){j.stopPropagation();return}p?.(j)},x=j=>{j.key===" "&&(j.preventDefault(),b(j))};return n==="a"&&(o||(o="#"),a&&(o=void 0)),[{role:d??"button",disabled:void 0,tabIndex:a?void 0:g,href:o,target:n==="a"?l:void 0,"aria-disabled":a||void 0,rel:n==="a"?u:void 0,onClick:b,onKeyDown:x},v]}const Yf=m.forwardRef((n,a)=>{let{as:o,disabled:l}=n,u=JN(n,qN);const[d,{tagName:p}]=Vf(Object.assign({tagName:o,disabled:l},u));return s.jsx(p,Object.assign({},u,d,{ref:a}))});Yf.displayName="Button";const FN=["onKeyDown"];function VN(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function YN(n){return!n||n.trim()==="#"}const Xf=m.forwardRef((n,a)=>{let{onKeyDown:o}=n,l=VN(n,FN);const[u]=Vf(Object.assign({tagName:"a"},l)),d=gt(p=>{u.onKeyDown(p),o?.(p)});return YN(l.href)||l.role==="button"?s.jsx("a",Object.assign({ref:a},l,u,{onKeyDown:d})):s.jsx("a",Object.assign({ref:a},l,{onKeyDown:o}))});Xf.displayName="Anchor";const XN={[mn]:"show",[oa]:"show"},fa=m.forwardRef(({className:n,children:a,transitionClasses:o={},onEnter:l,...u},d)=>{const p={in:!1,timeout:300,mountOnEnter:!1,unmountOnExit:!1,appear:!1,...u},g=m.useCallback((h,v)=>{dy(h),l?.(h,v)},[l]);return s.jsx(pc,{ref:d,addEndListener:Ff,...p,onEnter:g,childRef:Er(a),children:(h,v)=>m.cloneElement(a,{...v,className:ce("fade",n,a.props.className,XN[h],o[h])})})});fa.displayName="Fade";const ZN={"aria-label":_e.string,onClick:_e.func,variant:_e.oneOf(["white"])},gc=m.forwardRef(({className:n,variant:a,"aria-label":o="Close",...l},u)=>s.jsx("button",{ref:u,type:"button",className:ce("btn-close",a&&`btn-close-${a}`,n),"aria-label":o,...l}));gc.displayName="CloseButton";gc.propTypes=ZN;const xo=m.forwardRef(({bsPrefix:n,bg:a="primary",pill:o=!1,text:l,className:u,as:d="span",...p},g)=>{const h=de(n,"badge");return s.jsx(d,{ref:g,...p,className:ce(u,h,o&&"rounded-pill",l&&`text-${l}`,a&&`bg-${a}`)})});xo.displayName="Badge";const Oe=m.forwardRef(({as:n,bsPrefix:a,variant:o="primary",size:l,active:u=!1,disabled:d=!1,className:p,...g},h)=>{const v=de(a,"btn"),[b,{tagName:x}]=Vf({tagName:n,disabled:d,...g}),j=x;return s.jsx(j,{...b,...g,ref:h,disabled:d,className:ce(p,v,u&&"active",o&&`${v}-${o}`,l&&`${v}-${l}`,g.href&&d&&"disabled")})});Oe.displayName="Button";const Zf=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"card-body"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Zf.displayName="CardBody";const hy=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"card-footer"),s.jsx(o,{ref:u,className:ce(n,a),...l})));hy.displayName="CardFooter";const Kf=m.createContext(null);Kf.displayName="CardHeaderContext";const gy=m.forwardRef(({bsPrefix:n,className:a,as:o="div",...l},u)=>{const d=de(n,"card-header"),p=m.useMemo(()=>({cardHeaderBsPrefix:d}),[d]);return s.jsx(Kf.Provider,{value:p,children:s.jsx(o,{ref:u,...l,className:ce(a,d)})})});gy.displayName="CardHeader";const vy=m.forwardRef(({bsPrefix:n,className:a,variant:o,as:l="img",...u},d)=>{const p=de(n,"card-img");return s.jsx(l,{ref:d,className:ce(o?`${p}-${o}`:p,a),...u})});vy.displayName="CardImg";const by=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"card-img-overlay"),s.jsx(o,{ref:u,className:ce(n,a),...l})));by.displayName="CardImgOverlay";const yy=m.forwardRef(({className:n,bsPrefix:a,as:o="a",...l},u)=>(a=de(a,"card-link"),s.jsx(o,{ref:u,className:ce(n,a),...l})));yy.displayName="CardLink";const KN=hc("h6"),xy=m.forwardRef(({className:n,bsPrefix:a,as:o=KN,...l},u)=>(a=de(a,"card-subtitle"),s.jsx(o,{ref:u,className:ce(n,a),...l})));xy.displayName="CardSubtitle";const wy=m.forwardRef(({className:n,bsPrefix:a,as:o="p",...l},u)=>(a=de(a,"card-text"),s.jsx(o,{ref:u,className:ce(n,a),...l})));wy.displayName="CardText";const QN=hc("h5"),jy=m.forwardRef(({className:n,bsPrefix:a,as:o=QN,...l},u)=>(a=de(a,"card-title"),s.jsx(o,{ref:u,className:ce(n,a),...l})));jy.displayName="CardTitle";const Sy=m.forwardRef(({bsPrefix:n,className:a,bg:o,text:l,border:u,body:d=!1,children:p,as:g="div",...h},v)=>{const b=de(n,"card");return s.jsx(g,{ref:v,...h,className:ce(a,b,o&&`bg-${o}`,l&&`text-${l}`,u&&`border-${u}`),children:d?s.jsx(Zf,{children:p}):p})});Sy.displayName="Card";const wo=Object.assign(Sy,{Img:vy,Title:jy,Subtitle:xy,Body:Zf,Link:yy,Text:wy,Header:gy,Footer:hy,ImgOverlay:by});function WN(){const n=m.useRef(!0),a=m.useRef(()=>n.current);return m.useEffect(()=>(n.current=!0,()=>{n.current=!1}),[]),a.current}function e2(n){const a=m.useRef(n);return a.current=n,a}function Ey(n){const a=e2(n);m.useEffect(()=>()=>a.current(),[])}const wf=2**31-1;function Ny(n,a,o){const l=o-Date.now();n.current=l<=wf?setTimeout(a,l):setTimeout(()=>Ny(n,a,o),wf)}function Cy(){const n=WN(),a=m.useRef();return Ey(()=>clearTimeout(a.current)),m.useMemo(()=>{const o=()=>clearTimeout(a.current);function l(u,d=0){n()&&(o(),d<=wf?a.current=setTimeout(u,d):Ny(a,u,Date.now()+d))}return{set:l,clear:o,handleRef:a}},[])}function Kv(n,a){let o=0;return m.Children.map(n,l=>m.isValidElement(l)?a(l,o++):l)}function t2(n,a){let o=0;m.Children.forEach(n,l=>{m.isValidElement(l)&&a(l,o++)})}function n2(n,a){return m.Children.toArray(n).some(o=>m.isValidElement(o)&&o.type===a)}function a2({as:n,bsPrefix:a,className:o,...l}){a=de(a,"col");const u=sy(),d=iy(),p=[],g=[];return u.forEach(h=>{const v=l[h];delete l[h];let b,x,j;typeof v=="object"&&v!=null?{span:b,offset:x,order:j}=v:b=v;const S=h!==d?`-${h}`:"";b&&p.push(b===!0?`${a}${S}`:`${a}${S}-${b}`),j!=null&&g.push(`order${S}-${j}`),x!=null&&g.push(`offset${S}-${x}`)}),[{...l,className:ce(o,...p,...g)},{as:n,bsPrefix:a,spans:p}]}const Cn=m.forwardRef((n,a)=>{const[{className:o,...l},{as:u="div",bsPrefix:d,spans:p}]=a2(n);return s.jsx(u,{...l,ref:a,className:ce(o,!p.length&&d)})});Cn.displayName="Col";const Po=m.forwardRef(({bsPrefix:n,fluid:a=!1,as:o="div",className:l,...u},d)=>{const p=de(n,"container"),g=typeof a=="string"?`-${a}`:"-fluid";return s.jsx(o,{ref:d,...u,className:ce(l,a?`${p}${g}`:p)})});Po.displayName="Container";var r2=Function.prototype.bind.call(Function.prototype.call,[].slice);function ra(n,a){return r2(n.querySelectorAll(a))}function Ay(n,a,o){const l=m.useRef(n!==void 0),[u,d]=m.useState(a),p=n!==void 0,g=l.current;return l.current=p,!p&&g&&u!==a&&d(a),[p?n:u,m.useCallback((...h)=>{const[v,...b]=h;let x=o?.(v,...b);return d(v),x},[o])]}function Oy(){const[,n]=m.useReducer(a=>a+1,0);return n}const vc=m.createContext(null);var Qv=Object.prototype.hasOwnProperty;function Wv(n,a,o){for(o of n.keys())if(ei(o,a))return o}function ei(n,a){var o,l,u;if(n===a)return!0;if(n&&a&&(o=n.constructor)===a.constructor){if(o===Date)return n.getTime()===a.getTime();if(o===RegExp)return n.toString()===a.toString();if(o===Array){if((l=n.length)===a.length)for(;l--&&ei(n[l],a[l]););return l===-1}if(o===Set){if(n.size!==a.size)return!1;for(l of n)if(u=l,u&&typeof u=="object"&&(u=Wv(a,u),!u)||!a.has(u))return!1;return!0}if(o===Map){if(n.size!==a.size)return!1;for(l of n)if(u=l[0],u&&typeof u=="object"&&(u=Wv(a,u),!u)||!ei(l[1],a.get(u)))return!1;return!0}if(o===ArrayBuffer)n=new Uint8Array(n),a=new Uint8Array(a);else if(o===DataView){if((l=n.byteLength)===a.byteLength)for(;l--&&n.getInt8(l)===a.getInt8(l););return l===-1}if(ArrayBuffer.isView(n)){if((l=n.byteLength)===a.byteLength)for(;l--&&n[l]===a[l];);return l===-1}if(!o||typeof n=="object"){l=0;for(o in n)if(Qv.call(n,o)&&++l&&!Qv.call(a,o)||!(o in a)||!ei(n[o],a[o]))return!1;return Object.keys(a).length===l}}return n!==n&&a!==a}function o2(n){const a=my();return[n[0],m.useCallback(o=>{if(a())return n[1](o)},[a,n[1]])]}var Lt="top",vn="bottom",bn="right",Mt="left",Qf="auto",di=[Lt,vn,bn,Mt],Co="start",ri="end",s2="clippingParents",ky="viewport",Ks="popper",i2="reference",eb=di.reduce(function(n,a){return n.concat([a+"-"+Co,a+"-"+ri])},[]),Ty=[].concat(di,[Qf]).reduce(function(n,a){return n.concat([a,a+"-"+Co,a+"-"+ri])},[]),l2="beforeRead",c2="read",u2="afterRead",d2="beforeMain",f2="main",m2="afterMain",p2="beforeWrite",h2="write",g2="afterWrite",v2=[l2,c2,u2,d2,f2,m2,p2,h2,g2];function _n(n){return n.split("-")[0]}function Vt(n){if(n==null)return window;if(n.toString()!=="[object Window]"){var a=n.ownerDocument;return a&&a.defaultView||window}return n}function yr(n){var a=Vt(n).Element;return n instanceof a||n instanceof Element}function zn(n){var a=Vt(n).HTMLElement;return n instanceof a||n instanceof HTMLElement}function Wf(n){if(typeof ShadowRoot>"u")return!1;var a=Vt(n).ShadowRoot;return n instanceof a||n instanceof ShadowRoot}var vr=Math.max,Zl=Math.min,Ao=Math.round;function jf(){var n=navigator.userAgentData;return n!=null&&n.brands&&Array.isArray(n.brands)?n.brands.map(function(a){return a.brand+"/"+a.version}).join(" "):navigator.userAgent}function Ry(){return!/^((?!chrome|android).)*safari/i.test(jf())}function Oo(n,a,o){a===void 0&&(a=!1),o===void 0&&(o=!1);var l=n.getBoundingClientRect(),u=1,d=1;a&&zn(n)&&(u=n.offsetWidth>0&&Ao(l.width)/n.offsetWidth||1,d=n.offsetHeight>0&&Ao(l.height)/n.offsetHeight||1);var p=yr(n)?Vt(n):window,g=p.visualViewport,h=!Ry()&&o,v=(l.left+(h&&g?g.offsetLeft:0))/u,b=(l.top+(h&&g?g.offsetTop:0))/d,x=l.width/u,j=l.height/d;return{width:x,height:j,top:b,right:v+x,bottom:b+j,left:v,x:v,y:b}}function em(n){var a=Oo(n),o=n.offsetWidth,l=n.offsetHeight;return Math.abs(a.width-o)<=1&&(o=a.width),Math.abs(a.height-l)<=1&&(l=a.height),{x:n.offsetLeft,y:n.offsetTop,width:o,height:l}}function Dy(n,a){var o=a.getRootNode&&a.getRootNode();if(n.contains(a))return!0;if(o&&Wf(o)){var l=a;do{if(l&&n.isSameNode(l))return!0;l=l.parentNode||l.host}while(l)}return!1}function Va(n){return n?(n.nodeName||"").toLowerCase():null}function ma(n){return Vt(n).getComputedStyle(n)}function b2(n){return["table","td","th"].indexOf(Va(n))>=0}function Ya(n){return((yr(n)?n.ownerDocument:n.document)||window.document).documentElement}function bc(n){return Va(n)==="html"?n:n.assignedSlot||n.parentNode||(Wf(n)?n.host:null)||Ya(n)}function tb(n){return!zn(n)||ma(n).position==="fixed"?null:n.offsetParent}function y2(n){var a=/firefox/i.test(jf()),o=/Trident/i.test(jf());if(o&&zn(n)){var l=ma(n);if(l.position==="fixed")return null}var u=bc(n);for(Wf(u)&&(u=u.host);zn(u)&&["html","body"].indexOf(Va(u))<0;){var d=ma(u);if(d.transform!=="none"||d.perspective!=="none"||d.contain==="paint"||["transform","perspective"].indexOf(d.willChange)!==-1||a&&d.willChange==="filter"||a&&d.filter&&d.filter!=="none")return u;u=u.parentNode}return null}function fi(n){for(var a=Vt(n),o=tb(n);o&&b2(o)&&ma(o).position==="static";)o=tb(o);return o&&(Va(o)==="html"||Va(o)==="body"&&ma(o).position==="static")?a:o||y2(n)||a}function tm(n){return["top","bottom"].indexOf(n)>=0?"x":"y"}function ti(n,a,o){return vr(n,Zl(a,o))}function x2(n,a,o){var l=ti(n,a,o);return l>o?o:l}function Ly(){return{top:0,right:0,bottom:0,left:0}}function My(n){return Object.assign({},Ly(),n)}function _y(n,a){return a.reduce(function(o,l){return o[l]=n,o},{})}var w2=function(a,o){return a=typeof a=="function"?a(Object.assign({},o.rects,{placement:o.placement})):a,My(typeof a!="number"?a:_y(a,di))};function j2(n){var a,o=n.state,l=n.name,u=n.options,d=o.elements.arrow,p=o.modifiersData.popperOffsets,g=_n(o.placement),h=tm(g),v=[Mt,bn].indexOf(g)>=0,b=v?"height":"width";if(!(!d||!p)){var x=w2(u.padding,o),j=em(d),S=h==="y"?Lt:Mt,C=h==="y"?vn:bn,O=o.rects.reference[b]+o.rects.reference[h]-p[h]-o.rects.popper[b],E=p[h]-o.rects.reference[h],k=fi(d),N=k?h==="y"?k.clientHeight||0:k.clientWidth||0:0,T=O/2-E/2,L=x[S],B=N-j[b]-x[C],U=N/2-j[b]/2+T,_=ti(L,U,B),z=h;o.modifiersData[l]=(a={},a[z]=_,a.centerOffset=_-U,a)}}function S2(n){var a=n.state,o=n.options,l=o.element,u=l===void 0?"[data-popper-arrow]":l;u!=null&&(typeof u=="string"&&(u=a.elements.popper.querySelector(u),!u)||Dy(a.elements.popper,u)&&(a.elements.arrow=u))}const E2={name:"arrow",enabled:!0,phase:"main",fn:j2,effect:S2,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function ko(n){return n.split("-")[1]}var N2={top:"auto",right:"auto",bottom:"auto",left:"auto"};function C2(n,a){var o=n.x,l=n.y,u=a.devicePixelRatio||1;return{x:Ao(o*u)/u||0,y:Ao(l*u)/u||0}}function nb(n){var a,o=n.popper,l=n.popperRect,u=n.placement,d=n.variation,p=n.offsets,g=n.position,h=n.gpuAcceleration,v=n.adaptive,b=n.roundOffsets,x=n.isFixed,j=p.x,S=j===void 0?0:j,C=p.y,O=C===void 0?0:C,E=typeof b=="function"?b({x:S,y:O}):{x:S,y:O};S=E.x,O=E.y;var k=p.hasOwnProperty("x"),N=p.hasOwnProperty("y"),T=Mt,L=Lt,B=window;if(v){var U=fi(o),_="clientHeight",z="clientWidth";if(U===Vt(o)&&(U=Ya(o),ma(U).position!=="static"&&g==="absolute"&&(_="scrollHeight",z="scrollWidth")),U=U,u===Lt||(u===Mt||u===bn)&&d===ri){L=vn;var Y=x&&U===B&&B.visualViewport?B.visualViewport.height:U[_];O-=Y-l.height,O*=h?1:-1}if(u===Mt||(u===Lt||u===vn)&&d===ri){T=bn;var ee=x&&U===B&&B.visualViewport?B.visualViewport.width:U[z];S-=ee-l.width,S*=h?1:-1}}var ne=Object.assign({position:g},v&&N2),le=b===!0?C2({x:S,y:O},Vt(o)):{x:S,y:O};if(S=le.x,O=le.y,h){var ie;return Object.assign({},ne,(ie={},ie[L]=N?"0":"",ie[T]=k?"0":"",ie.transform=(B.devicePixelRatio||1)<=1?"translate("+S+"px, "+O+"px)":"translate3d("+S+"px, "+O+"px, 0)",ie))}return Object.assign({},ne,(a={},a[L]=N?O+"px":"",a[T]=k?S+"px":"",a.transform="",a))}function A2(n){var a=n.state,o=n.options,l=o.gpuAcceleration,u=l===void 0?!0:l,d=o.adaptive,p=d===void 0?!0:d,g=o.roundOffsets,h=g===void 0?!0:g,v={placement:_n(a.placement),variation:ko(a.placement),popper:a.elements.popper,popperRect:a.rects.popper,gpuAcceleration:u,isFixed:a.options.strategy==="fixed"};a.modifiersData.popperOffsets!=null&&(a.styles.popper=Object.assign({},a.styles.popper,nb(Object.assign({},v,{offsets:a.modifiersData.popperOffsets,position:a.options.strategy,adaptive:p,roundOffsets:h})))),a.modifiersData.arrow!=null&&(a.styles.arrow=Object.assign({},a.styles.arrow,nb(Object.assign({},v,{offsets:a.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:h})))),a.attributes.popper=Object.assign({},a.attributes.popper,{"data-popper-placement":a.placement})}const O2={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:A2,data:{}};var Pl={passive:!0};function k2(n){var a=n.state,o=n.instance,l=n.options,u=l.scroll,d=u===void 0?!0:u,p=l.resize,g=p===void 0?!0:p,h=Vt(a.elements.popper),v=[].concat(a.scrollParents.reference,a.scrollParents.popper);return d&&v.forEach(function(b){b.addEventListener("scroll",o.update,Pl)}),g&&h.addEventListener("resize",o.update,Pl),function(){d&&v.forEach(function(b){b.removeEventListener("scroll",o.update,Pl)}),g&&h.removeEventListener("resize",o.update,Pl)}}const T2={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:k2,data:{}};var R2={left:"right",right:"left",bottom:"top",top:"bottom"};function Fl(n){return n.replace(/left|right|bottom|top/g,function(a){return R2[a]})}var D2={start:"end",end:"start"};function ab(n){return n.replace(/start|end/g,function(a){return D2[a]})}function nm(n){var a=Vt(n),o=a.pageXOffset,l=a.pageYOffset;return{scrollLeft:o,scrollTop:l}}function am(n){return Oo(Ya(n)).left+nm(n).scrollLeft}function L2(n,a){var o=Vt(n),l=Ya(n),u=o.visualViewport,d=l.clientWidth,p=l.clientHeight,g=0,h=0;if(u){d=u.width,p=u.height;var v=Ry();(v||!v&&a==="fixed")&&(g=u.offsetLeft,h=u.offsetTop)}return{width:d,height:p,x:g+am(n),y:h}}function M2(n){var a,o=Ya(n),l=nm(n),u=(a=n.ownerDocument)==null?void 0:a.body,d=vr(o.scrollWidth,o.clientWidth,u?u.scrollWidth:0,u?u.clientWidth:0),p=vr(o.scrollHeight,o.clientHeight,u?u.scrollHeight:0,u?u.clientHeight:0),g=-l.scrollLeft+am(n),h=-l.scrollTop;return ma(u||o).direction==="rtl"&&(g+=vr(o.clientWidth,u?u.clientWidth:0)-d),{width:d,height:p,x:g,y:h}}function rm(n){var a=ma(n),o=a.overflow,l=a.overflowX,u=a.overflowY;return/auto|scroll|overlay|hidden/.test(o+u+l)}function zy(n){return["html","body","#document"].indexOf(Va(n))>=0?n.ownerDocument.body:zn(n)&&rm(n)?n:zy(bc(n))}function ni(n,a){var o;a===void 0&&(a=[]);var l=zy(n),u=l===((o=n.ownerDocument)==null?void 0:o.body),d=Vt(l),p=u?[d].concat(d.visualViewport||[],rm(l)?l:[]):l,g=a.concat(p);return u?g:g.concat(ni(bc(p)))}function Sf(n){return Object.assign({},n,{left:n.x,top:n.y,right:n.x+n.width,bottom:n.y+n.height})}function _2(n,a){var o=Oo(n,!1,a==="fixed");return o.top=o.top+n.clientTop,o.left=o.left+n.clientLeft,o.bottom=o.top+n.clientHeight,o.right=o.left+n.clientWidth,o.width=n.clientWidth,o.height=n.clientHeight,o.x=o.left,o.y=o.top,o}function rb(n,a,o){return a===ky?Sf(L2(n,o)):yr(a)?_2(a,o):Sf(M2(Ya(n)))}function z2(n){var a=ni(bc(n)),o=["absolute","fixed"].indexOf(ma(n).position)>=0,l=o&&zn(n)?fi(n):n;return yr(l)?a.filter(function(u){return yr(u)&&Dy(u,l)&&Va(u)!=="body"}):[]}function B2(n,a,o,l){var u=a==="clippingParents"?z2(n):[].concat(a),d=[].concat(u,[o]),p=d[0],g=d.reduce(function(h,v){var b=rb(n,v,l);return h.top=vr(b.top,h.top),h.right=Zl(b.right,h.right),h.bottom=Zl(b.bottom,h.bottom),h.left=vr(b.left,h.left),h},rb(n,p,l));return g.width=g.right-g.left,g.height=g.bottom-g.top,g.x=g.left,g.y=g.top,g}function By(n){var a=n.reference,o=n.element,l=n.placement,u=l?_n(l):null,d=l?ko(l):null,p=a.x+a.width/2-o.width/2,g=a.y+a.height/2-o.height/2,h;switch(u){case Lt:h={x:p,y:a.y-o.height};break;case vn:h={x:p,y:a.y+a.height};break;case bn:h={x:a.x+a.width,y:g};break;case Mt:h={x:a.x-o.width,y:g};break;default:h={x:a.x,y:a.y}}var v=u?tm(u):null;if(v!=null){var b=v==="y"?"height":"width";switch(d){case Co:h[v]=h[v]-(a[b]/2-o[b]/2);break;case ri:h[v]=h[v]+(a[b]/2-o[b]/2);break}}return h}function oi(n,a){a===void 0&&(a={});var o=a,l=o.placement,u=l===void 0?n.placement:l,d=o.strategy,p=d===void 0?n.strategy:d,g=o.boundary,h=g===void 0?s2:g,v=o.rootBoundary,b=v===void 0?ky:v,x=o.elementContext,j=x===void 0?Ks:x,S=o.altBoundary,C=S===void 0?!1:S,O=o.padding,E=O===void 0?0:O,k=My(typeof E!="number"?E:_y(E,di)),N=j===Ks?i2:Ks,T=n.rects.popper,L=n.elements[C?N:j],B=B2(yr(L)?L:L.contextElement||Ya(n.elements.popper),h,b,p),U=Oo(n.elements.reference),_=By({reference:U,element:T,placement:u}),z=Sf(Object.assign({},T,_)),Y=j===Ks?z:U,ee={top:B.top-Y.top+k.top,bottom:Y.bottom-B.bottom+k.bottom,left:B.left-Y.left+k.left,right:Y.right-B.right+k.right},ne=n.modifiersData.offset;if(j===Ks&&ne){var le=ne[u];Object.keys(ee).forEach(function(ie){var ae=[bn,vn].indexOf(ie)>=0?1:-1,P=[Lt,vn].indexOf(ie)>=0?"y":"x";ee[ie]+=le[P]*ae})}return ee}function U2(n,a){a===void 0&&(a={});var o=a,l=o.placement,u=o.boundary,d=o.rootBoundary,p=o.padding,g=o.flipVariations,h=o.allowedAutoPlacements,v=h===void 0?Ty:h,b=ko(l),x=b?g?eb:eb.filter(function(C){return ko(C)===b}):di,j=x.filter(function(C){return v.indexOf(C)>=0});j.length===0&&(j=x);var S=j.reduce(function(C,O){return C[O]=oi(n,{placement:O,boundary:u,rootBoundary:d,padding:p})[_n(O)],C},{});return Object.keys(S).sort(function(C,O){return S[C]-S[O]})}function P2(n){if(_n(n)===Qf)return[];var a=Fl(n);return[ab(n),a,ab(a)]}function I2(n){var a=n.state,o=n.options,l=n.name;if(!a.modifiersData[l]._skip){for(var u=o.mainAxis,d=u===void 0?!0:u,p=o.altAxis,g=p===void 0?!0:p,h=o.fallbackPlacements,v=o.padding,b=o.boundary,x=o.rootBoundary,j=o.altBoundary,S=o.flipVariations,C=S===void 0?!0:S,O=o.allowedAutoPlacements,E=a.options.placement,k=_n(E),N=k===E,T=h||(N||!C?[Fl(E)]:P2(E)),L=[E].concat(T).reduce(function(G,ue){return G.concat(_n(ue)===Qf?U2(a,{placement:ue,boundary:b,rootBoundary:x,padding:v,flipVariations:C,allowedAutoPlacements:O}):ue)},[]),B=a.rects.reference,U=a.rects.popper,_=new Map,z=!0,Y=L[0],ee=0;ee<L.length;ee++){var ne=L[ee],le=_n(ne),ie=ko(ne)===Co,ae=[Lt,vn].indexOf(le)>=0,P=ae?"width":"height",D=oi(a,{placement:ne,boundary:b,rootBoundary:x,altBoundary:j,padding:v}),Q=ae?ie?bn:Mt:ie?vn:Lt;B[P]>U[P]&&(Q=Fl(Q));var oe=Fl(Q),V=[];if(d&&V.push(D[le]<=0),g&&V.push(D[Q]<=0,D[oe]<=0),V.every(function(G){return G})){Y=ne,z=!1;break}_.set(ne,V)}if(z)for(var A=C?3:1,$=function(ue){var me=L.find(function(He){var we=_.get(He);if(we)return we.slice(0,ue).every(function(Ie){return Ie})});if(me)return Y=me,"break"},re=A;re>0;re--){var Z=$(re);if(Z==="break")break}a.placement!==Y&&(a.modifiersData[l]._skip=!0,a.placement=Y,a.reset=!0)}}const $2={name:"flip",enabled:!0,phase:"main",fn:I2,requiresIfExists:["offset"],data:{_skip:!1}};function ob(n,a,o){return o===void 0&&(o={x:0,y:0}),{top:n.top-a.height-o.y,right:n.right-a.width+o.x,bottom:n.bottom-a.height+o.y,left:n.left-a.width-o.x}}function sb(n){return[Lt,bn,vn,Mt].some(function(a){return n[a]>=0})}function H2(n){var a=n.state,o=n.name,l=a.rects.reference,u=a.rects.popper,d=a.modifiersData.preventOverflow,p=oi(a,{elementContext:"reference"}),g=oi(a,{altBoundary:!0}),h=ob(p,l),v=ob(g,u,d),b=sb(h),x=sb(v);a.modifiersData[o]={referenceClippingOffsets:h,popperEscapeOffsets:v,isReferenceHidden:b,hasPopperEscaped:x},a.attributes.popper=Object.assign({},a.attributes.popper,{"data-popper-reference-hidden":b,"data-popper-escaped":x})}const q2={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:H2};function J2(n,a,o){var l=_n(n),u=[Mt,Lt].indexOf(l)>=0?-1:1,d=typeof o=="function"?o(Object.assign({},a,{placement:n})):o,p=d[0],g=d[1];return p=p||0,g=(g||0)*u,[Mt,bn].indexOf(l)>=0?{x:g,y:p}:{x:p,y:g}}function G2(n){var a=n.state,o=n.options,l=n.name,u=o.offset,d=u===void 0?[0,0]:u,p=Ty.reduce(function(b,x){return b[x]=J2(x,a.rects,d),b},{}),g=p[a.placement],h=g.x,v=g.y;a.modifiersData.popperOffsets!=null&&(a.modifiersData.popperOffsets.x+=h,a.modifiersData.popperOffsets.y+=v),a.modifiersData[l]=p}const F2={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:G2};function V2(n){var a=n.state,o=n.name;a.modifiersData[o]=By({reference:a.rects.reference,element:a.rects.popper,placement:a.placement})}const Y2={name:"popperOffsets",enabled:!0,phase:"read",fn:V2,data:{}};function X2(n){return n==="x"?"y":"x"}function Z2(n){var a=n.state,o=n.options,l=n.name,u=o.mainAxis,d=u===void 0?!0:u,p=o.altAxis,g=p===void 0?!1:p,h=o.boundary,v=o.rootBoundary,b=o.altBoundary,x=o.padding,j=o.tether,S=j===void 0?!0:j,C=o.tetherOffset,O=C===void 0?0:C,E=oi(a,{boundary:h,rootBoundary:v,padding:x,altBoundary:b}),k=_n(a.placement),N=ko(a.placement),T=!N,L=tm(k),B=X2(L),U=a.modifiersData.popperOffsets,_=a.rects.reference,z=a.rects.popper,Y=typeof O=="function"?O(Object.assign({},a.rects,{placement:a.placement})):O,ee=typeof Y=="number"?{mainAxis:Y,altAxis:Y}:Object.assign({mainAxis:0,altAxis:0},Y),ne=a.modifiersData.offset?a.modifiersData.offset[a.placement]:null,le={x:0,y:0};if(U){if(d){var ie,ae=L==="y"?Lt:Mt,P=L==="y"?vn:bn,D=L==="y"?"height":"width",Q=U[L],oe=Q+E[ae],V=Q-E[P],A=S?-z[D]/2:0,$=N===Co?_[D]:z[D],re=N===Co?-z[D]:-_[D],Z=a.elements.arrow,G=S&&Z?em(Z):{width:0,height:0},ue=a.modifiersData["arrow#persistent"]?a.modifiersData["arrow#persistent"].padding:Ly(),me=ue[ae],He=ue[P],we=ti(0,_[D],G[D]),Ie=T?_[D]/2-A-we-me-ee.mainAxis:$-we-me-ee.mainAxis,zt=T?-_[D]/2+A+we+He+ee.mainAxis:re+we+He+ee.mainAxis,Bt=a.elements.arrow&&fi(a.elements.arrow),Kt=Bt?L==="y"?Bt.clientTop||0:Bt.clientLeft||0:0,Qt=(ie=ne?.[L])!=null?ie:0,Wt=Q+Ie-Qt-Kt,ze=Q+zt-Qt,Hn=ti(S?Zl(oe,Wt):oe,Q,S?vr(V,ze):V);U[L]=Hn,le[L]=Hn-Q}if(g){var ot,Zo=L==="x"?Lt:Mt,Or=L==="x"?vn:bn,en=U[B],wn=B==="y"?"height":"width",kr=en+E[Zo],Xa=en-E[Or],ba=[Lt,Mt].indexOf(k)!==-1,Tr=(ot=ne?.[B])!=null?ot:0,je=ba?kr:en-_[wn]-z[wn]-Tr+ee.altAxis,Ye=ba?en+_[wn]+z[wn]-Tr-ee.altAxis:Xa,At=S&&ba?x2(je,en,Ye):ti(S?je:kr,en,S?Ye:Xa);U[B]=At,le[B]=At-en}a.modifiersData[l]=le}}const K2={name:"preventOverflow",enabled:!0,phase:"main",fn:Z2,requiresIfExists:["offset"]};function Q2(n){return{scrollLeft:n.scrollLeft,scrollTop:n.scrollTop}}function W2(n){return n===Vt(n)||!zn(n)?nm(n):Q2(n)}function eC(n){var a=n.getBoundingClientRect(),o=Ao(a.width)/n.offsetWidth||1,l=Ao(a.height)/n.offsetHeight||1;return o!==1||l!==1}function tC(n,a,o){o===void 0&&(o=!1);var l=zn(a),u=zn(a)&&eC(a),d=Ya(a),p=Oo(n,u,o),g={scrollLeft:0,scrollTop:0},h={x:0,y:0};return(l||!l&&!o)&&((Va(a)!=="body"||rm(d))&&(g=W2(a)),zn(a)?(h=Oo(a,!0),h.x+=a.clientLeft,h.y+=a.clientTop):d&&(h.x=am(d))),{x:p.left+g.scrollLeft-h.x,y:p.top+g.scrollTop-h.y,width:p.width,height:p.height}}function nC(n){var a=new Map,o=new Set,l=[];n.forEach(function(d){a.set(d.name,d)});function u(d){o.add(d.name);var p=[].concat(d.requires||[],d.requiresIfExists||[]);p.forEach(function(g){if(!o.has(g)){var h=a.get(g);h&&u(h)}}),l.push(d)}return n.forEach(function(d){o.has(d.name)||u(d)}),l}function aC(n){var a=nC(n);return v2.reduce(function(o,l){return o.concat(a.filter(function(u){return u.phase===l}))},[])}function rC(n){var a;return function(){return a||(a=new Promise(function(o){Promise.resolve().then(function(){a=void 0,o(n())})})),a}}function oC(n){var a=n.reduce(function(o,l){var u=o[l.name];return o[l.name]=u?Object.assign({},u,l,{options:Object.assign({},u.options,l.options),data:Object.assign({},u.data,l.data)}):l,o},{});return Object.keys(a).map(function(o){return a[o]})}var ib={placement:"bottom",modifiers:[],strategy:"absolute"};function lb(){for(var n=arguments.length,a=new Array(n),o=0;o<n;o++)a[o]=arguments[o];return!a.some(function(l){return!(l&&typeof l.getBoundingClientRect=="function")})}function sC(n){n===void 0&&(n={});var a=n,o=a.defaultModifiers,l=o===void 0?[]:o,u=a.defaultOptions,d=u===void 0?ib:u;return function(g,h,v){v===void 0&&(v=d);var b={placement:"bottom",orderedModifiers:[],options:Object.assign({},ib,d),modifiersData:{},elements:{reference:g,popper:h},attributes:{},styles:{}},x=[],j=!1,S={state:b,setOptions:function(k){var N=typeof k=="function"?k(b.options):k;O(),b.options=Object.assign({},d,b.options,N),b.scrollParents={reference:yr(g)?ni(g):g.contextElement?ni(g.contextElement):[],popper:ni(h)};var T=aC(oC([].concat(l,b.options.modifiers)));return b.orderedModifiers=T.filter(function(L){return L.enabled}),C(),S.update()},forceUpdate:function(){if(!j){var k=b.elements,N=k.reference,T=k.popper;if(lb(N,T)){b.rects={reference:tC(N,fi(T),b.options.strategy==="fixed"),popper:em(T)},b.reset=!1,b.placement=b.options.placement,b.orderedModifiers.forEach(function(ee){return b.modifiersData[ee.name]=Object.assign({},ee.data)});for(var L=0;L<b.orderedModifiers.length;L++){if(b.reset===!0){b.reset=!1,L=-1;continue}var B=b.orderedModifiers[L],U=B.fn,_=B.options,z=_===void 0?{}:_,Y=B.name;typeof U=="function"&&(b=U({state:b,options:z,name:Y,instance:S})||b)}}}},update:rC(function(){return new Promise(function(E){S.forceUpdate(),E(b)})}),destroy:function(){O(),j=!0}};if(!lb(g,h))return S;S.setOptions(v).then(function(E){!j&&v.onFirstUpdate&&v.onFirstUpdate(E)});function C(){b.orderedModifiers.forEach(function(E){var k=E.name,N=E.options,T=N===void 0?{}:N,L=E.effect;if(typeof L=="function"){var B=L({state:b,name:k,instance:S,options:T}),U=function(){};x.push(B||U)}})}function O(){x.forEach(function(E){return E()}),x=[]}return S}}const iC=sC({defaultModifiers:[q2,Y2,O2,T2,F2,$2,K2,E2]}),lC=["enabled","placement","strategy","modifiers"];function cC(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}const uC={name:"applyStyles",enabled:!1,phase:"afterWrite",fn:()=>{}},dC={name:"ariaDescribedBy",enabled:!0,phase:"afterWrite",effect:({state:n})=>()=>{const{reference:a,popper:o}=n.elements;if("removeAttribute"in a){const l=(a.getAttribute("aria-describedby")||"").split(",").filter(u=>u.trim()!==o.id);l.length?a.setAttribute("aria-describedby",l.join(",")):a.removeAttribute("aria-describedby")}},fn:({state:n})=>{var a;const{popper:o,reference:l}=n.elements,u=(a=o.getAttribute("role"))==null?void 0:a.toLowerCase();if(o.id&&u==="tooltip"&&"setAttribute"in l){const d=l.getAttribute("aria-describedby");if(d&&d.split(",").indexOf(o.id)!==-1)return;l.setAttribute("aria-describedby",d?`${d},${o.id}`:o.id)}}},fC=[];function Uy(n,a,o={}){let{enabled:l=!0,placement:u="bottom",strategy:d="absolute",modifiers:p=fC}=o,g=cC(o,lC);const h=m.useRef(p),v=m.useRef(),b=m.useCallback(()=>{var E;(E=v.current)==null||E.update()},[]),x=m.useCallback(()=>{var E;(E=v.current)==null||E.forceUpdate()},[]),[j,S]=o2(m.useState({placement:u,update:b,forceUpdate:x,attributes:{},styles:{popper:{},arrow:{}}})),C=m.useMemo(()=>({name:"updateStateModifier",enabled:!0,phase:"write",requires:["computeStyles"],fn:({state:E})=>{const k={},N={};Object.keys(E.elements).forEach(T=>{k[T]=E.styles[T],N[T]=E.attributes[T]}),S({state:E,styles:k,attributes:N,update:b,forceUpdate:x,placement:E.placement})}}),[b,x,S]),O=m.useMemo(()=>(ei(h.current,p)||(h.current=p),h.current),[p]);return m.useEffect(()=>{!v.current||!l||v.current.setOptions({placement:u,strategy:d,modifiers:[...O,C,uC]})},[d,u,C,l,O]),m.useEffect(()=>{if(!(!l||n==null||a==null))return v.current=iC(n,a,Object.assign({},g,{placement:u,strategy:d,modifiers:[...O,dC,C]})),()=>{v.current!=null&&(v.current.destroy(),v.current=void 0,S(E=>Object.assign({},E,{attributes:{},styles:{popper:{}}})))}},[l,n,a]),j}function si(n,a){if(n.contains)return n.contains(a);if(n.compareDocumentPosition)return n===a||!!(n.compareDocumentPosition(a)&16)}var ef,cb;function mC(){if(cb)return ef;cb=1;var n=function(){};return ef=n,ef}var pC=mC();const hC=Do(pC),ub=()=>{};function gC(n){return n.button===0}function vC(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}const Vl=n=>n&&("current"in n?n.current:n),db={click:"mousedown",mouseup:"mousedown",pointerup:"pointerdown"};function Py(n,a=ub,{disabled:o,clickTrigger:l="click"}={}){const u=m.useRef(!1),d=m.useRef(!1),p=m.useCallback(v=>{const b=Vl(n);hC(!!b,"ClickOutside captured a close event but does not have a ref to compare it to. useClickOutside(), should be passed a ref that resolves to a DOM node"),u.current=!b||vC(v)||!gC(v)||!!si(b,v.target)||d.current,d.current=!1},[n]),g=gt(v=>{const b=Vl(n);b&&si(b,v.target)?d.current=!0:d.current=!1}),h=gt(v=>{u.current||a(v)});m.useEffect(()=>{var v,b;if(o||n==null)return;const x=zo(Vl(n)),j=x.defaultView||window;let S=(v=j.event)!=null?v:(b=j.parent)==null?void 0:b.event,C=null;db[l]&&(C=sa(x,db[l],g,!0));const O=sa(x,l,p,!0),E=sa(x,l,N=>{if(N===S){S=void 0;return}h(N)});let k=[];return"ontouchstart"in x.documentElement&&(k=[].slice.call(x.body.children).map(N=>sa(N,"mousemove",ub))),()=>{C?.(),O(),E(),k.forEach(N=>N())}},[n,o,l,p,g,h])}function bC(n){const a={};return Array.isArray(n)?(n?.forEach(o=>{a[o.name]=o}),a):n||a}function yC(n={}){return Array.isArray(n)?n:Object.keys(n).map(a=>(n[a].name=a,n[a]))}function Iy({enabled:n,enableEvents:a,placement:o,flip:l,offset:u,fixed:d,containerPadding:p,arrowElement:g,popperConfig:h={}}){var v,b,x,j,S;const C=bC(h.modifiers);return Object.assign({},h,{placement:o,enabled:n,strategy:d?"fixed":h.strategy,modifiers:yC(Object.assign({},C,{eventListeners:{enabled:a,options:(v=C.eventListeners)==null?void 0:v.options},preventOverflow:Object.assign({},C.preventOverflow,{options:p?Object.assign({padding:p},(b=C.preventOverflow)==null?void 0:b.options):(x=C.preventOverflow)==null?void 0:x.options}),offset:{options:Object.assign({offset:u},(j=C.offset)==null?void 0:j.options)},arrow:Object.assign({},C.arrow,{enabled:!!g,options:Object.assign({},(S=C.arrow)==null?void 0:S.options,{element:g})}),flip:Object.assign({enabled:!!l},C.flip)}))})}const xC=["children","usePopper"];function wC(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}const jC=()=>{};function $y(n={}){const a=m.useContext(vc),[o,l]=xf(),u=m.useRef(!1),{flip:d,offset:p,rootCloseEvent:g,fixed:h=!1,placement:v,popperConfig:b={},enableEventListeners:x=!0,usePopper:j=!!a}=n,S=a?.show==null?!!n.show:a.show;S&&!u.current&&(u.current=!0);const C=U=>{a?.toggle(!1,U)},{placement:O,setMenu:E,menuElement:k,toggleElement:N}=a||{},T=Uy(N,k,Iy({placement:v||O||"bottom-start",enabled:j,enableEvents:x??S,offset:p,flip:d,fixed:h,arrowElement:o,popperConfig:b})),L=Object.assign({ref:E||jC,"aria-labelledby":N?.id},T.attributes.popper,{style:T.styles.popper}),B={show:S,placement:O,hasShown:u.current,toggle:a?.toggle,popper:j?T:null,arrowProps:j?Object.assign({ref:l},T.attributes.arrow,{style:T.styles.arrow}):{}};return Py(k,C,{clickTrigger:g,disabled:!S}),[L,B]}function Hy(n){let{children:a,usePopper:o=!0}=n,l=wC(n,xC);const[u,d]=$y(Object.assign({},l,{usePopper:o}));return s.jsx(s.Fragment,{children:a(u,d)})}Hy.displayName="DropdownMenu";const qy={prefix:String(Math.round(Math.random()*1e10)),current:0},Jy=Fe.createContext(qy),SC=Fe.createContext(!1);let tf=new WeakMap;function EC(n=!1){let a=m.useContext(Jy),o=m.useRef(null);if(o.current===null&&!n){var l,u;let d=(u=Fe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED)===null||u===void 0||(l=u.ReactCurrentOwner)===null||l===void 0?void 0:l.current;if(d){let p=tf.get(d);p==null?tf.set(d,{id:a.current,state:d.memoizedState}):d.memoizedState!==p.state&&(a.current=p.id,tf.delete(d))}o.current=++a.current}return o.current}function NC(n){let a=m.useContext(Jy),o=EC(!!n),l=`react-aria${a.prefix}`;return n||`${l}-${o}`}function CC(n){let a=Fe.useId(),[o]=m.useState(TC()),l=o?"react-aria":`react-aria${qy.prefix}`;return n||`${l}-${a}`}const Gy=typeof Fe.useId=="function"?CC:NC;function AC(){return!1}function OC(){return!0}function kC(n){return()=>{}}function TC(){return typeof Fe.useSyncExternalStore=="function"?Fe.useSyncExternalStore(kC,AC,OC):m.useContext(SC)}const Fy=n=>{var a;return((a=n.getAttribute("role"))==null?void 0:a.toLowerCase())==="menu"},fb=()=>{};function Vy(){const n=Gy(),{show:a=!1,toggle:o=fb,setToggle:l,menuElement:u}=m.useContext(vc)||{},d=m.useCallback(g=>{o(!a,g)},[a,o]),p={id:n,ref:l||fb,onClick:d,"aria-expanded":!!a};return u&&Fy(u)&&(p["aria-haspopup"]=!0),[p,{show:a,toggle:o}]}function Yy({children:n}){const[a,o]=Vy();return s.jsx(s.Fragment,{children:n(a,o)})}Yy.displayName="DropdownToggle";const Bn=m.createContext(null),xr=(n,a=null)=>n!=null?String(n):a||null,yc=m.createContext(null);yc.displayName="NavContext";const RC="data-rr-ui-",DC="rrUi";function Io(n){return`${RC}${n}`}function LC(n){return`${DC}${n}`}const MC=["eventKey","disabled","onClick","active","as"];function _C(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function Xy({key:n,href:a,active:o,disabled:l,onClick:u}){const d=m.useContext(Bn),p=m.useContext(yc),{activeKey:g}=p||{},h=xr(n,a),v=o==null&&n!=null?xr(g)===h:o;return[{onClick:gt(x=>{l||(u?.(x),d&&!x.isPropagationStopped()&&d(h,x))}),"aria-disabled":l||void 0,"aria-selected":v,[Io("dropdown-item")]:""},{isActive:v}]}const Zy=m.forwardRef((n,a)=>{let{eventKey:o,disabled:l,onClick:u,active:d,as:p=Yf}=n,g=_C(n,MC);const[h]=Xy({key:o,href:g.href,disabled:l,onClick:u,active:d});return s.jsx(p,Object.assign({},g,{ref:a},h))});Zy.displayName="DropdownItem";const Ky=m.createContext(Bo?window:void 0);Ky.Provider;function xc(){return m.useContext(Ky)}function mb(){const n=Oy(),a=m.useRef(null),o=m.useCallback(l=>{a.current=l,n()},[n]);return[a,o]}function mi({defaultShow:n,show:a,onSelect:o,onToggle:l,itemSelector:u=`* [${Io("dropdown-item")}]`,focusFirstItemOnShow:d,placement:p="bottom-start",children:g}){const h=xc(),[v,b]=Ay(a,n,l),[x,j]=mb(),S=x.current,[C,O]=mb(),E=C.current,k=py(v),N=m.useRef(null),T=m.useRef(!1),L=m.useContext(Bn),B=m.useCallback((ne,le,ie=le?.type)=>{b(ne,{originalEvent:le,source:ie})},[b]),U=gt((ne,le)=>{o?.(ne,le),B(!1,le,"select"),le.isPropagationStopped()||L?.(ne,le)}),_=m.useMemo(()=>({toggle:B,placement:p,show:v,menuElement:S,toggleElement:E,setMenu:j,setToggle:O}),[B,p,v,S,E,j,O]);S&&k&&!v&&(T.current=S.contains(S.ownerDocument.activeElement));const z=gt(()=>{E&&E.focus&&E.focus()}),Y=gt(()=>{const ne=N.current;let le=d;if(le==null&&(le=x.current&&Fy(x.current)?"keyboard":!1),le===!1||le==="keyboard"&&!/^key.+$/.test(ne))return;const ie=ra(x.current,u)[0];ie&&ie.focus&&ie.focus()});m.useEffect(()=>{v?Y():T.current&&(T.current=!1,z())},[v,T,z,Y]),m.useEffect(()=>{N.current=null});const ee=(ne,le)=>{if(!x.current)return null;const ie=ra(x.current,u);let ae=ie.indexOf(ne)+le;return ae=Math.max(0,Math.min(ae,ie.length)),ie[ae]};return IN(m.useCallback(()=>h.document,[h]),"keydown",ne=>{var le,ie;const{key:ae}=ne,P=ne.target,D=(le=x.current)==null?void 0:le.contains(P),Q=(ie=C.current)==null?void 0:ie.contains(P);if(/input|textarea/i.test(P.tagName)&&(ae===" "||ae!=="Escape"&&D||ae==="Escape"&&P.type==="search")||!D&&!Q||ae==="Tab"&&(!x.current||!v))return;N.current=ne.type;const V={originalEvent:ne,source:ne.type};switch(ae){case"ArrowUp":{const A=ee(P,-1);A&&A.focus&&A.focus(),ne.preventDefault();return}case"ArrowDown":if(ne.preventDefault(),!v)b(!0,V);else{const A=ee(P,1);A&&A.focus&&A.focus()}return;case"Tab":Gf(P.ownerDocument,"keyup",A=>{var $;(A.key==="Tab"&&!A.target||!(($=x.current)!=null&&$.contains(A.target)))&&b(!1,V)},{once:!0});break;case"Escape":ae==="Escape"&&(ne.preventDefault(),ne.stopPropagation()),b(!1,V);break}}),s.jsx(Bn.Provider,{value:U,children:s.jsx(vc.Provider,{value:_,children:g})})}mi.displayName="Dropdown";mi.Menu=Hy;mi.Toggle=Yy;mi.Item=Zy;const om=m.createContext({});om.displayName="DropdownContext";const Qy=m.forwardRef(({className:n,bsPrefix:a,as:o="hr",role:l="separator",...u},d)=>(a=de(a,"dropdown-divider"),s.jsx(o,{ref:d,className:ce(n,a),role:l,...u})));Qy.displayName="DropdownDivider";const Wy=m.forwardRef(({className:n,bsPrefix:a,as:o="div",role:l="heading",...u},d)=>(a=de(a,"dropdown-header"),s.jsx(o,{ref:d,className:ce(n,a),role:l,...u})));Wy.displayName="DropdownHeader";const ex=m.forwardRef(({bsPrefix:n,className:a,eventKey:o,disabled:l=!1,onClick:u,active:d,as:p=Xf,...g},h)=>{const v=de(n,"dropdown-item"),[b,x]=Xy({key:o,href:g.href,disabled:l,onClick:u,active:d});return s.jsx(p,{...g,...b,ref:h,className:ce(a,v,x.isActive&&"active",l&&"disabled")})});ex.displayName="DropdownItem";const tx=m.forwardRef(({className:n,bsPrefix:a,as:o="span",...l},u)=>(a=de(a,"dropdown-item-text"),s.jsx(o,{ref:u,className:ce(n,a),...l})));tx.displayName="DropdownItemText";const zC=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",BC=typeof document<"u",sm=BC||zC?m.useLayoutEffect:m.useEffect,wc=m.createContext(null);wc.displayName="InputGroupContext";const Nr=m.createContext(null);Nr.displayName="NavbarContext";function nx(n,a){return n}function ax(n,a,o){const l=o?"top-end":"top-start",u=o?"top-start":"top-end",d=o?"bottom-end":"bottom-start",p=o?"bottom-start":"bottom-end",g=o?"right-start":"left-start",h=o?"right-end":"left-end",v=o?"left-start":"right-start",b=o?"left-end":"right-end";let x=n?p:d;return a==="up"?x=n?u:l:a==="end"?x=n?b:v:a==="start"?x=n?h:g:a==="down-centered"?x="bottom":a==="up-centered"&&(x="top"),x}const rx=m.forwardRef(({bsPrefix:n,className:a,align:o,rootCloseEvent:l,flip:u=!0,show:d,renderOnMount:p,as:g="div",popperConfig:h,variant:v,...b},x)=>{let j=!1;const S=m.useContext(Nr),C=de(n,"dropdown-menu"),{align:O,drop:E,isRTL:k}=m.useContext(om);o=o||O;const N=m.useContext(wc),T=[];if(o)if(typeof o=="object"){const ne=Object.keys(o);if(ne.length){const le=ne[0],ie=o[le];j=ie==="start",T.push(`${C}-${le}-${ie}`)}}else o==="end"&&(j=!0);const L=ax(j,E,k),[B,{hasShown:U,popper:_,show:z,toggle:Y}]=$y({flip:u,rootCloseEvent:l,show:d,usePopper:!S&&T.length===0,offset:[0,2],popperConfig:h,placement:L});if(B.ref=Uo(nx(x),B.ref),sm(()=>{z&&_?.update()},[z]),!U&&!p&&!N)return null;typeof g!="string"&&(B.show=z,B.close=()=>Y?.(!1),B.align=o);let ee=b.style;return _!=null&&_.placement&&(ee={...b.style,...B.style},b["x-placement"]=_.placement),s.jsx(g,{...b,...B,style:ee,...(T.length||S)&&{"data-bs-popper":"static"},className:ce(a,C,z&&"show",j&&`${C}-end`,v&&`${C}-${v}`,...T)})});rx.displayName="DropdownMenu";const ox=m.forwardRef(({bsPrefix:n,split:a,className:o,childBsPrefix:l,as:u=Oe,...d},p)=>{const g=de(n,"dropdown-toggle"),h=m.useContext(vc);l!==void 0&&(d.bsPrefix=l);const[v]=Vy();return v.ref=Uo(v.ref,nx(p)),s.jsx(u,{className:ce(o,g,a&&`${g}-split`,h?.show&&"show"),...v,...d})});ox.displayName="DropdownToggle";const sx=m.forwardRef((n,a)=>{const{bsPrefix:o,drop:l="down",show:u,className:d,align:p="start",onSelect:g,onToggle:h,focusFirstItemOnShow:v,as:b="div",navbar:x,autoClose:j=!0,...S}=fc(n,{show:"onToggle"}),C=m.useContext(wc),O=de(o,"dropdown"),E=mc(),k=_=>j===!1?_==="click":j==="inside"?_!=="rootClose":j==="outside"?_!=="select":!0,N=da((_,z)=>{var Y;!((Y=z.originalEvent)==null||(Y=Y.target)==null)&&Y.classList.contains("dropdown-toggle")&&z.source==="mousedown"||(z.originalEvent.currentTarget===document&&(z.source!=="keydown"||z.originalEvent.key==="Escape")&&(z.source="rootClose"),k(z.source)&&h?.(_,z))}),L=ax(p==="end",l,E),B=m.useMemo(()=>({align:p,drop:l,isRTL:E}),[p,l,E]),U={down:O,"down-centered":`${O}-center`,up:"dropup","up-centered":"dropup-center dropup",end:"dropend",start:"dropstart"};return s.jsx(om.Provider,{value:B,children:s.jsx(mi,{placement:L,show:u,onSelect:g,onToggle:N,focusFirstItemOnShow:v,itemSelector:`.${O}-item:not(.disabled):not(:disabled)`,children:C?S.children:s.jsx(b,{...S,ref:a,className:ce(d,u&&"show",U[l])})})})});sx.displayName="Dropdown";const pn=Object.assign(sx,{Toggle:ox,Menu:rx,Item:ex,ItemText:tx,Divider:Qy,Header:Wy}),UC={type:_e.string,tooltip:_e.bool,as:_e.elementType},jc=m.forwardRef(({as:n="div",className:a,type:o="valid",tooltip:l=!1,...u},d)=>s.jsx(n,{...u,ref:d,className:ce(a,`${o}-${l?"tooltip":"feedback"}`)}));jc.displayName="Feedback";jc.propTypes=UC;const pa=m.createContext({}),pi=m.forwardRef(({id:n,bsPrefix:a,className:o,type:l="checkbox",isValid:u=!1,isInvalid:d=!1,as:p="input",...g},h)=>{const{controlId:v}=m.useContext(pa);return a=de(a,"form-check-input"),s.jsx(p,{...g,ref:h,type:l,id:n||v,className:ce(o,a,u&&"is-valid",d&&"is-invalid")})});pi.displayName="FormCheckInput";const Kl=m.forwardRef(({bsPrefix:n,className:a,htmlFor:o,...l},u)=>{const{controlId:d}=m.useContext(pa);return n=de(n,"form-check-label"),s.jsx("label",{...l,ref:u,htmlFor:o||d,className:ce(a,n)})});Kl.displayName="FormCheckLabel";const ix=m.forwardRef(({id:n,bsPrefix:a,bsSwitchPrefix:o,inline:l=!1,reverse:u=!1,disabled:d=!1,isValid:p=!1,isInvalid:g=!1,feedbackTooltip:h=!1,feedback:v,feedbackType:b,className:x,style:j,title:S="",type:C="checkbox",label:O,children:E,as:k="input",...N},T)=>{a=de(a,"form-check"),o=de(o,"form-switch");const{controlId:L}=m.useContext(pa),B=m.useMemo(()=>({controlId:n||L}),[L,n]),U=!E&&O!=null&&O!==!1||n2(E,Kl),_=s.jsx(pi,{...N,type:C==="switch"?"checkbox":C,ref:T,isValid:p,isInvalid:g,disabled:d,as:k});return s.jsx(pa.Provider,{value:B,children:s.jsx("div",{style:j,className:ce(x,U&&a,l&&`${a}-inline`,u&&`${a}-reverse`,C==="switch"&&o),children:E||s.jsxs(s.Fragment,{children:[_,U&&s.jsx(Kl,{title:S,children:O}),v&&s.jsx(jc,{type:b,tooltip:h,children:v})]})})})});ix.displayName="FormCheck";const Ql=Object.assign(ix,{Input:pi,Label:Kl}),lx=m.forwardRef(({bsPrefix:n,type:a,size:o,htmlSize:l,id:u,className:d,isValid:p=!1,isInvalid:g=!1,plaintext:h,readOnly:v,as:b="input",...x},j)=>{const{controlId:S}=m.useContext(pa);return n=de(n,"form-control"),s.jsx(b,{...x,type:a,size:l,ref:j,readOnly:v,id:u||S,className:ce(d,h?`${n}-plaintext`:n,o&&`${n}-${o}`,a==="color"&&`${n}-color`,p&&"is-valid",g&&"is-invalid")})});lx.displayName="FormControl";const PC=Object.assign(lx,{Feedback:jc}),cx=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"form-floating"),s.jsx(o,{ref:u,className:ce(n,a),...l})));cx.displayName="FormFloating";const im=m.forwardRef(({controlId:n,as:a="div",...o},l)=>{const u=m.useMemo(()=>({controlId:n}),[n]);return s.jsx(pa.Provider,{value:u,children:s.jsx(a,{...o,ref:l})})});im.displayName="FormGroup";const ux=m.forwardRef(({as:n="label",bsPrefix:a,column:o=!1,visuallyHidden:l=!1,className:u,htmlFor:d,...p},g)=>{const{controlId:h}=m.useContext(pa);a=de(a,"form-label");let v="col-form-label";typeof o=="string"&&(v=`${v} ${v}-${o}`);const b=ce(u,a,l&&"visually-hidden",o&&v);return d=d||h,o?s.jsx(Cn,{ref:g,as:"label",className:b,htmlFor:d,...p}):s.jsx(n,{ref:g,className:b,htmlFor:d,...p})});ux.displayName="FormLabel";const dx=m.forwardRef(({bsPrefix:n,className:a,id:o,...l},u)=>{const{controlId:d}=m.useContext(pa);return n=de(n,"form-range"),s.jsx("input",{...l,type:"range",ref:u,className:ce(a,n),id:o||d})});dx.displayName="FormRange";const fx=m.forwardRef(({bsPrefix:n,size:a,htmlSize:o,className:l,isValid:u=!1,isInvalid:d=!1,id:p,...g},h)=>{const{controlId:v}=m.useContext(pa);return n=de(n,"form-select"),s.jsx("select",{...g,size:o,ref:h,className:ce(l,n,a&&`${n}-${a}`,u&&"is-valid",d&&"is-invalid"),id:p||v})});fx.displayName="FormSelect";const mx=m.forwardRef(({bsPrefix:n,className:a,as:o="small",muted:l,...u},d)=>(n=de(n,"form-text"),s.jsx(o,{...u,ref:d,className:ce(a,n,l&&"text-muted")})));mx.displayName="FormText";const px=m.forwardRef((n,a)=>s.jsx(Ql,{...n,ref:a,type:"switch"}));px.displayName="Switch";const IC=Object.assign(px,{Input:Ql.Input,Label:Ql.Label}),hx=m.forwardRef(({bsPrefix:n,className:a,children:o,controlId:l,label:u,...d},p)=>(n=de(n,"form-floating"),s.jsxs(im,{ref:p,className:ce(a,n),controlId:l,...d,children:[o,s.jsx("label",{htmlFor:l,children:u})]})));hx.displayName="FloatingLabel";const $C={_ref:_e.any,validated:_e.bool,as:_e.elementType},lm=m.forwardRef(({className:n,validated:a,as:o="form",...l},u)=>s.jsx(o,{...l,ref:u,className:ce(n,a&&"was-validated")}));lm.displayName="Form";lm.propTypes=$C;const se=Object.assign(lm,{Group:im,Control:PC,Floating:cx,Check:Ql,Switch:IC,Label:ux,Text:mx,Range:dx,Select:fx,FloatingLabel:hx}),Sc=m.forwardRef(({className:n,bsPrefix:a,as:o="span",...l},u)=>(a=de(a,"input-group-text"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Sc.displayName="InputGroupText";const HC=n=>s.jsx(Sc,{children:s.jsx(pi,{type:"checkbox",...n})}),qC=n=>s.jsx(Sc,{children:s.jsx(pi,{type:"radio",...n})}),gx=m.forwardRef(({bsPrefix:n,size:a,hasValidation:o,className:l,as:u="div",...d},p)=>{n=de(n,"input-group");const g=m.useMemo(()=>({}),[]);return s.jsx(wc.Provider,{value:g,children:s.jsx(u,{ref:p,...d,className:ce(l,n,a&&`${n}-${a}`,o&&"has-validation")})})});gx.displayName="InputGroup";const JC=Object.assign(gx,{Text:Sc,Radio:qC,Checkbox:HC}),pb=n=>!n||typeof n=="function"?n:a=>{n.current=a};function GC(n,a){const o=pb(n),l=pb(a);return u=>{o&&o(u),l&&l(u)}}function hi(n,a){return m.useMemo(()=>GC(n,a),[n,a])}const $o=m.createContext(null),FC=["as","active","eventKey"];function VC(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function vx({key:n,onClick:a,active:o,id:l,role:u,disabled:d}){const p=m.useContext(Bn),g=m.useContext(yc),h=m.useContext($o);let v=o;const b={role:u};if(g){!u&&g.role==="tablist"&&(b.role="tab");const x=g.getControllerId(n??null),j=g.getControlledId(n??null);b[Io("event-key")]=n,b.id=x||l,v=o==null&&n!=null?g.activeKey===n:o,(v||!(h!=null&&h.unmountOnExit)&&!(h!=null&&h.mountOnEnter))&&(b["aria-controls"]=j)}return b.role==="tab"&&(b["aria-selected"]=v,v||(b.tabIndex=-1),d&&(b.tabIndex=-1,b["aria-disabled"]=!0)),b.onClick=gt(x=>{d||(a?.(x),n!=null&&p&&!x.isPropagationStopped()&&p(n,x))}),[b,{isActive:v}]}const bx=m.forwardRef((n,a)=>{let{as:o=Yf,active:l,eventKey:u}=n,d=VC(n,FC);const[p,g]=vx(Object.assign({key:xr(u,d.href),active:l},d));return p[Io("active")]=g.isActive,s.jsx(o,Object.assign({},d,p,{ref:a}))});bx.displayName="NavItem";const YC=["as","onSelect","activeKey","role","onKeyDown"];function XC(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}const hb=()=>{},gb=Io("event-key"),yx=m.forwardRef((n,a)=>{let{as:o="div",onSelect:l,activeKey:u,role:d,onKeyDown:p}=n,g=XC(n,YC);const h=Oy(),v=m.useRef(!1),b=m.useContext(Bn),x=m.useContext($o);let j,S;x&&(d=d||"tablist",u=x.activeKey,j=x.getControlledId,S=x.getControllerId);const C=m.useRef(null),O=T=>{const L=C.current;if(!L)return null;const B=ra(L,`[${gb}]:not([aria-disabled=true])`),U=L.querySelector("[aria-selected=true]");if(!U||U!==document.activeElement)return null;const _=B.indexOf(U);if(_===-1)return null;let z=_+T;return z>=B.length&&(z=0),z<0&&(z=B.length-1),B[z]},E=(T,L)=>{T!=null&&(l?.(T,L),b?.(T,L))},k=T=>{if(p?.(T),!x)return;let L;switch(T.key){case"ArrowLeft":case"ArrowUp":L=O(-1);break;case"ArrowRight":case"ArrowDown":L=O(1);break;default:return}L&&(T.preventDefault(),E(L.dataset[LC("EventKey")]||null,T),v.current=!0,h())};m.useEffect(()=>{if(C.current&&v.current){const T=C.current.querySelector(`[${gb}][aria-selected=true]`);T?.focus()}v.current=!1});const N=hi(a,C);return s.jsx(Bn.Provider,{value:E,children:s.jsx(yc.Provider,{value:{role:d,activeKey:xr(u),getControlledId:j||hb,getControllerId:S||hb},children:s.jsx(o,Object.assign({},g,{onKeyDown:k,ref:N,role:d}))})})});yx.displayName="Nav";const ZC=Object.assign(yx,{Item:bx});var Il;function vb(n){if((!Il&&Il!==0||n)&&Bo){var a=document.createElement("div");a.style.position="absolute",a.style.top="-9999px",a.style.width="50px",a.style.height="50px",a.style.overflow="scroll",document.body.appendChild(a),Il=a.offsetWidth-a.clientWidth,document.body.removeChild(a)}return Il}function KC(){return m.useState(null)}function nf(n){n===void 0&&(n=zo());try{var a=n.activeElement;return!a||!a.nodeName?null:a}catch{return n.body}}function QC(n){const a=m.useRef(n);return a.current=n,a}function WC(n){const a=QC(n);m.useEffect(()=>()=>a.current(),[])}function eA(n=document){const a=n.defaultView;return Math.abs(a.innerWidth-n.documentElement.clientWidth)}const bb=Io("modal-open");class cm{constructor({ownerDocument:a,handleContainerOverflow:o=!0,isRTL:l=!1}={}){this.handleContainerOverflow=o,this.isRTL=l,this.modals=[],this.ownerDocument=a}getScrollbarWidth(){return eA(this.ownerDocument)}getElement(){return(this.ownerDocument||document).body}setModalAttributes(a){}removeModalAttributes(a){}setContainerStyle(a){const o={overflow:"hidden"},l=this.isRTL?"paddingLeft":"paddingRight",u=this.getElement();a.style={overflow:u.style.overflow,[l]:u.style[l]},a.scrollBarWidth&&(o[l]=`${parseInt(la(u,l)||"0",10)+a.scrollBarWidth}px`),u.setAttribute(bb,""),la(u,o)}reset(){[...this.modals].forEach(a=>this.remove(a))}removeContainerStyle(a){const o=this.getElement();o.removeAttribute(bb),Object.assign(o.style,a.style)}add(a){let o=this.modals.indexOf(a);return o!==-1||(o=this.modals.length,this.modals.push(a),this.setModalAttributes(a),o!==0)||(this.state={scrollBarWidth:this.getScrollbarWidth(),style:{}},this.handleContainerOverflow&&this.setContainerStyle(this.state)),o}remove(a){const o=this.modals.indexOf(a);o!==-1&&(this.modals.splice(o,1),!this.modals.length&&this.handleContainerOverflow&&this.removeContainerStyle(this.state),this.removeModalAttributes(a))}isTopModal(a){return!!this.modals.length&&this.modals[this.modals.length-1]===a}}const af=(n,a)=>Bo?n==null?(a||zo()).body:(typeof n=="function"&&(n=n()),n&&"current"in n&&(n=n.current),n&&("nodeType"in n||n.getBoundingClientRect)?n:null):null;function Ef(n,a){const o=xc(),[l,u]=m.useState(()=>af(n,o?.document));if(!l){const d=af(n);d&&u(d)}return m.useEffect(()=>{},[a,l]),m.useEffect(()=>{const d=af(n);d!==l&&u(d)},[n,l]),l}function um({children:n,in:a,onExited:o,mountOnEnter:l,unmountOnExit:u}){const d=m.useRef(null),p=m.useRef(a),g=gt(o);m.useEffect(()=>{a?p.current=!0:g(d.current)},[a,g]);const h=hi(d,Er(n)),v=m.cloneElement(n,{ref:h});return a?v:u||!p.current&&l?null:v}const tA=["onEnter","onEntering","onEntered","onExit","onExiting","onExited","addEndListener","children"];function nA(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function aA(n){let{onEnter:a,onEntering:o,onEntered:l,onExit:u,onExiting:d,onExited:p,addEndListener:g,children:h}=n,v=nA(n,tA);const b=m.useRef(null),x=hi(b,Er(h)),j=L=>B=>{L&&b.current&&L(b.current,B)},S=m.useCallback(j(a),[a]),C=m.useCallback(j(o),[o]),O=m.useCallback(j(l),[l]),E=m.useCallback(j(u),[u]),k=m.useCallback(j(d),[d]),N=m.useCallback(j(p),[p]),T=m.useCallback(j(g),[g]);return Object.assign({},v,{nodeRef:b},a&&{onEnter:S},o&&{onEntering:C},l&&{onEntered:O},u&&{onExit:E},d&&{onExiting:k},p&&{onExited:N},g&&{addEndListener:T},{children:typeof h=="function"?(L,B)=>h(L,Object.assign({},B,{ref:x})):m.cloneElement(h,{ref:x})})}const rA=["component"];function oA(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}const sA=m.forwardRef((n,a)=>{let{component:o}=n,l=oA(n,rA);const u=aA(l);return s.jsx(o,Object.assign({ref:a},u))});function iA({in:n,onTransition:a}){const o=m.useRef(null),l=m.useRef(!0),u=gt(a);return Zv(()=>{if(!o.current)return;let d=!1;return u({in:n,element:o.current,initial:l.current,isStale:()=>d}),()=>{d=!0}},[n,u]),Zv(()=>(l.current=!1,()=>{l.current=!0}),[]),o}function lA({children:n,in:a,onExited:o,onEntered:l,transition:u}){const[d,p]=m.useState(!a);a&&d&&p(!1);const g=iA({in:!!a,onTransition:v=>{const b=()=>{v.isStale()||(v.in?l?.(v.element,v.initial):(p(!0),o?.(v.element)))};Promise.resolve(u(v)).then(b,x=>{throw v.in||p(!0),x})}}),h=hi(g,Er(n));return d&&!a?null:m.cloneElement(n,{ref:h})}function Nf(n,a,o){return n?s.jsx(sA,Object.assign({},o,{component:n})):a?s.jsx(lA,Object.assign({},o,{transition:a})):s.jsx(um,Object.assign({},o))}const cA=["show","role","className","style","children","backdrop","keyboard","onBackdropClick","onEscapeKeyDown","transition","runTransition","backdropTransition","runBackdropTransition","autoFocus","enforceFocus","restoreFocus","restoreFocusOptions","renderDialog","renderBackdrop","manager","container","onShow","onHide","onExit","onExited","onExiting","onEnter","onEntering","onEntered"];function uA(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}let rf;function dA(n){return rf||(rf=new cm({ownerDocument:n?.document})),rf}function fA(n){const a=xc(),o=n||dA(a),l=m.useRef({dialog:null,backdrop:null});return Object.assign(l.current,{add:()=>o.add(l.current),remove:()=>o.remove(l.current),isTopModal:()=>o.isTopModal(l.current),setDialogRef:m.useCallback(u=>{l.current.dialog=u},[]),setBackdropRef:m.useCallback(u=>{l.current.backdrop=u},[])})}const xx=m.forwardRef((n,a)=>{let{show:o=!1,role:l="dialog",className:u,style:d,children:p,backdrop:g=!0,keyboard:h=!0,onBackdropClick:v,onEscapeKeyDown:b,transition:x,runTransition:j,backdropTransition:S,runBackdropTransition:C,autoFocus:O=!0,enforceFocus:E=!0,restoreFocus:k=!0,restoreFocusOptions:N,renderDialog:T,renderBackdrop:L=ze=>s.jsx("div",Object.assign({},ze)),manager:B,container:U,onShow:_,onHide:z=()=>{},onExit:Y,onExited:ee,onExiting:ne,onEnter:le,onEntering:ie,onEntered:ae}=n,P=uA(n,cA);const D=xc(),Q=Ef(U),oe=fA(B),V=my(),A=py(o),[$,re]=m.useState(!o),Z=m.useRef(null);m.useImperativeHandle(a,()=>oe,[oe]),Bo&&!A&&o&&(Z.current=nf(D?.document)),o&&$&&re(!1);const G=gt(()=>{if(oe.add(),zt.current=sa(document,"keydown",we),Ie.current=sa(document,"focus",()=>setTimeout(me),!0),_&&_(),O){var ze,Hn;const ot=nf((ze=(Hn=oe.dialog)==null?void 0:Hn.ownerDocument)!=null?ze:D?.document);oe.dialog&&ot&&!si(oe.dialog,ot)&&(Z.current=ot,oe.dialog.focus())}}),ue=gt(()=>{if(oe.remove(),zt.current==null||zt.current(),Ie.current==null||Ie.current(),k){var ze;(ze=Z.current)==null||ze.focus==null||ze.focus(N),Z.current=null}});m.useEffect(()=>{!o||!Q||G()},[o,Q,G]),m.useEffect(()=>{$&&ue()},[$,ue]),WC(()=>{ue()});const me=gt(()=>{if(!E||!V()||!oe.isTopModal())return;const ze=nf(D?.document);oe.dialog&&ze&&!si(oe.dialog,ze)&&oe.dialog.focus()}),He=gt(ze=>{ze.target===ze.currentTarget&&(v?.(ze),g===!0&&z())}),we=gt(ze=>{h&&cy(ze)&&oe.isTopModal()&&(b?.(ze),ze.defaultPrevented||z())}),Ie=m.useRef(),zt=m.useRef(),Bt=(...ze)=>{re(!0),ee?.(...ze)};if(!Q)return null;const Kt=Object.assign({role:l,ref:oe.setDialogRef,"aria-modal":l==="dialog"?!0:void 0},P,{style:d,className:u,tabIndex:-1});let Qt=T?T(Kt):s.jsx("div",Object.assign({},Kt,{children:m.cloneElement(p,{role:"document"})}));Qt=Nf(x,j,{unmountOnExit:!0,mountOnEnter:!0,appear:!0,in:!!o,onExit:Y,onExiting:ne,onExited:Bt,onEnter:le,onEntering:ie,onEntered:ae,children:Qt});let Wt=null;return g&&(Wt=L({ref:oe.setBackdropRef,onClick:He}),Wt=Nf(S,C,{in:!!o,appear:!0,mountOnEnter:!0,unmountOnExit:!0,children:Wt})),s.jsx(s.Fragment,{children:gr.createPortal(s.jsxs(s.Fragment,{children:[Wt,Qt]}),Q)})});xx.displayName="Modal";const wx=Object.assign(xx,{Manager:cm});function Cf(n,a){return n.classList?!!a&&n.classList.contains(a):(" "+(n.className.baseVal||n.className)+" ").indexOf(" "+a+" ")!==-1}function mA(n,a){n.classList?n.classList.add(a):Cf(n,a)||(typeof n.className=="string"?n.className=n.className+" "+a:n.setAttribute("class",(n.className&&n.className.baseVal||"")+" "+a))}function yb(n,a){return n.replace(new RegExp("(^|\\s)"+a+"(?:\\s|$)","g"),"$1").replace(/\s+/g," ").replace(/^\s*|\s*$/g,"")}function pA(n,a){n.classList?n.classList.remove(a):typeof n.className=="string"?n.className=yb(n.className,a):n.setAttribute("class",yb(n.className&&n.className.baseVal||"",a))}const bo={FIXED_CONTENT:".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",STICKY_CONTENT:".sticky-top",NAVBAR_TOGGLER:".navbar-toggler"};class jx extends cm{adjustAndStore(a,o,l){const u=o.style[a];o.dataset[a]=u,la(o,{[a]:`${parseFloat(la(o,a))+l}px`})}restore(a,o){const l=o.dataset[a];l!==void 0&&(delete o.dataset[a],la(o,{[a]:l}))}setContainerStyle(a){super.setContainerStyle(a);const o=this.getElement();if(mA(o,"modal-open"),!a.scrollBarWidth)return;const l=this.isRTL?"paddingLeft":"paddingRight",u=this.isRTL?"marginLeft":"marginRight";ra(o,bo.FIXED_CONTENT).forEach(d=>this.adjustAndStore(l,d,a.scrollBarWidth)),ra(o,bo.STICKY_CONTENT).forEach(d=>this.adjustAndStore(u,d,-a.scrollBarWidth)),ra(o,bo.NAVBAR_TOGGLER).forEach(d=>this.adjustAndStore(u,d,a.scrollBarWidth))}removeContainerStyle(a){super.removeContainerStyle(a);const o=this.getElement();pA(o,"modal-open");const l=this.isRTL?"paddingLeft":"paddingRight",u=this.isRTL?"marginLeft":"marginRight";ra(o,bo.FIXED_CONTENT).forEach(d=>this.restore(l,d)),ra(o,bo.STICKY_CONTENT).forEach(d=>this.restore(u,d)),ra(o,bo.NAVBAR_TOGGLER).forEach(d=>this.restore(u,d))}}let of;function Sx(n){return of||(of=new jx(n)),of}const Ex=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"modal-body"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Ex.displayName="ModalBody";const dm=m.createContext({onHide(){}}),fm=m.forwardRef(({bsPrefix:n,className:a,contentClassName:o,centered:l,size:u,fullscreen:d,children:p,scrollable:g,...h},v)=>{n=de(n,"modal");const b=`${n}-dialog`,x=typeof d=="string"?`${n}-fullscreen-${d}`:`${n}-fullscreen`;return s.jsx("div",{...h,ref:v,className:ce(b,a,u&&`${n}-${u}`,l&&`${b}-centered`,g&&`${b}-scrollable`,d&&x),children:s.jsx("div",{className:ce(`${n}-content`,o),children:p})})});fm.displayName="ModalDialog";const Nx=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"modal-footer"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Nx.displayName="ModalFooter";const mm=m.forwardRef(({closeLabel:n="Close",closeVariant:a,closeButton:o=!1,onHide:l,children:u,...d},p)=>{const g=m.useContext(dm),h=da(()=>{g?.onHide(),l?.()});return s.jsxs("div",{ref:p,...d,children:[u,o&&s.jsx(gc,{"aria-label":n,variant:a,onClick:h})]})});mm.displayName="AbstractModalHeader";const Cx=m.forwardRef(({bsPrefix:n,className:a,closeLabel:o="Close",closeButton:l=!1,...u},d)=>(n=de(n,"modal-header"),s.jsx(mm,{ref:d,...u,className:ce(a,n),closeLabel:o,closeButton:l})));Cx.displayName="ModalHeader";const hA=hc("h4"),Ax=m.forwardRef(({className:n,bsPrefix:a,as:o=hA,...l},u)=>(a=de(a,"modal-title"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Ax.displayName="ModalTitle";function gA(n){return s.jsx(fa,{...n,timeout:null})}function vA(n){return s.jsx(fa,{...n,timeout:null})}const Ox=m.forwardRef(({bsPrefix:n,className:a,style:o,dialogClassName:l,contentClassName:u,children:d,dialogAs:p=fm,"data-bs-theme":g,"aria-labelledby":h,"aria-describedby":v,"aria-label":b,show:x=!1,animation:j=!0,backdrop:S=!0,keyboard:C=!0,onEscapeKeyDown:O,onShow:E,onHide:k,container:N,autoFocus:T=!0,enforceFocus:L=!0,restoreFocus:B=!0,restoreFocusOptions:U,onEntered:_,onExit:z,onExiting:Y,onEnter:ee,onEntering:ne,onExited:le,backdropClassName:ie,manager:ae,...P},D)=>{const[Q,oe]=m.useState({}),[V,A]=m.useState(!1),$=m.useRef(!1),re=m.useRef(!1),Z=m.useRef(null),[G,ue]=KC(),me=Uo(D,ue),He=da(k),we=mc();n=de(n,"modal");const Ie=m.useMemo(()=>({onHide:He}),[He]);function zt(){return ae||Sx({isRTL:we})}function Bt(je){if(!Bo)return;const Ye=zt().getScrollbarWidth()>0,At=je.scrollHeight>zo(je).documentElement.clientHeight;oe({paddingRight:Ye&&!At?vb():void 0,paddingLeft:!Ye&&At?vb():void 0})}const Kt=da(()=>{G&&Bt(G.dialog)});Ey(()=>{yf(window,"resize",Kt),Z.current==null||Z.current()});const Qt=()=>{$.current=!0},Wt=je=>{$.current&&G&&je.target===G.dialog&&(re.current=!0),$.current=!1},ze=()=>{A(!0),Z.current=uy(G.dialog,()=>{A(!1)})},Hn=je=>{je.target===je.currentTarget&&ze()},ot=je=>{if(S==="static"){Hn(je);return}if(re.current||je.target!==je.currentTarget){re.current=!1;return}k?.()},Zo=je=>{C?O?.(je):(je.preventDefault(),S==="static"&&ze())},Or=(je,Ye)=>{je&&Bt(je),ee?.(je,Ye)},en=je=>{Z.current==null||Z.current(),z?.(je)},wn=(je,Ye)=>{ne?.(je,Ye),Gf(window,"resize",Kt)},kr=je=>{je&&(je.style.display=""),le?.(je),yf(window,"resize",Kt)},Xa=m.useCallback(je=>s.jsx("div",{...je,className:ce(`${n}-backdrop`,ie,!j&&"show")}),[j,ie,n]),ba={...o,...Q};ba.display="block";const Tr=je=>s.jsx("div",{role:"dialog",...je,style:ba,className:ce(a,n,V&&`${n}-static`,!j&&"show"),onClick:S?ot:void 0,onMouseUp:Wt,"data-bs-theme":g,"aria-label":b,"aria-labelledby":h,"aria-describedby":v,children:s.jsx(p,{...P,onMouseDown:Qt,className:l,contentClassName:u,children:d})});return s.jsx(dm.Provider,{value:Ie,children:s.jsx(wx,{show:x,ref:me,backdrop:S,container:N,keyboard:!0,autoFocus:T,enforceFocus:L,restoreFocus:B,restoreFocusOptions:U,onEscapeKeyDown:Zo,onShow:E,onHide:k,onEnter:Or,onEntering:wn,onEntered:_,onExit:en,onExiting:Y,onExited:kr,manager:zt(),transition:j?gA:void 0,backdropTransition:j?vA:void 0,renderBackdrop:Xa,renderDialog:Tr})})});Ox.displayName="Modal";const ye=Object.assign(Ox,{Body:Ex,Header:Cx,Title:Ax,Footer:Nx,Dialog:fm,TRANSITION_DURATION:300,BACKDROP_TRANSITION_DURATION:150}),pm=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"nav-item"),s.jsx(o,{ref:u,className:ce(n,a),...l})));pm.displayName="NavItem";const Ec=m.forwardRef(({bsPrefix:n,className:a,as:o=Xf,active:l,eventKey:u,disabled:d=!1,...p},g)=>{n=de(n,"nav-link");const[h,v]=vx({key:xr(u,p.href),active:l,disabled:d,...p});return s.jsx(o,{...p,...h,ref:g,disabled:d,className:ce(a,n,d&&"disabled",v.isActive&&"active")})});Ec.displayName="NavLink";const kx=m.forwardRef((n,a)=>{const{as:o="div",bsPrefix:l,variant:u,fill:d=!1,justify:p=!1,navbar:g,navbarScroll:h,className:v,activeKey:b,...x}=fc(n,{activeKey:"onSelect"}),j=de(l,"nav");let S,C,O=!1;const E=m.useContext(Nr),k=m.useContext(Kf);return E?(S=E.bsPrefix,O=g??!0):k&&({cardHeaderBsPrefix:C}=k),s.jsx(ZC,{as:o,ref:a,activeKey:b,className:ce(v,{[j]:!O,[`${S}-nav`]:O,[`${S}-nav-scroll`]:O&&h,[`${C}-${u}`]:!!C,[`${j}-${u}`]:!!u,[`${j}-fill`]:d,[`${j}-justified`]:p}),...x})});kx.displayName="Nav";const Ft=Object.assign(kx,{Item:pm,Link:Ec}),Tx=m.forwardRef(({bsPrefix:n,className:a,as:o,...l},u)=>{n=de(n,"navbar-brand");const d=o||(l.href?"a":"span");return s.jsx(d,{...l,ref:u,className:ce(a,n)})});Tx.displayName="NavbarBrand";const Rx=m.forwardRef(({children:n,bsPrefix:a,...o},l)=>{a=de(a,"navbar-collapse");const u=m.useContext(Nr);return s.jsx(fy,{in:!!(u&&u.expanded),...o,children:s.jsx("div",{ref:l,className:a,children:n})})});Rx.displayName="NavbarCollapse";const Dx=m.forwardRef(({bsPrefix:n,className:a,children:o,label:l="Toggle navigation",as:u="button",onClick:d,...p},g)=>{n=de(n,"navbar-toggler");const{onToggle:h,expanded:v}=m.useContext(Nr)||{},b=da(x=>{d&&d(x),h&&h()});return u==="button"&&(p.type="button"),s.jsx(u,{...p,ref:g,onClick:b,"aria-label":l,className:ce(a,n,!v&&"collapsed"),children:o||s.jsx("span",{className:`${n}-icon`})})});Dx.displayName="NavbarToggle";const Af=new WeakMap,xb=(n,a)=>{if(!n||!a)return;const o=Af.get(a)||new Map;Af.set(a,o);let l=o.get(n);return l||(l=a.matchMedia(n),l.refCount=0,o.set(l.media,l)),l};function bA(n,a=typeof window>"u"?void 0:window){const o=xb(n,a),[l,u]=m.useState(()=>o?o.matches:!1);return sm(()=>{let d=xb(n,a);if(!d)return u(!1);let p=Af.get(a);const g=()=>{u(d.matches)};return d.refCount++,d.addListener(g),g(),()=>{d.removeListener(g),d.refCount--,d.refCount<=0&&p?.delete(d.media),d=void 0}},[n]),l}function yA(n){const a=Object.keys(n);function o(g,h){return g===h?h:g?`${g} and ${h}`:h}function l(g){return a[Math.min(a.indexOf(g)+1,a.length-1)]}function u(g){const h=l(g);let v=n[h];return typeof v=="number"?v=`${v-.2}px`:v=`calc(${v} - 0.2px)`,`(max-width: ${v})`}function d(g){let h=n[g];return typeof h=="number"&&(h=`${h}px`),`(min-width: ${h})`}function p(g,h,v){let b;typeof g=="object"?(b=g,v=h,h=!0):(h=h||!0,b={[g]:h});let x=m.useMemo(()=>Object.entries(b).reduce((j,[S,C])=>((C==="up"||C===!0)&&(j=o(j,d(S))),(C==="down"||C===!0)&&(j=o(j,u(S))),j),""),[JSON.stringify(b)]);return bA(x,v)}return p}const xA=yA({xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1400}),Lx=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"offcanvas-body"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Lx.displayName="OffcanvasBody";const wA={[mn]:"show",[oa]:"show"},Mx=m.forwardRef(({bsPrefix:n,className:a,children:o,in:l=!1,mountOnEnter:u=!1,unmountOnExit:d=!1,appear:p=!1,...g},h)=>(n=de(n,"offcanvas"),s.jsx(pc,{ref:h,addEndListener:Ff,in:l,mountOnEnter:u,unmountOnExit:d,appear:p,...g,childRef:Er(o),children:(v,b)=>m.cloneElement(o,{...b,className:ce(a,o.props.className,(v===mn||v===No)&&`${n}-toggling`,wA[v])})})));Mx.displayName="OffcanvasToggling";const _x=m.forwardRef(({bsPrefix:n,className:a,closeLabel:o="Close",closeButton:l=!1,...u},d)=>(n=de(n,"offcanvas-header"),s.jsx(mm,{ref:d,...u,className:ce(a,n),closeLabel:o,closeButton:l})));_x.displayName="OffcanvasHeader";const jA=hc("h5"),zx=m.forwardRef(({className:n,bsPrefix:a,as:o=jA,...l},u)=>(a=de(a,"offcanvas-title"),s.jsx(o,{ref:u,className:ce(n,a),...l})));zx.displayName="OffcanvasTitle";function SA(n){return s.jsx(Mx,{...n})}function EA(n){return s.jsx(fa,{...n})}const Bx=m.forwardRef(({bsPrefix:n,className:a,children:o,"aria-labelledby":l,placement:u="start",responsive:d,show:p=!1,backdrop:g=!0,keyboard:h=!0,scroll:v=!1,onEscapeKeyDown:b,onShow:x,onHide:j,container:S,autoFocus:C=!0,enforceFocus:O=!0,restoreFocus:E=!0,restoreFocusOptions:k,onEntered:N,onExit:T,onExiting:L,onEnter:B,onEntering:U,onExited:_,backdropClassName:z,manager:Y,renderStaticNode:ee=!1,...ne},le)=>{const ie=m.useRef();n=de(n,"offcanvas");const[ae,P]=m.useState(!1),D=da(j),Q=xA(d||"xs","up");m.useEffect(()=>{P(d?p&&!Q:p)},[p,d,Q]);const oe=m.useMemo(()=>({onHide:D}),[D]);function V(){return Y||(v?(ie.current||(ie.current=new jx({handleContainerOverflow:!1})),ie.current):Sx())}const A=(G,...ue)=>{G&&(G.style.visibility="visible"),B?.(G,...ue)},$=(G,...ue)=>{G&&(G.style.visibility=""),_?.(...ue)},re=m.useCallback(G=>s.jsx("div",{...G,className:ce(`${n}-backdrop`,z)}),[z,n]),Z=G=>s.jsx("div",{...G,...ne,className:ce(a,d?`${n}-${d}`:n,`${n}-${u}`),"aria-labelledby":l,children:o});return s.jsxs(s.Fragment,{children:[!ae&&(d||ee)&&Z({}),s.jsx(dm.Provider,{value:oe,children:s.jsx(wx,{show:ae,ref:le,backdrop:g,container:S,keyboard:h,autoFocus:C,enforceFocus:O&&!v,restoreFocus:E,restoreFocusOptions:k,onEscapeKeyDown:b,onShow:x,onHide:D,onEnter:A,onEntering:U,onEntered:N,onExit:T,onExiting:L,onExited:$,manager:V(),transition:SA,backdropTransition:EA,renderBackdrop:re,renderDialog:Z})})]})});Bx.displayName="Offcanvas";const qa=Object.assign(Bx,{Body:Lx,Header:_x,Title:zx}),Ux=m.forwardRef(({onHide:n,...a},o)=>{const l=m.useContext(Nr),u=da(()=>{l==null||l.onToggle==null||l.onToggle(),n?.()});return s.jsx(qa,{ref:o,show:!!(l!=null&&l.expanded),...a,renderStaticNode:!0,onHide:u})});Ux.displayName="NavbarOffcanvas";const Px=m.forwardRef(({className:n,bsPrefix:a,as:o="span",...l},u)=>(a=de(a,"navbar-text"),s.jsx(o,{ref:u,className:ce(n,a),...l})));Px.displayName="NavbarText";const Ix=m.forwardRef((n,a)=>{const{bsPrefix:o,expand:l=!0,variant:u="light",bg:d,fixed:p,sticky:g,className:h,as:v="nav",expanded:b,onToggle:x,onSelect:j,collapseOnSelect:S=!1,...C}=fc(n,{expanded:"onToggle"}),O=de(o,"navbar"),E=m.useCallback((...T)=>{j?.(...T),S&&b&&x?.(!1)},[j,S,b,x]);C.role===void 0&&v!=="nav"&&(C.role="navigation");let k=`${O}-expand`;typeof l=="string"&&(k=`${k}-${l}`);const N=m.useMemo(()=>({onToggle:()=>x?.(!b),bsPrefix:O,expanded:!!b,expand:l}),[O,b,l,x]);return s.jsx(Nr.Provider,{value:N,children:s.jsx(Bn.Provider,{value:E,children:s.jsx(v,{ref:a,...C,className:ce(h,O,l&&k,u&&`${O}-${u}`,d&&`bg-${d}`,g&&`sticky-${g}`,p&&`fixed-${p}`)})})})});Ix.displayName="Navbar";const $l=Object.assign(Ix,{Brand:Tx,Collapse:Rx,Offcanvas:Ux,Text:Px,Toggle:Dx}),$x=m.forwardRef(({id:n,title:a,children:o,bsPrefix:l,className:u,rootCloseEvent:d,menuRole:p,disabled:g,active:h,renderMenuOnMount:v,menuVariant:b,...x},j)=>{const S=de(void 0,"nav-item");return s.jsxs(pn,{ref:j,...x,className:ce(u,S),children:[s.jsx(pn.Toggle,{id:n,eventKey:null,active:h,disabled:g,childBsPrefix:l,as:Ec,children:a}),s.jsx(pn.Menu,{role:p,renderOnMount:v,rootCloseEvent:d,variant:b,children:o})]})});$x.displayName="NavDropdown";const dn=Object.assign($x,{Item:pn.Item,ItemText:pn.ItemText,Divider:pn.Divider,Header:pn.Header}),NA=()=>{};function CA(n,a,{disabled:o,clickTrigger:l}={}){const u=a||NA;Py(n,u,{disabled:o,clickTrigger:l});const d=gt(p=>{cy(p)&&u(p)});m.useEffect(()=>{if(o||n==null)return;const p=zo(Vl(n));let g=(p.defaultView||window).event;const h=sa(p,"keyup",v=>{if(v===g){g=void 0;return}d(v)});return()=>{h()}},[n,o,d])}const Hx=m.forwardRef((n,a)=>{const{flip:o,offset:l,placement:u,containerPadding:d,popperConfig:p={},transition:g,runTransition:h}=n,[v,b]=xf(),[x,j]=xf(),S=hi(b,a),C=Ef(n.container),O=Ef(n.target),[E,k]=m.useState(!n.show),N=Uy(O,v,Iy({placement:u,enableEvents:!!n.show,containerPadding:d||5,flip:o,offset:l,arrowElement:x,popperConfig:p}));n.show&&E&&k(!1);const T=(...ne)=>{k(!0),n.onExited&&n.onExited(...ne)},L=n.show||!E;if(CA(v,n.onHide,{disabled:!n.rootClose||n.rootCloseDisabled,clickTrigger:n.rootCloseEvent}),!L)return null;const{onExit:B,onExiting:U,onEnter:_,onEntering:z,onEntered:Y}=n;let ee=n.children(Object.assign({},N.attributes.popper,{style:N.styles.popper,ref:S}),{popper:N,placement:u,show:!!n.show,arrowProps:Object.assign({},N.attributes.arrow,{style:N.styles.arrow,ref:j})});return ee=Nf(g,h,{in:!!n.show,appear:!0,mountOnEnter:!0,unmountOnExit:!0,children:ee,onExit:B,onExiting:U,onExited:T,onEnter:_,onEntering:z,onEntered:Y}),C?gr.createPortal(ee,C):null});Hx.displayName="Overlay";const qx=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"popover-header"),s.jsx(o,{ref:u,className:ce(n,a),...l})));qx.displayName="PopoverHeader";const hm=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"popover-body"),s.jsx(o,{ref:u,className:ce(n,a),...l})));hm.displayName="PopoverBody";function Jx(n,a){let o=n;return n==="left"?o=a?"end":"start":n==="right"&&(o=a?"start":"end"),o}function Gx(n="absolute"){return{position:n,top:"0",left:"0",opacity:"0",pointerEvents:"none"}}const Fx=m.forwardRef(({bsPrefix:n,placement:a="right",className:o,style:l,children:u,body:d,arrowProps:p,hasDoneInitialMeasure:g,popper:h,show:v,...b},x)=>{const j=de(n,"popover"),S=mc(),[C]=a?.split("-")||[],O=Jx(C,S);let E=l;return v&&!g&&(E={...l,...Gx(h?.strategy)}),s.jsxs("div",{ref:x,role:"tooltip",style:E,"x-placement":C,className:ce(o,j,C&&`bs-popover-${O}`),...b,children:[s.jsx("div",{className:"popover-arrow",...p}),d?s.jsx(hm,{children:u}):u]})});Fx.displayName="Popover";const AA=Object.assign(Fx,{Header:qx,Body:hm,POPPER_OFFSET:[0,8]}),Vx=m.forwardRef(({bsPrefix:n,placement:a="right",className:o,style:l,children:u,arrowProps:d,hasDoneInitialMeasure:p,popper:g,show:h,...v},b)=>{n=de(n,"tooltip");const x=mc(),[j]=a?.split("-")||[],S=Jx(j,x);let C=l;return h&&!p&&(C={...l,...Gx(g?.strategy)}),s.jsxs("div",{ref:b,style:C,role:"tooltip","x-placement":j,className:ce(o,n,`bs-tooltip-${S}`),...v,children:[s.jsx("div",{className:"tooltip-arrow",...d}),s.jsx("div",{className:`${n}-inner`,children:u})]})});Vx.displayName="Tooltip";const hr=Object.assign(Vx,{TOOLTIP_OFFSET:[0,6]});function OA(n){const a=m.useRef(null),o=de(void 0,"popover"),l=de(void 0,"tooltip"),u=m.useMemo(()=>({name:"offset",options:{offset:()=>{if(n)return n;if(a.current){if(Cf(a.current,o))return AA.POPPER_OFFSET;if(Cf(a.current,l))return hr.TOOLTIP_OFFSET}return[0,0]}}}),[n,o,l]);return[a,[u]]}function kA(n,a){const{ref:o}=n,{ref:l}=a;n.ref=o.__wrapped||(o.__wrapped=u=>o(Xl(u))),a.ref=l.__wrapped||(l.__wrapped=u=>l(Xl(u)))}const Yx=m.forwardRef(({children:n,transition:a=fa,popperConfig:o={},rootClose:l=!1,placement:u="top",show:d=!1,...p},g)=>{const h=m.useRef({}),[v,b]=m.useState(null),[x,j]=OA(p.offset),S=Uo(g,x),C=a===!0?fa:a||void 0,O=da(E=>{b(E),o==null||o.onFirstUpdate==null||o.onFirstUpdate(E)});return sm(()=>{v&&p.target&&(h.current.scheduleUpdate==null||h.current.scheduleUpdate())},[v,p.target]),m.useEffect(()=>{d||b(null)},[d]),s.jsx(Hx,{...p,ref:S,popperConfig:{...o,modifiers:j.concat(o.modifiers||[]),onFirstUpdate:O},transition:C,rootClose:l,placement:u,show:d,children:(E,{arrowProps:k,popper:N,show:T})=>{var L;kA(E,k);const B=N?.placement,U=Object.assign(h.current,{state:N?.state,scheduleUpdate:N?.update,placement:B,outOfBoundaries:(N==null||(L=N.state)==null||(L=L.modifiersData.hide)==null?void 0:L.isReferenceHidden)||!1,strategy:o.strategy}),_=!!v;return typeof n=="function"?n({...E,placement:B,show:T,...!a&&T&&{className:"show"},popper:U,arrowProps:k,hasDoneInitialMeasure:_}):m.cloneElement(n,{...E,placement:B,arrowProps:k,popper:U,hasDoneInitialMeasure:_,className:ce(n.props.className,!a&&T&&"show"),style:{...n.props.style,...E.style}})}})});Yx.displayName="Overlay";function TA(n){return n&&typeof n=="object"?n:{show:n,hide:n}}function wb(n,a,o){const[l]=a,u=l.currentTarget,d=l.relatedTarget||l.nativeEvent[o];(!d||d!==u)&&!si(u,d)&&n(...a)}_e.oneOf(["click","hover","focus"]);const yo=({trigger:n=["hover","focus"],overlay:a,children:o,popperConfig:l={},show:u,defaultShow:d=!1,onToggle:p,delay:g,placement:h,flip:v=h&&h.indexOf("auto")!==-1,...b})=>{const x=m.useRef(null),j=Uo(x,Er(o)),S=Cy(),C=m.useRef(""),[O,E]=oy(u,d,p),k=TA(g),{onFocus:N,onBlur:T,onClick:L}=typeof o!="function"?m.Children.only(o).props:{},B=P=>{j(Xl(P))},U=m.useCallback(()=>{if(S.clear(),C.current="show",!k.show){E(!0);return}S.set(()=>{C.current==="show"&&E(!0)},k.show)},[k.show,E,S]),_=m.useCallback(()=>{if(S.clear(),C.current="hide",!k.hide){E(!1);return}S.set(()=>{C.current==="hide"&&E(!1)},k.hide)},[k.hide,E,S]),z=m.useCallback((...P)=>{U(),N?.(...P)},[U,N]),Y=m.useCallback((...P)=>{_(),T?.(...P)},[_,T]),ee=m.useCallback((...P)=>{E(!O),L?.(...P)},[L,E,O]),ne=m.useCallback((...P)=>{wb(U,P,"fromElement")},[U]),le=m.useCallback((...P)=>{wb(_,P,"toElement")},[_]),ie=n==null?[]:[].concat(n),ae={ref:B};return ie.indexOf("click")!==-1&&(ae.onClick=ee),ie.indexOf("focus")!==-1&&(ae.onFocus=z,ae.onBlur=Y),ie.indexOf("hover")!==-1&&(ae.onMouseOver=ne,ae.onMouseOut=le),s.jsxs(s.Fragment,{children:[typeof o=="function"?o(ae):m.cloneElement(o,ae),s.jsx(Yx,{...b,show:O,onHide:_,flip:v,placement:h,popperConfig:l,target:x.current,children:a})]})},wr=m.forwardRef(({bsPrefix:n,className:a,as:o="div",...l},u)=>{const d=de(n,"row"),p=sy(),g=iy(),h=`${d}-cols`,v=[];return p.forEach(b=>{const x=l[b];delete l[b];let j;x!=null&&typeof x=="object"?{cols:j}=x:j=x;const S=b!==g?`-${b}`:"";j!=null&&v.push(`${h}${S}-${j}`)}),s.jsx(o,{ref:u,...l,className:ce(a,d,...v)})});wr.displayName="Row";const St=m.forwardRef(({bsPrefix:n,variant:a,animation:o="border",size:l,as:u="div",className:d,...p},g)=>{n=de(n,"spinner");const h=`${n}-${o}`;return s.jsx(u,{ref:g,...p,className:ce(d,h,l&&`${h}-${l}`,a&&`text-${a}`)})});St.displayName="Spinner";const RA=["active","eventKey","mountOnEnter","transition","unmountOnExit","role","onEnter","onEntering","onEntered","onExit","onExiting","onExited"],DA=["activeKey","getControlledId","getControllerId"],LA=["as"];function Of(n,a){if(n==null)return{};var o={};for(var l in n)if({}.hasOwnProperty.call(n,l)){if(a.indexOf(l)>=0)continue;o[l]=n[l]}return o}function Xx(n){let{active:a,eventKey:o,mountOnEnter:l,transition:u,unmountOnExit:d,role:p="tabpanel",onEnter:g,onEntering:h,onEntered:v,onExit:b,onExiting:x,onExited:j}=n,S=Of(n,RA);const C=m.useContext($o);if(!C)return[Object.assign({},S,{role:p}),{eventKey:o,isActive:a,mountOnEnter:l,transition:u,unmountOnExit:d,onEnter:g,onEntering:h,onEntered:v,onExit:b,onExiting:x,onExited:j}];const{activeKey:O,getControlledId:E,getControllerId:k}=C,N=Of(C,DA),T=xr(o);return[Object.assign({},S,{role:p,id:E(o),"aria-labelledby":k(o)}),{eventKey:o,isActive:a==null&&T!=null?xr(O)===T:a,transition:u||N.transition,mountOnEnter:l??N.mountOnEnter,unmountOnExit:d??N.unmountOnExit,onEnter:g,onEntering:h,onEntered:v,onExit:b,onExiting:x,onExited:j}]}const Zx=m.forwardRef((n,a)=>{let{as:o="div"}=n,l=Of(n,LA);const[u,{isActive:d,onEnter:p,onEntering:g,onEntered:h,onExit:v,onExiting:b,onExited:x,mountOnEnter:j,unmountOnExit:S,transition:C=um}]=Xx(l);return s.jsx($o.Provider,{value:null,children:s.jsx(Bn.Provider,{value:null,children:s.jsx(C,{in:d,onEnter:p,onEntering:g,onEntered:h,onExit:v,onExiting:b,onExited:x,mountOnEnter:j,unmountOnExit:S,children:s.jsx(o,Object.assign({},u,{ref:a,hidden:!d,"aria-hidden":!d}))})})})});Zx.displayName="TabPanel";const gm=n=>{const{id:a,generateChildId:o,onSelect:l,activeKey:u,defaultActiveKey:d,transition:p,mountOnEnter:g,unmountOnExit:h,children:v}=n,[b,x]=Ay(u,d,l),j=Gy(a),S=m.useMemo(()=>o||((O,E)=>j?`${j}-${E}-${O}`:null),[j,o]),C=m.useMemo(()=>({onSelect:x,activeKey:b,transition:p,mountOnEnter:g||!1,unmountOnExit:h||!1,getControlledId:O=>S(O,"tabpane"),getControllerId:O=>S(O,"tab")}),[x,b,p,g,h,S]);return s.jsx($o.Provider,{value:C,children:s.jsx(Bn.Provider,{value:x||null,children:v})})};gm.Panel=Zx;function vm(n){return typeof n=="boolean"?n?fa:um:n}const Kx=({transition:n,...a})=>s.jsx(gm,{...a,transition:vm(n)});Kx.displayName="TabContainer";const bm=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"tab-content"),s.jsx(o,{ref:u,className:ce(n,a),...l})));bm.displayName="TabContent";const ym=m.forwardRef(({bsPrefix:n,transition:a,...o},l)=>{const[{className:u,as:d="div",...p},{isActive:g,onEnter:h,onEntering:v,onEntered:b,onExit:x,onExiting:j,onExited:S,mountOnEnter:C,unmountOnExit:O,transition:E=fa}]=Xx({...o,transition:vm(a)}),k=de(n,"tab-pane");return s.jsx($o.Provider,{value:null,children:s.jsx(Bn.Provider,{value:null,children:s.jsx(E,{in:g,onEnter:h,onEntering:v,onEntered:b,onExit:x,onExiting:j,onExited:S,mountOnEnter:C,unmountOnExit:O,children:s.jsx(d,{...p,ref:l,className:ce(u,k,g&&"active")})})})})});ym.displayName="TabPane";const MA={eventKey:_e.oneOfType([_e.string,_e.number]),title:_e.node.isRequired,disabled:_e.bool,tabClassName:_e.string,tabAttrs:_e.object},Qx=()=>{throw new Error("ReactBootstrap: The `Tab` component is not meant to be rendered! It's an abstract component that is only valid as a direct Child of the `Tabs` Component. For custom tabs components use TabPane and TabsContainer directly")};Qx.propTypes=MA;const jo=Object.assign(Qx,{Container:Kx,Content:bm,Pane:ym}),gi=m.forwardRef(({bsPrefix:n,className:a,striped:o,bordered:l,borderless:u,hover:d,size:p,variant:g,responsive:h,...v},b)=>{const x=de(n,"table"),j=ce(a,x,g&&`${x}-${g}`,p&&`${x}-${p}`,o&&`${x}-${typeof o=="string"?`striped-${o}`:"striped"}`,l&&`${x}-bordered`,u&&`${x}-borderless`,d&&`${x}-hover`),S=s.jsx("table",{...v,className:j,ref:b});if(h){let C=`${x}-responsive`;return typeof h=="string"&&(C=`${C}-${h}`),s.jsx("div",{className:C,children:S})}return S});gi.displayName="Table";function _A(n){let a;return t2(n,o=>{a==null&&(a=o.props.eventKey)}),a}function zA(n){const{title:a,eventKey:o,disabled:l,tabClassName:u,tabAttrs:d,id:p}=n.props;return a==null?null:s.jsx(pm,{as:"li",role:"presentation",children:s.jsx(Ec,{as:"button",type:"button",eventKey:o,disabled:l,id:p,className:u,...d,children:a})})}const xm=n=>{const{id:a,onSelect:o,transition:l,mountOnEnter:u=!1,unmountOnExit:d=!1,variant:p="tabs",children:g,activeKey:h=_A(g),...v}=fc(n,{activeKey:"onSelect"});return s.jsxs(gm,{id:a,activeKey:h,onSelect:o,transition:vm(l),mountOnEnter:u,unmountOnExit:d,children:[s.jsx(Ft,{id:a,...v,role:"tablist",as:"ul",variant:p,children:Kv(g,zA)}),s.jsx(bm,{children:Kv(g,b=>{const x={...b.props};return delete x.title,delete x.disabled,delete x.tabClassName,delete x.tabAttrs,s.jsx(ym,{...x})})})]})};xm.displayName="Tabs";const BA={[mn]:"showing",[No]:"showing show"},Wx=m.forwardRef((n,a)=>s.jsx(fa,{...n,ref:a,transitionClasses:BA}));Wx.displayName="ToastFade";const ew=m.createContext({onClose(){}}),tw=m.forwardRef(({bsPrefix:n,closeLabel:a="Close",closeVariant:o,closeButton:l=!0,className:u,children:d,...p},g)=>{n=de(n,"toast-header");const h=m.useContext(ew),v=da(b=>{h==null||h.onClose==null||h.onClose(b)});return s.jsxs("div",{ref:g,...p,className:ce(n,u),children:[d,l&&s.jsx(gc,{"aria-label":a,variant:o,onClick:v,"data-dismiss":"toast"})]})});tw.displayName="ToastHeader";const nw=m.forwardRef(({className:n,bsPrefix:a,as:o="div",...l},u)=>(a=de(a,"toast-body"),s.jsx(o,{ref:u,className:ce(n,a),...l})));nw.displayName="ToastBody";const aw=m.forwardRef(({bsPrefix:n,className:a,transition:o=Wx,show:l=!0,animation:u=!0,delay:d=5e3,autohide:p=!1,onClose:g,onEntered:h,onExit:v,onExiting:b,onEnter:x,onEntering:j,onExited:S,bg:C,...O},E)=>{n=de(n,"toast");const k=m.useRef(d),N=m.useRef(g);m.useEffect(()=>{k.current=d,N.current=g},[d,g]);const T=Cy(),L=!!(p&&l),B=m.useCallback(()=>{L&&(N.current==null||N.current())},[L]);m.useEffect(()=>{T.set(B,k.current)},[T,B]);const U=m.useMemo(()=>({onClose:g}),[g]),_=!!(o&&u),z=s.jsx("div",{...O,ref:E,className:ce(n,a,C&&`bg-${C}`,!_&&(l?"show":"hide")),role:"alert","aria-live":"assertive","aria-atomic":"true"});return s.jsx(ew.Provider,{value:U,children:_&&o?s.jsx(o,{in:l,onEnter:x,onEntering:j,onEntered:h,onExit:v,onExiting:b,onExited:S,unmountOnExit:!0,children:z}):z})});aw.displayName="Toast";const Et=Object.assign(aw,{Body:nw,Header:tw}),UA={"top-start":"top-0 start-0","top-center":"top-0 start-50 translate-middle-x","top-end":"top-0 end-0","middle-start":"top-50 start-0 translate-middle-y","middle-center":"top-50 start-50 translate-middle","middle-end":"top-50 end-0 translate-middle-y","bottom-start":"bottom-0 start-0","bottom-center":"bottom-0 start-50 translate-middle-x","bottom-end":"bottom-0 end-0"},Ho=m.forwardRef(({bsPrefix:n,position:a,containerPosition:o,className:l,as:u="div",...d},p)=>(n=de(n,"toast-container"),s.jsx(u,{ref:p,...d,className:ce(n,a&&UA[a],o&&`position-${o}`,l)})));Ho.displayName="ToastContainer";const rw=m.createContext();function PA({children:n}){const[a,o]=m.useState([]),l=m.useCallback((g,h="success",v=3e3,b="Notificación")=>{const x=crypto.randomUUID();o(j=>[...j,{id:x,message:g,variant:h,delay:v,header:b}])},[]),u=g=>{o(h=>h.filter(v=>v.id!==g))},d=g=>{switch(g){case"success":return{color:"#0f5132"};case"danger":return{color:"#842029"};case"warning":return{color:"#664d03"};case"info":return{color:"#055160"};default:return{color:"#212529"}}},p=g=>{switch(g){case"success":case"danger":case"warning":case"info":return"text-white";default:return"text-dark"}};return s.jsxs(rw.Provider,{value:{showToast:l},children:[n,s.jsx(Ho,{position:"bottom-end",className:"p-3",style:{zIndex:2e3},children:a.map(g=>s.jsxs(Et,{bg:g.variant,autohide:!0,delay:g.delay,onClose:()=>u(g.id),children:[s.jsx(Et.Header,{closeButton:!0,children:s.jsx("strong",{className:"me-auto",style:d(g.variant),children:g.header})}),s.jsx(Et.Body,{className:p(g.variant),children:g.message})]},g.id))})]})}function $n(){const n=m.useContext(rw);if(!n)throw new Error("useToast debe usarse dentro de <ToastProvider>");return n}/*!
* sweetalert2 v11.23.0
* Released under the MIT License.
*/function ow(n,a,o){if(typeof n=="function"?n===a:n.has(a))return arguments.length<3?a:o;throw new TypeError("Private element is not present on this object")}function IA(n,a){if(a.has(n))throw new TypeError("Cannot initialize the same private elements twice on an object")}function jb(n,a){return n.get(ow(n,a))}function $A(n,a,o){IA(n,a),a.set(n,o)}function HA(n,a,o){return n.set(ow(n,a),o),o}const qA=100,he={},JA=()=>{he.previousActiveElement instanceof HTMLElement?(he.previousActiveElement.focus(),he.previousActiveElement=null):document.body&&document.body.focus()},GA=n=>new Promise(a=>{if(!n)return a();const o=window.scrollX,l=window.scrollY;he.restoreFocusTimeout=setTimeout(()=>{JA(),a()},qA),window.scrollTo(o,l)}),sw="swal2-",FA=["container","shown","height-auto","iosfix","popup","modal","no-backdrop","no-transition","toast","toast-shown","show","hide","close","title","html-container","actions","confirm","deny","cancel","footer","icon","icon-content","image","input","file","range","select","radio","checkbox","label","textarea","inputerror","input-label","validation-message","progress-steps","active-progress-step","progress-step","progress-step-line","loader","loading","styled","top","top-start","top-end","top-left","top-right","center","center-start","center-end","center-left","center-right","bottom","bottom-start","bottom-end","bottom-left","bottom-right","grow-row","grow-column","grow-fullscreen","rtl","timer-progress-bar","timer-progress-bar-container","scrollbar-measure","icon-success","icon-warning","icon-info","icon-question","icon-error","draggable","dragging"],X=FA.reduce((n,a)=>(n[a]=sw+a,n),{}),VA=["success","warning","info","question","error"],Wl=VA.reduce((n,a)=>(n[a]=sw+a,n),{}),iw="SweetAlert2:",wm=n=>n.charAt(0).toUpperCase()+n.slice(1),Nt=n=>{console.warn(`${iw} ${typeof n=="object"?n.join(" "):n}`)},Cr=n=>{console.error(`${iw} ${n}`)},Sb=[],YA=n=>{Sb.includes(n)||(Sb.push(n),Nt(n))},lw=(n,a=null)=>{YA(`"${n}" is deprecated and will be removed in the next major release.${a?` Use "${a}" instead.`:""}`)},Nc=n=>typeof n=="function"?n():n,jm=n=>n&&typeof n.toPromise=="function",vi=n=>jm(n)?n.toPromise():Promise.resolve(n),Sm=n=>n&&Promise.resolve(n)===n,Ct=()=>document.body.querySelector(`.${X.container}`),bi=n=>{const a=Ct();return a?a.querySelector(n):null},Xt=n=>bi(`.${n}`),Te=()=>Xt(X.popup),qo=()=>Xt(X.icon),XA=()=>Xt(X["icon-content"]),cw=()=>Xt(X.title),Em=()=>Xt(X["html-container"]),uw=()=>Xt(X.image),Nm=()=>Xt(X["progress-steps"]),Cc=()=>Xt(X["validation-message"]),Un=()=>bi(`.${X.actions} .${X.confirm}`),Jo=()=>bi(`.${X.actions} .${X.cancel}`),Ar=()=>bi(`.${X.actions} .${X.deny}`),ZA=()=>Xt(X["input-label"]),Go=()=>bi(`.${X.loader}`),yi=()=>Xt(X.actions),dw=()=>Xt(X.footer),Ac=()=>Xt(X["timer-progress-bar"]),Cm=()=>Xt(X.close),KA=`
  a[href],
  area[href],
  input:not([disabled]),
  select:not([disabled]),
