...
function agregarUsuario(data, usuario) {
  ...
  try {
    ...
    if (!correo || !nombre || !rol) {
      return respuestaJSON({ status: "warning", mensaje: "⚠️ Campos obligatorios faltantes." });
    }
...
`,sR="/appdeclaracion/assets/imgBackend1-DSJ-bLa1.webp",iR="/appdeclaracion/assets/imgBackend2-Cqt62vUJ.webp",lR="/appdeclaracion/assets/imgBackend3-DaVLght5.webp",cR="/appdeclaracion/assets/imgBackend4-B-5yDjcs.webp",uR="/appdeclaracion/assets/imgBackend5-DVl6r9fh.webp",dR="/appdeclaracion/assets/imgBackend6-B2Xs4tWE.webp",fR="/appdeclaracion/assets/imgBackend7-N9ASCtVG.webp",mR="/appdeclaracion/assets/imgBackend8-BwprXXyy.webp",pR="/appdeclaracion/assets/imgBackend9-D3jD8_Vx.webp",hR=()=>{const[n,a]=m.useState(!1),o=()=>{window.open("https://script.google.com/home/","_blank")},l=[{img:sR,descripcion:"Ingrese a la consola de Google Apps Script para comenzar con la configuración:",puntos:["Escriba https://script.google.com/home/ en su navegador.","O haga clic en el botón 'Abrir Apps Script' de arriba."]},{img:iR,descripcion:"Inicie un nuevo proyecto desde el panel principal:",puntos:["Haga clic en el botón 'Nuevo proyecto' ubicado en la parte superior izquierda."]},{img:lR,descripcion:"Configure el código base del backend:",puntos:["Cambie el nombre del proyecto a 'AppDeclaracion' haciendo doble click encima del nombre .","Ubique el archivo Codigo.gs y elimine todo su contenido.","Pegue el código proporcionado por AppDeclaracion el cual puede ver y copiar en el siguiente botón."]},{img:cR,descripcion:"Habilite los servicios necesarios de Google:",puntos:["En el panel izquierdo, haga clic en el símbolo '+' en Servicios para agregar un Drive.","Busque y seleccione 'Drive API'.","Seleccione la versión v3 y haga clic en 'Añadir'."]},{img:uR,descripcion:"Inicie el proceso de publicación:",puntos:["Haga clic en el botón azul 'Implementar' (arriba a la derecha).","Seleccione 'Nueva implementación'.","Haga clic en el icono de engranaje y elija 'Aplicación web'."]},{img:dR,descripcion:"Configure los parámetros de acceso de la aplicación:",puntos:["Descripción: 'Versión inicial'.","Ejecutar como: 'Yo'.","Quién tiene acceso: 'Cualquier usuario' (esto es vital para la conexión).","Haga clic en el botón 'Implementar'."]},{img:fR,descripcion:"Autorice los permisos de seguridad de Google:",puntos:["Haga clic en 'Autorizar acceso'.","Seleccione su cuenta de Google.","Haga clic en 'Advanced' y luego en 'Go to AppDeclaracion (unsafe)'.","Permita todos los accesos y copie la URL generada (URL de la aplicación web) en un archivo de texto para utilizarla posteriormente en el worker."]},{img:mR,descripcion:"Ejecute la configuración inicial de la base de datos:",puntos:["En la barra de herramientas superior, seleccione la función 'inicializarSistema'.","Haga clic en el botón 'Ejecutar'.","Espere a que el registro de ejecución finalice correctamente.","En el logo de Apps Script Superior Izquierdo de colores hacer click para regresar al administrador de proyectos"]},{img:pR,descripcion:"Active el acceso programático final:",puntos:["En el panel izquierdo hacer click en el icono de engranaje de configuración.","Hacer click en 'API de Google Apps Script' el cual se debe encontrar desactivado","Hacer click en la parte derecha en el botón Switch o deslizante","Finalizado este paso y copiada la URL ya podemos cerrar Apps Script y pasar a la pestaña del Worker"]}];return i.jsxs("div",{className:"crear-backend",children:[i.jsx("h1",{children:"Crear Backend en Apps Script"}),i.jsx("div",{className:"video-container",children:i.jsx("iframe",{src:"https://player.vimeo.com/video/1182426720?h=ddeac77678&badge=0&autopause=0&player_id=0&app_id=58479",title:"Tutorial Backend Apps Script",allowFullScreen:!0,allow:"autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share",referrerPolicy:"strict-origin-when-cross-origin",style:{position:"absolute",top:0,left:0,width:"100%",height:"100%"}})}),i.jsx("div",{className:"boton-container",children:i.jsx("button",{onClick:o,children:"Abrir Apps Script"})}),i.jsx("div",{className:"pasos-container",children:l.map((c,d)=>i.jsxs("div",{className:"paso",children:[i.jsx("img",{src:c.img,alt:`Paso ${d+1}`}),i.jsxs("div",{className:"paso-contenido",children:[i.jsxs("strong",{children:["Paso ",d+1,":"]}),i.jsx("p",{children:c.descripcion}),c.puntos&&i.jsx("ul",{children:c.puntos.map((p,g)=>i.jsx("li",{children:p},g))})]}),d===2&&i.jsx("div",{className:"boton-container",children:i.jsx("button",{onClick:()=>a(!0),children:"Ver código del Backend"})})]},d))}),i.jsx($0,{isOpen:n,onClose:()=>a(!1),titulo:"Código Backend Apps Script",codigo:oR})]})},gR=`export default {
  async fetch(request) {
...
`,vR="/appdeclaracion/assets/imgWorker1-DsxzgBXq.webp",bR="/appdeclaracion/assets/imgWorker2-BG05QrIG.webp",yR="/appdeclaracion/assets/imgWorker3-ByEQQa3f.webp",xR="/appdeclaracion/assets/imgWorker4-vNF1IGvm.webp",wR="/appdeclaracion/assets/imgWorker5-BMmv7aUK.webp",jR="/appdeclaracion/assets/imgWorker6-FbMqyreq.webp",SR="/appdeclaracion/assets/imgWorker7-DYrg8XBA.webp",ER=()=>{const[n,a]=m.useState(!1),o=()=>{window.open("https://dash.cloudflare.com/","_blank")},l=[{img:vR,descripcion:'Ingrese a la consola de Cloudflare escribiendo en el navegador https://dash.cloudflare.com/login o haciendo clic en el botón "Abrir Cloudflare". Luego:',puntos:["Haga clic en 'Continue with Google'","Seleccione su cuenta de Google","Haga clic en 'Continuar' para ingresar al panel."]},{img:bR,descripcion:"Dentro del panel de Cloudflare ubique el menú lateral izquierdo:",puntos:["Busque la sección 'Compute'","Haga clic en 'Workers & Pages'","Luego haga clic en el botón 'Create application'"]},{img:yR,descripcion:"En la pantalla de creación de la aplicación ubique la opción 'Start with hello world!' y haga clic en ella.",puntos:["Esto generará un Worker base que posteriormente será modificado con el código de AppDeclaracion el cual puede ver y copiar en el siguiente botón."]},{img:xR,descripcion:"En el campo 'Worker name' elimine el contenido existente y escriba:",puntos:["appdeclaracion","Luego haga clic en el botón 'Deploy' para crear el Worker."]},{img:wR,descripcion:"Una vez creado el Worker aparecerá una pantalla de confirmación.",puntos:["En esta pantalla haga clic en el botón 'Edit code' para abrir el editor del Worker."]},{img:jR,descripcion:"Dentro del editor ubique el archivo worker.js, elimine el código existente y pegue el proporcionado por AppDeclaracion. Luego, busque la línea 'const destino' y:",puntos:["Reemplace la URL entre comillas por la generada en Apps Script.","Asegúrese que inicie con https:// y termine en /exec.","Copie la URL pública del Worker que aparece en la parte superior derecha (esta es la que compartirá con los usuarios).","Haga clic en 'Deploy' y luego en el enlace 'appdeclaracion' para regresar."]},{img:SR,descripcion:"Al regresar al panel principal diríjase nuevamente a 'Workers & Pages':",puntos:["Verifique que aparezca el Worker llamado 'appdeclaracion'.","Esto confirma que el Worker fue creado y desplegado correctamente.","Finalizado este paso y copiada la URL que debe registrarse en la sección 'Configuración de Backends'. Es la misma dirección que deberá proporcionarle a su contador. Una vez que él le informe su correo electrónico, usted podrá registrarlo como nuevo usuario con los roles y permisos adecuados. Recuerde que tanto usted como el contador deben agregar esta URL del Worker en sus respectivos paneles de AppDeclaración para que el sistema funcione correctamente."]}];return i.jsxs("div",{className:"crear-backend",children:[i.jsx("h1",{children:"Crear worker"}),i.jsx("div",{className:"video-container",children:i.jsx("iframe",{src:"https://player.vimeo.com/video/1182429387?h=02f60cfc57&badge=0&autopause=0&player_id=0&app_id=58479",title:"Tutorial Backend Workwe CloudFlare",allowFullScreen:!0,allow:"autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share",referrerPolicy:"strict-origin-when-cross-origin",style:{position:"absolute",top:0,left:0,width:"100%",height:"100%"}})}),i.jsx("div",{className:"boton-container",children:i.jsx("button",{onClick:o,children:"Abrir CloudFlare"})}),i.jsx("div",{className:"pasos-container",children:l.map((c,d)=>i.jsxs("div",{className:"paso",children:[i.jsx("img",{src:c.img,alt:`Paso ${d+1}`}),i.jsxs("div",{className:"paso-contenido",children:[i.jsxs("strong",{children:["Paso ",d+1,":"]}),i.jsx("p",{children:c.descripcion}),c.puntos&&i.jsx("ul",{children:c.puntos.map((p,g)=>i.jsx("li",{children:p},g))})]}),d===2&&i.jsx("div",{className:"boton-container",children:i.jsx("button",{onClick:()=>a(!0),children:"Ver código del Worker"})})]},d))}),i.jsx($0,{isOpen:n,onClose:()=>a(!1),titulo:"Código Cloudflare Worker",codigo:gR})]})},NR=()=>{const[n,a]=m.useState("appsScript");return i.jsxs(Yo,{fluid:!0,className:"p-3",children:[i.jsx(Rr,{children:i.jsx(Ln,{children:i.jsx("h3",{className:"mb-4 text-center fw-bold",children:"⚙️ Configuración Backend"})})}),i.jsx(Rr,{children:i.jsxs(Ln,{children:[i.jsxs(Dm,{activeKey:n,onSelect:o=>a(o),id:"admin-tabs",className:"mb-3",justify:!0,children:[i.jsx(Do,{eventKey:"appsScript",title:"🧱 Apps Script"}),i.jsx(Do,{eventKey:"worker",title:"🏰 Worker"})]}),n==="appsScript"&&i.jsx(hR,{}),n==="worker"&&i.jsx(ER,{})]})})]})};function fi(){return i.jsx("div",{className:"p-4 text-danger fw-bold",children:"❌ No tienes permiso para realizar esta acción."})}const iy=({isMobile:n})=>n?i.jsxs("div",{className:"usuario-card skeleton-card-usuario",children:[i.jsxs("div",{className:"card-header d-flex align-items-center",children:[i.jsx("div",{className:"skeleton-bar",style:{width:"50%"}}),i.jsx("div",{className:"skeleton-badge ms-2"})]}),i.jsxs("div",{className:"card-body",children:[i.jsx("div",{className:"skeleton-bar mb-2",style:{width:"30%"}}),i.jsx("div",{className:"skeleton-bar mb-3",style:{width:"80%"}}),i.jsx("div",{className:"skeleton-switch mb-3"}),i.jsxs("div",{className:"d-flex gap-2",children:[i.jsx("div",{className:"skeleton-button-lg"}),i.jsx("div",{className:"skeleton-button-lg"})]})]})]}):i.jsxs("tr",{className:"usuario-skeleton-row",children:[i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar",style:{width:"85%"}})}),i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar",style:{width:"70%"}})}),i.jsx("td",{children:i.jsx("div",{className:"skeleton-badge"})}),i.jsx("td",{className:"text-center",children:i.jsx("div",{className:"skeleton-switch"})}),i.jsx("td",{className:"text-center",children:i.jsxs("div",{className:"d-flex justify-content-center gap-2",children:[i.jsx("div",{className:"skeleton-button"}),i.jsx("div",{className:"skeleton-button"})]})})]}),CR=({isFocused:n})=>{const{usuarios:a,rolesDisponibles:o,rolesErrorPermisos:l,getDatos:c,addDato:d,updateDato:p,toggleActivo:g,deleteDato:h,loading:v,getRoles:y}=NT(),{errors:x,validateField:w,validateForm:E,clearErrors:N,clearError:A}=rs(),{user:S}=Oi(),[R,C]=m.useState(!1),[T,M]=m.useState(null),[U,B]=m.useState({correo:"",nombreUsuario:"",rol:""}),[L,z]=m.useState(null),[K,te]=m.useState(!1),{puede:ne}=Ea(),re=ne("getUsuarios");m.useEffect(()=>{n&&re&&(c(),y())},[c,y,re,n]);const oe=async()=>{if(N(),!E({correo:U.correo,nombreUsuario:U.nombreUsuario,rol:U.rol}))return;const F={correo:U.correo.toLowerCase(),nombre:yt(U.nombreUsuario),rol:U.rol};T?await p(T.correo,F):await d(F),C(!1),M(null),B({correo:"",nombreUsuario:"",rol:""})},W=k=>{M(k),B({correo:k.correo,nombreUsuario:k.nombre,rol:k.rol}),C(!0)},X=async k=>{await g(k.correo,!k.activo,k.nombre)};return re?i.jsxs("div",{className:"usuarios-admin p-3",children:[i.jsxs("div",{className:"d-flex justify-content-between align-items-center mb-3",children:[i.jsx("h4",{className:"fw-bold mb-0",children:"👥 Administración de Usuarios"}),i.jsx(Te,{onClick:()=>C(!0),variant:"primary",size:"sm",disabled:v,children:"➕ Crear Usuario"})]}),!v&&a.length===0?i.jsx("div",{className:"text-center text-muted py-4",children:"No hay usuarios registrados."}):i.jsxs(i.Fragment,{children:[i.jsx("div",{className:"table-responsive shadow-sm rounded d-none d-md-block",children:i.jsxs(wi,{hover:!0,className:"align-middle mb-0",children:[i.jsx("thead",{className:"table-light",children:i.jsxs("tr",{children:[i.jsx("th",{children:"Correo"}),i.jsx("th",{children:"Nombre"}),i.jsx("th",{children:"Rol"}),i.jsx("th",{className:"text-center",children:"Estado"}),i.jsx("th",{className:"text-center",children:"Acciones"})]})}),i.jsx("tbody",{children:v?Array.from({length:5}).map((k,F)=>i.jsx(iy,{isMobile:!1},`skel-table-${F}`)):a.map((k,F)=>i.jsxs("tr",{children:[i.jsx("td",{children:k.correo}),i.jsx("td",{children:k.nombre}),i.jsx("td",{children:i.jsx(To,{bg:k.rol==="administrador"?"warning":k.rol==="contador"?"info":"secondary",text:k.rol==="administrador"?"dark":"white",className:"px-2 py-1 text-capitalize",children:k.rol})}),i.jsx("td",{className:"text-center",children:i.jsx(ie.Check,{type:"switch",checked:k.activo,onChange:()=>X(k),disabled:k.nombre.toLowerCase()==="administrador"&&k.rol==="administrador",label:i.jsx("span",{className:k.activo?"text-success":"text-danger",children:k.activo?"Activo":"Inactivo"})})}),i.jsx("td",{className:"text-center","data-label":"Acciones",children:i.jsx("div",{className:"ico-edit-elim",children:S?.correo===k.correo?i.jsx(To,{bg:"light",text:"dark",className:"border shadow-sm",children:"Tu sesión"}):k.nombre.toLowerCase()==="administrador"?i.jsxs(To,{bg:"dark",text:"white",className:"shadow-sm",children:[i.jsx("i",{className:"bi bi-shield-lock-fill me-1"})," Restringido"]}):i.jsxs(i.Fragment,{children:[i.jsx("i",{className:"bi bi-pencil-square accion-icon",title:"Editar",onClick:()=>W(k)}),i.jsx("i",{className:"bi bi-x-circle accion-icon text-danger",title:"Eliminar",onClick:()=>{z(k),te(!0)}})]})})})]},F))})]})}),i.jsx("div",{className:"usuarios-cards d-md-none",children:v?Array.from({length:4}).map((k,F)=>i.jsx(iy,{isMobile:!0},`skel-card-${F}`)):a.map((k,F)=>i.jsxs("div",{className:"usuario-card",children:[i.jsxs("div",{className:"card-header",children:[i.jsx("strong",{children:k.nombre}),i.jsx(To,{bg:k.rol==="administrador"?"warning":"info",text:k.rol==="administrador"?"dark":"white",className:"ms-2",children:k.rol})]}),i.jsxs("div",{className:"card-body",children:[i.jsxs("p",{children:[i.jsx("strong",{children:"Correo:"}),i.jsx("br",{})," ",k.correo]}),i.jsx(ie.Check,{type:"switch",id:`switch-mobile-${k.correo}`,checked:k.activo,onChange:()=>X(k),disabled:k.nombre.toLowerCase()==="administrador"&&k.rol==="administrador",label:k.activo?"Activo":"Inactivo"}),i.jsxs("div",{className:"d-flex gap-2 mt-3",children:[i.jsx("span",{className:"label-edit-elim-span",children:"Acciones:"}),i.jsx("div",{className:"ico-edit-elim",children:S?.correo===k.correo?i.jsx("span",{className:"text-muted small fw-bold",children:"Sesión activa"}):k.nombre.toLowerCase()==="administrador"?i.jsxs("span",{className:"text-danger small fw-bold span-i-restri",children:[i.jsx("i",{className:"bi bi-shield-lock-fill me-1"})," Restringido"]}):i.jsxs(i.Fragment,{children:[i.jsx("i",{className:"bi bi-pencil-square accion-icon",title:"Editar",onClick:()=>W(k)}),i.jsx("i",{className:"bi bi-x-circle accion-icon text-danger",title:"Eliminar",onClick:()=>{z(k),te(!0)}})]})})]})]})]},F))})]}),i.jsxs(be,{show:R,centered:!0,onHide:()=>C(!1),children:[i.jsx(be.Header,{closeButton:!0,children:i.jsx(be.Title,{children:T?"Editar Usuario":"Nuevo Usuario"})}),i.jsxs(be.Body,{children:[i.jsx(as,{errors:x}),i.jsxs(ie,{children:[i.jsxs(ie.Group,{className:"mb-3",children:[i.jsx(ie.Label,{children:"Correo"}),i.jsx(ie.Control,{type:"email",value:U.correo,onChange:k=>{const F=k.target.value.toLowerCase();B({...U,correo:F}),A("correo")},onBlur:k=>w("correo",k.target.value),disabled:T})]}),i.jsxs(ie.Group,{className:"mb-3",children:[i.jsx(ie.Label,{children:"Nombre completo"}),i.jsx(ie.Control,{type:"text",value:U.nombreUsuario,onChange:k=>{B({...U,nombreUsuario:k.target.value}),A("nombreUsuario")},onBlur:k=>w("nombreUsuario",k.target.value)})]}),i.jsxs(ie.Group,{className:"mb-3",children:[i.jsx(ie.Label,{children:"Rol"}),l?i.jsx("div",{className:"alert alert-warning py-2 small",children:"⚠️ No tienes permiso para ver roles."}):i.jsxs(ie.Select,{value:U.rol,onChange:k=>{B({...U,rol:k.target.value}),A("rol")},onBlur:k=>w("rol",k.target.value),children:[i.jsx("option",{value:"",children:"Seleccionar rol..."}),o.map((k,F)=>i.jsx("option",{value:k.rol,children:k.rol},F))]})]})]})]}),i.jsxs(be.Footer,{children:[i.jsx(Te,{variant:"secondary",onClick:()=>C(!1),children:"Cancelar"}),i.jsx(Te,{variant:"success",onClick:oe,disabled:v,children:v?i.jsxs(i.Fragment,{children:[i.jsx(Nt,{size:"sm",animation:"border"})," Guardando..."]}):"💾 Guardar"})]}),i.jsx(Nn,{show:v})]}),i.jsx(Na,{show:K,onHide:()=>te(!1),title:"Eliminar Usuario",message:i.jsxs(i.Fragment,{children:["¿Seguro que deseas eliminar al usuario ",i.jsx("strong",{children:L?.correo}),"?"]}),confirmLabel:"Eliminar",confirmVariant:"danger",onConfirm:()=>h(L?.correo)})]}):i.jsx(fi,{})},AR=()=>i.jsxs("tr",{className:"rol-skeleton-row",children:[i.jsx("td",{"data-label":"Rol",children:i.jsx("div",{className:"d-flex align-items-center",children:i.jsx("div",{className:"skeleton-bar",style:{width:"120px"}})})}),i.jsx("td",{"data-label":"Permisos",children:i.jsxs("div",{className:"d-flex flex-column gap-2",children:[i.jsx("div",{className:"skeleton-bar",style:{width:"90%"}}),i.jsx("div",{className:"skeleton-bar",style:{width:"70%"}})]})}),i.jsx("td",{className:"td-acciones text-center","data-label":"Acciones",children:i.jsxs("div",{className:"d-flex justify-content-center gap-2",children:[i.jsx("div",{className:"skeleton-btn-rect"}),i.jsx("div",{className:"skeleton-btn-rect"})]})})]}),OR=({isFocused:n})=>{const{roles:a,funcionesDisponibles:o,getDatos:l,addDato:c,updateDato:d,deleteDato:p,loading:g}=kT(),{errors:h,validateField:v,validateForm:y,clearErrors:x,clearError:w}=rs(),[E,N]=m.useState(!1),[A,S]=m.useState(""),[R,C]=m.useState([]),[T,M]=m.useState(null),[U,B]=m.useState(null),[L,z]=m.useState(!1),{puede:K}=Ea(),te=K("getRoles");m.useEffect(()=>{n&&te&&l()},[l,te,n]);const ne=async()=>{x();const X={rolPermisos:R};if(T||(X.rolNombre=A),!y(X))return;const F=yt(A);T?await d(T.rol,R):await c(F,R),N(!1),S(""),C([]),M(null)},re=X=>{M(X),S(X.rol),C((X.permisos||[]).map(k=>k.trim())),N(!0)},oe=X=>{const k=R.includes(X)?R.filter(F=>F!==X):[...R,X];C(k),v("rolPermisos",k)},W=()=>{const X=R.length===o.length?[]:o;C(X),v("rolPermisos",X)};return te?i.jsxs("div",{className:"roles-admin-container p-3",children:[i.jsxs("div",{className:"d-flex justify-content-between align-items-center mb-3",children:[i.jsx("h4",{className:"fw-bold mb-0",children:"Administración de Roles"}),i.jsx(Te,{onClick:()=>{M(null),S(""),C([]),N(!0)},variant:"primary",disabled:g,children:"➕ Nuevo Rol"})]}),i.jsx("div",{className:"table-responsive shadow-sm rounded",children:i.jsxs(wi,{striped:!0,bordered:!0,hover:!0,className:"align-middle mb-0",children:[i.jsx("thead",{className:"table-light",children:i.jsxs("tr",{children:[i.jsx("th",{children:"Rol"}),i.jsx("th",{children:"Permisos"}),i.jsx("th",{className:"text-center",children:"Acciones"})]})}),i.jsx("tbody",{children:g?Array.from({length:5}).map((X,k)=>i.jsx(AR,{},`rol-skel-${k}`)):a.length===0?i.jsx("tr",{children:i.jsx("td",{colSpan:"3",className:"text-center py-4 text-muted",children:"No hay roles definidos."})}):a.map((X,k)=>i.jsxs("tr",{children:[i.jsxs("td",{"data-label":"Rol",children:[i.jsx("strong",{children:X.rol}),X.rol==="administrador"&&i.jsx(To,{bg:"warning",text:"dark",className:"ms-2",children:"Protegido"})]}),i.jsx("td",{"data-label":"Permisos",children:i.jsx("div",{className:"text-muted small text-break",children:X.permisos?.includes("*")?"Todos los permisos":X.permisos?.join(", ")||"—"})}),i.jsx("td",{className:"td-acciones text-center","data-label":"Acciones",children:i.jsx("div",{className:"ico-edit-elim",children:X.rol!=="administrador"&&i.jsxs(i.Fragment,{children:[i.jsx("i",{className:"bi bi-pencil-square accion-icon",title:"Editar",onClick:()=>re(X)}),i.jsx("i",{className:"bi bi-x-circle accion-icon text-danger",title:"Eliminar",onClick:()=>{B(X.rol),z(!0)}})]})})})]},k))})]})}),i.jsxs(be,{show:E,onHide:()=>N(!1),size:"lg",centered:!0,children:[i.jsx(be.Header,{closeButton:!0,children:i.jsx(be.Title,{children:T?`Editar Permisos: ${T.rol}`:"Crear Nuevo Rol"})}),i.jsxs(be.Body,{children:[i.jsx(as,{errors:h}),!T&&i.jsxs(ie.Group,{className:"mb-3",children:[i.jsx(ie.Label,{className:"fw-bold",children:"Nombre del Rol"}),i.jsx(ie.Control,{type:"text",value:A,onChange:X=>{S(X.target.value),w("rolNombre")},onBlur:X=>v("rolNombre",X.target.value),placeholder:"Ejemplo: Contador, Revisor, Supervisor..."})]}),i.jsxs("div",{className:"d-flex justify-content-between align-items-center mb-2",children:[i.jsxs(ie.Label,{className:"fw-bold mb-0",children:["Permisos del Rol (",R.length,")"]}),i.jsx(Te,{size:"sm",variant:"outline-primary",onClick:W,children:R.length===o.length?"Deseleccionar todos":"Seleccionar todos"})]}),i.jsx("div",{className:"p-3 bg-light border rounded",style:{maxHeight:"350px",overflowY:"auto"},children:i.jsx("div",{className:"row",children:o.map(X=>i.jsx("div",{className:"col-md-6 col-lg-4 mb-2",children:i.jsx(ie.Check,{type:"checkbox",id:`perm-${X}`,label:i.jsx("span",{className:"small",children:X}),checked:R.includes(X),onChange:()=>oe(X)})},X))})})]}),i.jsxs(be.Footer,{children:[i.jsx(Te,{variant:"secondary",onClick:()=>N(!1),children:"Cancelar"}),i.jsx(Te,{variant:"success",onClick:ne,disabled:g,children:g?i.jsxs(i.Fragment,{children:[i.jsx(Nt,{size:"sm",animation:"border",className:"me-2"}),"Guardando..."]}):"💾 Guardar"})]}),i.jsx(Nn,{show:g})]}),i.jsx(Na,{show:L,onHide:()=>z(!1),title:"Eliminar Rol",message:i.jsxs(i.Fragment,{children:["¿Seguro que deseas eliminar el rol ",i.jsx("strong",{children:U}),"?"]}),confirmLabel:"Eliminar",confirmVariant:"danger",onConfirm:()=>p(U)})]}):i.jsx(fi,{})},ly=({isTable:n=!1})=>n?i.jsxs("tr",{className:"log-skeleton-row",children:[i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar",style:{width:"140px"}})}),i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar",style:{width:"100px"}})}),i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar",style:{width:"120px"}})}),i.jsx("td",{children:i.jsx("div",{className:"skeleton-bar-rect"})})]}):i.jsxs("div",{className:"log-skeleton-card",children:[i.jsxs("div",{className:"log-header-skeleton",children:[i.jsx("div",{className:"skeleton-bar",style:{width:"40%"}}),i.jsx("div",{className:"skeleton-bar",style:{width:"30%"}})]}),i.jsxs("div",{className:"log-body-skeleton",children:[i.jsx("div",{className:"skeleton-bar mb-3",style:{width:"60%"}}),i.jsx("div",{className:"skeleton-bar-rect"})]})]});function kR({isFocused:n}){const{puede:a}=Ea(),o=a("getLogs"),{logs:l,getDatos:c,clearDatos:d,loading:p}=ST(),[g,h]=m.useState(!1);return m.useEffect(()=>{n&&o&&c()},[c,o,n]),o?i.jsxs("div",{className:"p-4",children:[i.jsx("h2",{className:"mb-4",children:"📜 Administración de Logs"}),i.jsx("div",{className:"d-flex justify-content-end mb-3",children:i.jsx(Te,{variant:"danger",onClick:()=>h(!0),disabled:p,children:"🧹 Limpiar Logs Antiguos"})}),i.jsxs(wi,{striped:!0,bordered:!0,hover:!0,size:"sm",responsive:!0,className:"logs-table",children:[i.jsx("thead",{children:i.jsxs("tr",{children:[i.jsx("th",{children:"Fecha"}),i.jsx("th",{children:"Acción"}),i.jsx("th",{children:"Usuario"}),i.jsx("th",{children:"Detalle"})]})}),i.jsx("tbody",{children:p?Array.from({length:8}).map((v,y)=>i.jsx(ly,{isTable:!0},`table-skel-${y}`)):l.length>0?l.map((v,y)=>i.jsxs("tr",{children:[i.jsx("td",{children:v.fecha}),i.jsx("td",{children:v.accion}),i.jsx("td",{children:v.usuario}),i.jsx("td",{children:i.jsx("pre",{className:"bg-light p-2 rounded small mb-0",children:JSON.stringify(v.detalle,null,2)})})]},y)):i.jsx("tr",{children:i.jsx("td",{colSpan:4,className:"text-center text-muted",children:"No hay logs disponibles"})})})]}),i.jsx("div",{className:"logs-cards",children:p?Array.from({length:4}).map((v,y)=>i.jsx(ly,{isTable:!1},`card-skel-${y}`)):l.length>0?l.map((v,y)=>i.jsxs("div",{className:"log-card",children:[i.jsxs("div",{className:"log-header",children:[i.jsx("h6",{children:v.accion}),i.jsx("span",{children:v.fecha})]}),i.jsxs("div",{className:"log-body",children:[i.jsxs("p",{children:[i.jsx("strong",{children:"Usuario:"})," ",v.usuario]}),i.jsx("pre",{children:JSON.stringify(v.detalle,null,2)})]})]},y)):i.jsx("p",{className:"text-center text-muted",children:"No hay logs disponibles"})}),i.jsx(Na,{show:g,onHide:()=>h(!1),title:"🧹 Limpiar Logs Antiguos",message:i.jsxs(i.Fragment,{children:["Esta acción eliminará todos los logs antiguos y conservará solo los"," ",i.jsx("strong",{children:"10 más recientes"}),".",i.jsx("p",{className:"text-danger fw-semibold mt-2",children:"⚠️ Esta operación no se puede deshacer."})]}),confirmLabel:"Limpiar Logs",confirmVariant:"danger",onConfirm:d})]}):i.jsx(fi,{})}const TR=()=>i.jsxs("div",{className:"config-skeleton-container",children:[i.jsxs("div",{className:"card shadow-sm p-3 mb-4",children:[i.jsx("div",{className:"skeleton-title mb-3",style:{width:"200px"}}),i.jsxs("div",{className:"row gy-3",children:[i.jsxs("div",{className:"col-12 col-md-5",children:[i.jsx("div",{className:"skeleton-label mb-2"}),i.jsx("div",{className:"skeleton-input mb-3"}),i.jsx("div",{className:"skeleton-btn",style:{width:"180px"}})]}),i.jsxs("div",{className:"col-12 col-md-5",children:[i.jsx("div",{className:"skeleton-label mb-2"}),i.jsx("div",{className:"skeleton-input mb-3"}),i.jsx("div",{className:"skeleton-label mb-2"}),i.jsx("div",{className:"skeleton-input mb-1"}),i.jsx("div",{className:"skeleton-text",style:{width:"120px"}})]}),i.jsx("div",{className:"col-12 col-md-2",children:i.jsx("div",{className:"skeleton-btn h-100",style:{minHeight:"38px"}})})]})]}),i.jsxs("div",{className:"card shadow-sm p-3 mb-4",children:[i.jsxs("div",{className:"d-flex justify-content-between mb-3",children:[i.jsx("div",{className:"skeleton-title",style:{width:"250px"}}),i.jsx("div",{className:"skeleton-input",style:{width:"200px"}})]}),i.jsx("div",{className:"skeleton-table",children:[1,2,3,4].map(n=>i.jsxs("div",{className:"skeleton-table-row d-flex justify-content-between p-2 border-bottom",children:[i.jsx("div",{className:"skeleton-bar",style:{width:"40px"}}),i.jsx("div",{className:"skeleton-btn",style:{width:"80px",height:"25px"}})]},n))}),i.jsx("div",{className:"text-end mt-3",children:i.jsx("div",{className:"skeleton-btn d-inline-block",style:{width:"150px"}})})]})]}),RR=({isFocused:n})=>{const{config:a,clearConfig:o,getConfig:l,versionBackend:c,updateConfig:d,generarBackup:p,reinicializarSistemaForzado:g,loading:h}=AT(),[v,y]=m.useState(""),[x,w]=m.useState(""),[E,N]=m.useState([]),[A,S]=m.useState(""),[R,C]=m.useState(!1),[T,M]=m.useState(""),[U,B]=m.useState(!1),[L]=m.useState("v2720262210"),{puede:z}=Ea(),K=z("getConfig"),[te,ne]=m.useState(!1),[re,oe]=m.useState(!1),[W,X]=m.useState(!1),[k,F]=m.useState(!1);m.useEffect(()=>{n&&K&&(F(!1),l())},[l,K,n]),m.useEffect(()=>{a&&!k&&!W&&(y(a.TAMANO_MAX_MB||10),w(a.TOKEN_EXP_MINUTOS||60),N(a.TIPOS_PERMITIDOS||[]),F(!0))},[a,k,W]),m.useEffect(()=>{n||(F(!1),y(""),w(""),N([]),S(""),o())},[n,o]);const se=()=>{const P=A.trim().toLowerCase();if(P){if(E.includes(P))return alert("⚠️ Esa extensión ya está permitida.");N([...E,P]),S("")}},V=P=>{M(P),C(!0)},le=()=>{N(E.filter(P=>P!==T)),C(!1),M("")},O=P=>{const ce=P.target.value;ce>45?y(45):y(ce)},q=async()=>{X(!0);try{await d({CARPETA_PRINCIPAL:a?.CARPETA_PRINCIPAL||"",TAMANO_MAX_MB:Number(v),TOKEN_EXP_MINUTOS:Number(x),TIPOS_PERMITIDOS:E})}finally{X(!1)}},ae=async()=>{ne(!0);try{await p()}finally{ne(!1)}};return K?i.jsxs("div",{className:"config-admin-page container py-3",children:[i.jsx("h3",{className:"fw-bold mb-4 text-primary",children:"⚙️ Administración de Configuración"}),!K&&i.jsx(fi,{}),(h||!k)&&n?i.jsx(TR,{}):i.jsxs(i.Fragment,{children:[i.jsxs("div",{className:"card shadow-sm p-3 mb-4",children:[i.jsx("h5",{className:"fw-bold mb-3",children:"🔧 Configuración General"}),i.jsxs(Rr,{className:"gy-3",children:[i.jsxs(Ln,{xs:12,md:5,children:[i.jsxs(ie.Group,{children:[i.jsx(ie.Label,{className:"fw-semibold",children:"📁 Carpeta Principal"}),i.jsx(ie.Control,{type:"text",value:a?.CARPETA_PRINCIPAL||"",readOnly:!0,plaintext:!0}),i.jsxs(ie.Text,{muted:!0,children:[i.jsxs("p",{children:["Versión Backend: ",i.jsx("span",{className:"version-backend",children:`${c}`})]}),i.jsxs("p",{children:["Versión FrontEnd: ",i.jsx("span",{className:"version-frontEnd",children:L})]})]})]}),i.jsx(Te,{variant:"danger",className:"btn-CAP-inicializarproyecto",onClick:()=>B(!0),disabled:re,children:re?i.jsxs(i.Fragment,{children:[i.jsx(Nt,{as:"span",animation:"border",size:"sm"})," Procesando..."]}):"⚠️ Reinicializar Proyecto"})]}),i.jsxs(Ln,{xs:12,md:5,children:[i.jsxs(ie.Group,{children:[i.jsx(ie.Label,{className:"fw-semibold",children:"📦 Tamaño máximo permitido 45 (MB)"}),i.jsx(ie.Control,{type:"number",min:1,max:45,value:v,onChange:O})]}),i.jsxs(ie.Group,{children:[i.jsx(ie.Label,{className:"fw-semibold",children:"🔑 Expiración Token (Min)"}),i.jsx(ie.Control,{type:"number",min:1,value:x,onChange:P=>w(P.target.value)}),i.jsx(ie.Text,{muted:!0,children:"Duración de la sesión activa."})]})]}),i.jsx(Ln,{xs:12,md:2,children:i.jsxs("div",{className:"config-actions-panel",children:[i.jsx(Te,{variant:"primary",className:"btn-backup-grande",onClick:ae,disabled:te,children:te?i.jsxs(i.Fragment,{children:[i.jsx(Nt,{as:"span",animation:"border",size:"sm"}),i.jsx("span",{children:"Generando..."})]}):i.jsxs("div",{className:"btn-CAP-backup-iconText",children:[i.jsx("span",{className:"backup-ico bi bi-file-zip"}),i.jsx("span",{children:"Generar Backup"})]})}),i.jsx(Te,{variant:"success",className:"mt-2",onClick:q,disabled:W,children:W?i.jsxs(i.Fragment,{children:[i.jsx(Nt,{as:"span",animation:"border",size:"sm"})," Guardando..."]}):i.jsxs("div",{className:"btn-CAP-guardar-iconText",children:[i.jsx("span",{className:"icon-disk"}),i.jsx("span",{children:"Guardar Cambios"})]})})]})})]})]}),i.jsxs("div",{className:"card shadow-sm p-3 mb-4",children:[i.jsxs("div",{className:"d-flex justify-content-between align-items-center flex-wrap mb-3",children:[i.jsx("h5",{className:"fw-bold mb-2 mb-md-0",children:"🧩 Tipos de archivo permitidos"}),i.jsxs(RA,{style:{maxWidth:260},children:[i.jsx(ie.Control,{type:"text",placeholder:"Ej: pdf",value:A,onChange:P=>S(P.target.value)}),i.jsx(Te,{onClick:se,children:"➕"})]})]}),i.jsxs(wi,{bordered:!0,hover:!0,responsive:!0,className:"small shadow-inner-sm",children:[i.jsx("thead",{className:"table-light",children:i.jsxs("tr",{children:[i.jsx("th",{children:"Extensión"}),i.jsx("th",{className:"text-center",children:"Acciones"})]})}),i.jsxs("tbody",{children:[E.map((P,ce)=>i.jsxs("tr",{children:[i.jsx("td",{className:"fw-semibold",children:P}),i.jsx("td",{className:"text-center",children:i.jsx(Te,{size:"sm",variant:"outline-danger",onClick:()=>V(P),children:"🗑️ Eliminar"})})]},ce)),E.length===0&&i.jsx("tr",{children:i.jsx("td",{colSpan:2,className:"text-center text-muted py-3",children:"No hay extensiones configuradas."})})]})]})]})]}),i.jsx(Na,{show:R,onHide:()=>C(!1),title:"Eliminar tipo de archivo",message:i.jsxs(i.Fragment,{children:["¿Seguro que deseas eliminar ",i.jsx("strong",{children:T}),"?"]}),confirmLabel:"Eliminar",confirmVariant:"danger",onConfirm:le}),i.jsx(TT,{show:U,onHide:()=>B(!1),onConfirm:async(P,ce)=>{if(P==="INICIALIZAR"){oe(!0);try{const pe=await g(P,ce);console.log("reinicialización del sistema",pe.mensaje,pe.ok)}finally{oe(!1),B(!1)}}},loading:h}),i.jsx(Nn,{show:W||te||re})]}):i.jsx(fi,{})};function DR(){const[n,a]=m.useState("usuarios");return i.jsx(U0,{children:i.jsxs(Yo,{fluid:!0,className:"p-3",children:[i.jsx(Rr,{children:i.jsx(Ln,{children:i.jsx("h3",{className:"mb-4 text-center fw-bold",children:"⚙️ Panel de Administración"})})}),i.jsx(Rr,{children:i.jsx(Ln,{children:i.jsxs(Dm,{activeKey:n,onSelect:o=>a(o),id:"admin-tabs",className:"mb-3",justify:!0,mountOnEnter:!0,unmountOnExit:!0,children:[i.jsx(Do,{eventKey:"usuarios",title:"👥 Usuarios",children:i.jsx(CR,{isFocused:n==="usuarios"})}),i.jsx(Do,{eventKey:"roles",title:"🧩 Roles",children:i.jsx(OR,{isFocused:n==="roles"})}),i.jsx(Do,{eventKey:"config",title:"⚙️ Configuración",children:i.jsx(RR,{isFocused:n==="config"})}),i.jsx(Do,{eventKey:"logs",title:"📜 Logs",children:i.jsx(kR,{isFocused:n==="logs"})})]})})})]})})}function ai({children:n}){const{authenticated:a,loading:o}=Oi(),l=En();return o?null:a?n:i.jsx(mN,{to:"/",replace:!0,state:{from:l}})}function LR(){const[n,a]=m.useState(!1);return m.useEffect(()=>{const o=()=>a(!0);return window.addEventListener("backend:open-config",o),()=>{window.removeEventListener("backend:open-config",o)}},[]),i.jsxs(i.Fragment,{children:[i.jsx(BT,{onOpenBackend:()=>a(!0)}),i.jsx(UT,{show:n,onHide:()=>a(!1)}),i.jsx(Yo,{className:"mt-4",children:i.jsxs(hN,{children:[i.jsx(gn,{path:"/",element:i.jsx($T,{})}),i.jsx(gn,{path:"/productos",element:i.jsx(ai,{children:i.jsx(FT,{})})}),i.jsx(gn,{path:"/datos-tributarios",element:i.jsx(ai,{children:i.jsx(YT,{})})}),i.jsx(gn,{path:"/contador",element:i.jsx(ai,{children:i.jsx(ZT,{})})}),i.jsx(gn,{path:"/facturas",element:i.jsx(ai,{children:i.jsx(WT,{})})}),i.jsx(gn,{path:"/admin",element:i.jsx(ai,{children:i.jsx(DR,{})})}),i.jsx(gn,{path:"/privacidad",element:i.jsx(eR,{})}),i.jsx(gn,{path:"/terminos",element:i.jsx(tR,{})}),i.jsx(gn,{path:"/acerca-de",element:i.jsx(nR,{})}),i.jsx(gn,{path:"/donaciones",element:i.jsx(rR,{})}),i.jsx(gn,{path:"/backend-setup",element:i.jsx(NR,{})})]})}),i.jsx(IT,{}),i.jsx(PT,{})]})}const _R="modulepreload",zR=function(n){return"/appdeclaracion/"+n},cy={},MR=function(a,o,l){let c=Promise.resolve();if(o&&o.length>0){let v=function(y){return Promise.all(y.map(x=>Promise.resolve(x).then(w=>({status:"fulfilled",value:w}),w=>({status:"rejected",reason:w}))))};var p=v;document.getElementsByTagName("link");const g=document.querySelector("meta[property=csp-nonce]"),h=g?.nonce||g?.getAttribute("nonce");c=v(o.map(y=>{if(y=zR(y),y in cy)return;cy[y]=!0;const x=y.endsWith(".css"),w=x?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${y}"]${w}`))return;const E=document.createElement("link");if(E.rel=x?"stylesheet":_R,x||(E.as="script"),E.crossOrigin="",E.href=y,h&&E.setAttribute("nonce",h),document.head.appendChild(E),x)return new Promise((N,A)=>{E.addEventListener("load",N),E.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${y}`)))})}))}function d(g){const h=new Event("vite:preloadError",{cancelable:!0});if(h.payload=g,window.dispatchEvent(h),!h.defaultPrevented)throw g}return c.then(g=>{for(const h of g||[])h.status==="rejected"&&d(h.reason);return a().catch(d)})};function BR(n={}){const{immediate:a=!1,onNeedReload:o,onNeedRefresh:l,onOfflineReady:c,onRegistered:d,onRegisteredSW:p,onRegisterError:g}=n;let h,v;const y=async(w=!0)=>{await v};async function x(){if("serviceWorker"in navigator){if(h=await MR(async()=>{const{Workbox:w}=await import("./workbox-window.prod.es5-BBnX5xw4.js");return{Workbox:w}},[]).then(({Workbox:w})=>new w("/appdeclaracion/sw.js",{scope:"/appdeclaracion/",type:"classic"})).catch(w=>{g?.(w)}),!h)return;h.addEventListener("activated",w=>{(w.isUpdate||w.isExternal)&&(o?o():window.location.reload())}),h.addEventListener("installed",w=>{w.isUpdate||c?.()}),h.register({immediate:a}).then(w=>{p?p("/appdeclaracion/sw.js",w):d?.(w)}).catch(w=>{g?.(w)})}}return v=x(),y}BR({immediate:!0});gE.createRoot(document.getElementById("root")).render(i.jsx(Xe.StrictMode,{children:i.jsx(IN,{children:i.jsx(CO,{children:i.jsx(KN,{children:i.jsx(bT,{children:i.jsx(xT,{children:i.jsx(yT,{children:i.jsx(wT,{children:i.jsx(U0,{children:i.jsx(LR,{})})})})})})})})})}));
