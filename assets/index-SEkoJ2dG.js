 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ev;function TS(){if(Ev)return xe;Ev=1;var n=Symbol.for("react.transitional.element"),a=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),l=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),x=Symbol.iterator;function w(A){return A===null||typeof A!="object"?null:(A=x&&A[x]||A["@@iterator"],typeof A=="function"?A:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,R={};function N(A,V,Z){this.props=A,this.context=V,this.refs=R,this.updater=Z||S}N.prototype.isReactComponent={},N.prototype.setState=function(A,V){if(typeof A!="object"&&typeof A!="function"&&A!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,A,V,"setState")},N.prototype.forceUpdate=function(A){this.updater.enqueueForceUpdate(this,A,"forceUpdate")};function O(){}O.prototype=N.prototype;function C(A,V,Z){this.props=A,this.context=V,this.refs=R,this.updater=Z||S}var k=C.prototype=new O;k.constructor=C,E(k,N.prototype),k.isPureReactComponent=!0;var _=Array.isArray,z={H:null,A:null,T:null,S:null,V:null},L=Object.prototype.hasOwnProperty;function I(A,V,Z,te,se,fe){return Z=fe.ref,{$$typeof:n,type:A,key:V,ref:Z!==void 0?Z:null,props:fe}}function B(A,V){return I(A.type,V,void 0,void 0,void 0,A.props)}function X(A){return typeof A=="object"&&A!==null&&A.$$typeof===n}function W(A){var V={"=":"=0",":":"=2"};return"$"+A.replace(/[=:]/g,function(Z){return V[Z]})}var oe=/\/+/g;function ae(A,V){return typeof A=="object"&&A!==null&&A.key!=null?W(""+A.key):V.toString(36)}function le(){}function J(A){switch(A.status){case"fulfilled":return A.value;case"rejected":throw A.reason;default:switch(typeof A.status=="string"?A.then(le,le):(A.status="pending",A.then(function(V){A.status==="pending"&&(A.status="fulfilled",A.value=V)},function(V){A.status==="pending"&&(A.status="rejected",A.reason=V)})),A.status){case"fulfilled":return A.value;case"rejected":throw A.reason}}throw A}function ie(A,V,Z,te,se){var fe=typeof A;(fe==="undefined"||fe==="boolean")&&(A=null);var me=!1;if(A===null)me=!0;else switch(fe){case"bigint":case"string":case"number":me=!0;break;case"object":switch(A.$$typeof){case n:case a:me=!0;break;case b:return me=A._init,ie(me(A._payload),V,Z,te,se)}}if(me)return se=se(A),me=te===""?"."+ae(A,0):te,_(se)?(Z="",me!=null&&(Z=me.replace(oe,"$&/")+"/"),ie(se,V,Z,"",function(Qe){return Qe})):se!=null&&(X(se)&&(se=B(se,Z+(se.key==null||A&&A.key===se.key?"":(""+se.key).replace(oe,"$&/")+"/")+me)),V.push(se)),1;me=0;var $e=te===""?".":te+":";if(_(A))for(var we=0;we<A.length;we++)te=A[we],fe=$e+ae(te,we),me+=ie(te,V,Z,fe,se);else if(we=w(A),typeof we=="function")for(A=we.call(A),we=0;!(te=A.next()).done;)te=te.value,fe=$e+ae(te,we++),me+=ie(te,V,Z,fe,se);else if(fe==="object"){if(typeof A.then=="function")return ie(J(A),V,Z,te,se);throw V=String(A),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(A).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.")}return me}function $(A,V,Z){if(A==null)return A;var te=[],se=0;return ie(A,te,"","",function(fe){return V.call(Z,fe,se++)}),te}function ee(A){if(A._status===-1){var V=A._result;V=V(),V.then(function(Z){(A._status===0||A._status===-1)&&(A._status=1,A._result=Z)},function(Z){(A._status===0||A._status===-1)&&(A._status=2,A._result=Z)}),A._status===-1&&(A._status=0,A._result=V)}if(A._status===1)return A._result.default;throw A._result}var D=typeof reportError=="function"?reportError:function(A){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var V=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof A=="object"&&A!==null&&typeof A.message=="string"?String(A.message):String(A),error:A});if(!window.dispatchEvent(V))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",A);return}console.error(A)};function re(){}return xe.Children={map:$,forEach:function(A,V,Z){$(A,function(){V.apply(this,arguments)},Z)},count:function(A){var V=0;return $(A,function(){V++}),V},toArray:function(A){return $(A,function(V){return V})||[]},only:function(A){if(!X(A))throw Error("React.Children.only expected to receive a single React element child.");return A}},xe.Component=N,xe.Fragment=o,xe.Profiler=u,xe.PureComponent=C,xe.StrictMode=l,xe.Suspense=h,xe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,xe.__COMPILER_RUNTIME={__proto__:null,c:function(A){return z.H.useMemoCache(A)}},xe.cache=function(A){return function(){return A.apply(null,arguments)}},xe.cloneElement=function(A,V,Z){if(A==null)throw Error("The argument must be a React element, but you passed "+A+".");var te=E({},A.props),se=A.key,fe=void 0;if(V!=null)for(me in V.ref!==void 0&&(fe=void 0),V.key!==void 0&&(se=""+V.key),V)!L.call(V,me)||me==="key"||me==="__self"||me==="__source"||me==="ref"&&V.ref===void 0||(te[me]=V[me]);var me=arguments.length-2;if(me===1)te.children=Z;else if(1<me){for(var $e=Array(me),we=0;we<me;we++)$e[we]=arguments[we+2];te.children=$e}return I(A.type,se,void 0,void 0,fe,te)},xe.createContext=function(A){return A={$$typeof:p,_currentValue:A,_currentValue2:A,_threadCount:0,Provider:null,Consumer:null},A.Provider=A,A.Consumer={$$typeof:d,_context:A},A},xe.createElement=function(A,V,Z){var te,se={},fe=null;if(V!=null)for(te in V.key!==void 0&&(fe=""+V.key),V)L.call(V,te)&&te!=="key"&&te!=="__self"&&te!=="__source"&&(se[te]=V[te]);var me=arguments.length-2;if(me===1)se.children=Z;else if(1<me){for(var $e=Array(me),we=0;we<me;we++)$e[we]=arguments[we+2];se.children=$e}if(A&&A.defaultProps)for(te in me=A.defaultProps,me)se[te]===void 0&&(se[te]=me[te]);return I(A,fe,void 0,void 0,null,se)},xe.createRef=function(){return{current:null}},xe.forwardRef=function(A){return{$$typeof:g,render:A}},xe.isValidElement=X,xe.lazy=function(A){return{$$typeof:b,_payload:{_status:-1,_result:A},_init:ee}},xe.memo=function(A,V){return{$$typeof:v,type:A,compare:V===void 0?null:V}},xe.startTransition=function(A){var V=z.T,Z={};z.T=Z;try{var te=A(),se=z.S;se!==null&&se(Z,te),typeof te=="object"&&te!==null&&typeof te.then=="function"&&te.then(re,D)}catch(fe){D(fe)}finally{z.T=V}},xe.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},xe.use=function(A){return z.H.use(A)},xe.useActionState=function(A,V,Z){return z.H.useActionState(A,V,Z)},xe.useCallback=function(A,V){return z.H.useCallback(A,V)},xe.useContext=function(A){return z.H.useContext(A)},xe.useDebugValue=function(){},xe.useDeferredValue=function(A,V){return z.H.useDeferredValue(A,V)},xe.useEffect=function(A,V,Z){var te=z.H;if(typeof Z=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return te.useEffect(A,V)},xe.useId=function(){return z.H.useId()},xe.useImperativeHandle=function(A,V,Z){return z.H.useImperativeHandle(A,V,Z)},xe.useInsertionEffect=function(A,V){return z.H.useInsertionEffect(A,V)},xe.useLayoutEffect=function(A,V){return z.H.useLayoutEffect(A,V)},xe.useMemo=function(A,V){return z.H.useMemo(A,V)},xe.useOptimistic=function(A,V){return z.H.useOptimistic(A,V)},xe.useReducer=function(A,V,Z){return z.H.useReducer(A,V,Z)},xe.useRef=function(A){return z.H.useRef(A)},xe.useState=function(A){return z.H.useState(A)},xe.useSyncExternalStore=function(A,V,Z){return z.H.useSyncExternalStore(A,V,Z)},xe.useTransition=function(){return z.H.useTransition()},xe.version="19.1.1",xe}var Cv;function Lf(){return Cv||(Cv=1,Pd.exports=TS()),Pd.exports}var m=Lf();const Je=To(m);var $d={exports:{}},qs={},Hd={exports:{}},Gd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Av;function RS(){return Av||(Av=1,(function(n){function a($,ee){var D=$.length;$.push(ee);e:for(;0<D;){var re=D-1>>>1,A=$[re];if(0<u(A,ee))$[re]=ee,$[D]=A,D=re;else break e}}function o($){return $.length===0?null:$[0]}function l($){if($.length===0)return null;var ee=$[0],D=$.pop();if(D!==ee){$[0]=D;e:for(var re=0,A=$.length,V=A>>>1;re<V;){var Z=2*(re+1)-1,te=$[Z],se=Z+1,fe=$[se];if(0>u(te,D))se<A&&0>u(fe,te)?($[re]=fe,$[se]=D,re=se):($[re]=te,$[Z]=D,re=Z);else if(se<A&&0>u(fe,D))$[re]=fe,$[se]=D,re=se;else break e}}return ee}function u($,ee){var D=$.sortIndex-ee.sortIndex;return D!==0?D:$.id-ee.id}if(n.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;n.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();n.unstable_now=function(){return p.now()-g}}var h=[],v=[],b=1,x=null,w=3,S=!1,E=!1,R=!1,N=!1,O=typeof setTimeout=="function"?setTimeout:null,C=typeof clearTimeout=="function"?clearTimeout:null,k=typeof setImmediate<"u"?setImmediate:null;function _($){for(var ee=o(v);ee!==null;){if(ee.callback===null)l(v);else if(ee.startTime<=$)l(v),ee.sortIndex=ee.expirationTime,a(h,ee);else break;ee=o(v)}}function z($){if(R=!1,_($),!E)if(o(h)!==null)E=!0,L||(L=!0,ae());else{var ee=o(v);ee!==null&&ie(z,ee.startTime-$)}}var L=!1,I=-1,B=5,X=-1;function W(){return N?!0:!(n.unstable_now()-X<B)}function oe(){if(N=!1,L){var $=n.unstable_now();X=$;var ee=!0;try{e:{E=!1,R&&(R=!1,C(I),I=-1),S=!0;var D=w;try{t:{for(_($),x=o(h);x!==null&&!(x.expirationTime>$&&W());){var re=x.callback;if(typeof re=="function"){x.callback=null,w=x.priorityLevel;var A=re(x.expirationTime<=$);if($=n.unstable_now(),typeof A=="function"){x.callback=A,_($),ee=!0;break t}x===o(h)&&l(h),_($)}else l(h);x=o(h)}if(x!==null)ee=!0;else{var V=o(v);V!==null&&ie(z,V.startTime-$),ee=!1}}break e}finally{x=null,w=D,S=!1}ee=void 0}}finally{ee?ae():L=!1}}}var ae;if(typeof k=="function")ae=function(){k(oe)};else if(typeof MessageChannel<"u"){var le=new MessageChannel,J=le.port2;le.port1.onmessage=oe,ae=function(){J.postMessage(null)}}else ae=function(){O(oe,0)};function ie($,ee){I=O(function(){$(n.unstable_now())},ee)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function($){$.callback=null},n.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<$?Math.floor(1e3/$):5},n.unstable_getCurrentPriorityLevel=function(){return w},n.unstable_next=function($){switch(w){case 1:case 2:case 3:var ee=3;break;default:ee=w}var D=w;w=ee;try{return $()}finally{w=D}},n.unstable_requestPaint=function(){N=!0},n.unstable_runWithPriority=function($,ee){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var D=w;w=$;try{return ee()}finally{w=D}},n.unstable_scheduleCallback=function($,ee,D){var re=n.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?re+D:re):D=re,$){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=D+A,$={id:b++,callback:ee,priorityLevel:$,startTime:D,expirationTime:A,sortIndex:-1},D>re?($.sortIndex=D,a(v,$),o(h)===null&&$===o(v)&&(R?(C(I),I=-1):R=!0,ie(z,D-re))):($.sortIndex=A,a(h,$),E||S||(E=!0,L||(L=!0,ae()))),$},n.unstable_shouldYield=W,n.unstable_wrapCallback=function($){var ee=w;return function(){var D=w;w=ee;try{return $.apply(this,arguments)}finally{w=D}}}})(Gd)),Gd}var Ov;function DS(){return Ov||(Ov=1,Hd.exports=RS()),Hd.exports}var qd={exports:{}},xt={};/**
 * @license React
...
`.replace(/(^|\n)\s*/g,""),aO=()=>{const n=Et();return n?(n.remove(),hn([document.documentElement,document.body],[F["no-backdrop"],F["toast-shown"],F["has-column"]]),!0):!1},fr=()=>{he.currentInstance.resetValidationMessage()},rO=()=>{const n=Te(),a=Ha(n,F.input),o=Ha(n,F.file),l=n.querySelector(`.${F.range} input`),u=n.querySelector(`.${F.range} output`),d=Ha(n,F.select),p=n.querySelector(`.${F.checkbox} input`),g=Ha(n,F.textarea);a.oninput=fr,o.onchange=fr,d.onchange=fr,p.onchange=fr,g.oninput=fr,l.oninput=()=>{fr(),u.value=l.value},l.onchange=()=>{fr(),u.value=l.value}},oO=n=>typeof n=="string"?document.querySelector(n):n,sO=n=>{const a=Te();a.setAttribute("role",n.toast?"alert":"dialog"),a.setAttribute("aria-live",n.toast?"polite":"assertive"),n.toast||a.setAttribute("aria-modal","true")},iO=n=>{window.getComputedStyle(n).direction==="rtl"&&De(Et(),F.rtl)},lO=n=>{const a=aO();if(tO()){Sr("SweetAlert2 requires document to initialize");return}const o=document.createElement("div");o.className=F.container,a&&De(o,F["no-transition"]),Yt(o,nO),o.dataset.swal2Theme=n.theme;const l=oO(n.target);l.appendChild(o),n.topLayer&&(o.setAttribute("popover",""),o.showPopover()),sO(n),iO(l),rO()},Cm=(n,a)=>{n instanceof HTMLElement?a.appendChild(n):typeof n=="object"?cO(n,a):n&&Yt(a,n)},cO=(n,a)=>{n.jquery?uO(a,n):Yt(a,n.toString())},uO=(n,a)=>{if(n.textContent="",0 in a)for(let o=0;o in a;o++)n.appendChild(a[o].cloneNode(!0));else n.appendChild(a.cloneNode(!0))},dO=(n,a)=>{const o=gi(),l=Po();!o||!l||(!a.showConfirmButton&&!a.showDenyButton&&!a.showCancelButton?wt(o):mt(o),Ft(o,a,"actions"),fO(o,l,a),Yt(l,a.loaderHtml||""),Ft(l,a,"loader"))};function fO(n,a,o){const l=Mn(),u=Nr(),d=Io();!l||!u||!d||(of(l,"confirm",o),of(u,"deny",o),of(d,"cancel",o),mO(l,u,d,o),o.reverseButtons&&(o.toast?(n.insertBefore(d,l),n.insertBefore(u,l)):(n.insertBefore(d,a),n.insertBefore(u,a),n.insertBefore(l,a))))}function mO(n,a,o,l){if(!l.buttonsStyling){hn([n,a,o],F.styled);return}De([n,a,o],F.styled),l.confirmButtonColor&&n.style.setProperty("--swal2-confirm-button-background-color",l.confirmButtonColor),l.denyButtonColor&&a.style.setProperty("--swal2-deny-button-background-color",l.denyButtonColor),l.cancelButtonColor&&o.style.setProperty("--swal2-cancel-button-background-color",l.cancelButtonColor),rf(n),rf(a),rf(o)}function rf(n){const a=window.getComputedStyle(n);if(a.getPropertyValue("--swal2-action-button-focus-box-shadow"))return;const o=a.backgroundColor.replace(/rgba?\((\d+), (\d+), (\d+).*/,"rgba($1, $2, $3, 0.5)");n.style.setProperty("--swal2-action-button-focus-box-shadow",a.getPropertyValue("--swal2-outline").replace(/ rgba\(.*/,` ${o}`))}function of(n,a,o){const l=gm(a);vi(n,o[`show${l}Button`],"inline-block"),Yt(n,o[`${a}ButtonText`]||""),n.setAttribute("aria-label",o[`${a}ButtonAriaLabel`]||""),n.className=F[a],Ft(n,o,`${a}Button`)}const pO=(n,a)=>{const o=wm();o&&(Yt(o,a.closeButtonHtml||""),Ft(o,a,"closeButton"),vi(o,a.showCloseButton),o.setAttribute("aria-label",a.closeButtonAriaLabel||""))},hO=(n,a)=>{const o=Et();o&&(gO(o,a.backdrop),vO(o,a.position),bO(o,a.grow),Ft(o,a,"container"))};function gO(n,a){typeof a=="string"?n.style.background=a:a||De([document.documentElement,document.body],F["no-backdrop"])}function vO(n,a){a&&(a in F?De(n,F[a]):(Nt('The "position" parameter is not valid, defaulting to "center"'),De(n,F.center)))}function bO(n,a){a&&De(n,F[`grow-${a}`])}var Ge={innerParams:new WeakMap,domCache:new WeakMap};const yO=["input","file","range","select","radio","checkbox","textarea"],xO=(n,a)=>{const o=Te();if(!o)return;const l=Ge.innerParams.get(n),u=!l||a.input!==l.input;yO.forEach(d=>{const p=Ha(o,F[d]);p&&(SO(d,a.inputAttributes),p.className=F[d],u&&wt(p))}),a.input&&(u&&wO(a),NO(a))},wO=n=>{if(!n.input)return;if(!nt[n.input]){Sr(`Unexpected type of input! Expected ${Object.keys(nt).join(" | ")}, got "${n.input}"`);return}const a=mw(n.input);if(!a)return;const o=nt[n.input](a,n);mt(a),n.inputAutoFocus&&setTimeout(()=>{uw(o)})},jO=n=>{for(let a=0;a<n.attributes.length;a++){const o=n.attributes[a].name;["id","type","value","style"].includes(o)||n.removeAttribute(o)}},SO=(n,a)=>{const o=Te();if(!o)return;const l=Cc(o,n);if(l){jO(l);for(const u in a)l.setAttribute(u,a[u])}},NO=n=>{if(!n.input)return;const a=mw(n.input);a&&Ft(a,n,"input")},Am=(n,a)=>{!n.placeholder&&a.inputPlaceholder&&(n.placeholder=a.inputPlaceholder)},bi=(n,a,o)=>{if(o.inputLabel){const l=document.createElement("label"),u=F["input-label"];l.setAttribute("for",n.id),l.className=u,typeof o.customClass=="object"&&De(l,o.customClass.inputLabel),l.innerText=o.inputLabel,a.insertAdjacentElement("beforebegin",l)}},mw=n=>{const a=Te();if(a)return Ha(a,F[n]||F.input)},Kl=(n,a)=>{["string","number"].includes(typeof a)?n.value=`${a}`:bm(a)||Nt(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof a}"`)},nt={};nt.text=nt.email=nt.password=nt.number=nt.tel=nt.url=nt.search=nt.date=nt["datetime-local"]=nt.time=nt.week=nt.month=(n,a)=>(Kl(n,a.inputValue),bi(n,n,a),Am(n,a),n.type=a.input,n);nt.file=(n,a)=>(bi(n,n,a),Am(n,a),n);nt.range=(n,a)=>{const o=n.querySelector("input"),l=n.querySelector("output");return Kl(o,a.inputValue),o.type=a.input,Kl(l,a.inputValue),bi(o,n,a),n};nt.select=(n,a)=>{if(n.textContent="",a.inputPlaceholder){const o=document.createElement("option");Yt(o,a.inputPlaceholder),o.value="",o.disabled=!0,o.selected=!0,n.appendChild(o)}return bi(n,n,a),n};nt.radio=n=>(n.textContent="",n);nt.checkbox=(n,a)=>{const o=Cc(Te(),"checkbox");o.value="1",o.checked=!!a.inputValue;const l=n.querySelector("span");return Yt(l,a.inputPlaceholder||a.inputLabel),o};nt.textarea=(n,a)=>{Kl(n,a.inputValue),Am(n,a),bi(n,n,a);const o=l=>parseInt(window.getComputedStyle(l).marginLeft)+parseInt(window.getComputedStyle(l).marginRight);return setTimeout(()=>{if("MutationObserver"in window){const l=parseInt(window.getComputedStyle(Te()).width),u=()=>{if(!document.body.contains(n))return;const d=n.offsetWidth+o(n);d>l?Te().style.width=`${d}px`:hr(Te(),"width",a.width)};new MutationObserver(u).observe(n,{attributes:!0,attributeFilter:["style"]})}}),n};const EO=(n,a)=>{const o=ym();o&&(Nm(o),Ft(o,a,"htmlContainer"),a.html?(Cm(a.html,o),mt(o,"block")):a.text?(o.textContent=a.text,mt(o,"block")):wt(o),xO(n,a))},CO=(n,a)=>{const o=cw();o&&(Nm(o),vi(o,a.footer,"block"),a.footer&&Cm(a.footer,o),Ft(o,a,"footer"))},AO=(n,a)=>{const o=Ge.innerParams.get(n),l=Uo();if(!l)return;if(o&&a.icon===o.icon){Sb(l,a),jb(l,a);return}if(!a.icon&&!a.iconHtml){wt(l);return}if(a.icon&&Object.keys(Zl).indexOf(a.icon)===-1){Sr(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${a.icon}"`),wt(l);return}mt(l),Sb(l,a),jb(l,a),De(l,a.showClass&&a.showClass.icon),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",pw)},jb=(n,a)=>{for(const[o,l]of Object.entries(Zl))a.icon!==o&&hn(n,l);De(n,a.icon&&Zl[a.icon]),TO(n,a),pw(),Ft(n,a,"icon")},pw=()=>{const n=Te();if(!n)return;const a=window.getComputedStyle(n).getPropertyValue("background-color"),o=n.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix");for(let l=0;l<o.length;l++)o[l].style.backgroundColor=a},OO=n=>`
